...
library call`XmCreateSimplePulldownMenu`A RowColumn widget convenience creation functionXmCreateSimplePulldown\\%Menucreation functionsXmCreateSimplePulldown\\%Menu#include <Xm/RowColumn.h>Widget`XmCreateSimplePulldownMenu`WidgetparentStringnameArgListarglistCardinalargcount
## DESCRIPTION


`XmCreateSimplePulldownMenu`creates an instance of a RowColumn
