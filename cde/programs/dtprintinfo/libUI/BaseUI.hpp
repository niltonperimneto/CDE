...
#define TraceFunctionCalls(flag)
 ...
 protected:
   ...
   void AddToParentContainer(void);
   void DeleteFromParentContainer(void);
 ...
 public:
   ...
   virtual boolean HandleHelpRequest(void);
   void ContextualHelp(void);
   ...
   BaseUI ** Siblings(void);
   int NumSiblings(void);
   BaseUI * ContainerParent(void);
   int NumContainerChildren(void);
   BaseUI ** ContainerChildren(void);
