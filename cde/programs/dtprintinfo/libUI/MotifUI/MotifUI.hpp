...
class MotifUI : public BaseUI {
 ...
 private:
   ...
   Cursor InitHourGlassCursor(void);
 ...
 protected:
   ...
   void DoRefresh(void);
   void DoToFront(void);
   void DoContextualHelp(void);
   virtual void DoMakeVisible(void);
   virtual boolean DoIsVisible(void);
 ...
 public:
   ...
   PointerCursor PointerShape(void);
