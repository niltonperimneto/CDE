...
/* image offsets */
#define ICON_INNER_X_OFFSET (ICON_IMAGE_LEFT_PAD + ICON_EXTERNAL_SHADOW_WIDTH)
#define ICON_INNER_Y_OFFSET (ICON_IMAGE_TOP_PAD + ICON_EXTERNAL_SHADOW_WIDTH)
...
#define WM_TITLE_BAR_PADDING                                                   \
  (WM_TOP_TITLE_PADDING + WM_BOTTOM_TITLE_PADDING + WM_TOP_TITLE_SHADOW +      \
...
#define WM_DECOR_TITLEBAR                                                      \
  (WM_DECOR_SYSTEM | WM_DECOR_MINIMIZE | WM_DECOR_MAXIMIZE)
...
#define WM_SHOW_FB_ALL                                                         \
  (WM_SHOW_FB_BEHAVIOR | WM_SHOW_FB_MOVE | WM_SHOW_FB_PLACEMENT |              \
   WM_SHOW_FB_RESIZE | WM_SHOW_FB_RESTART | WM_SHOW_FB_QUIT | WM_SHOW_FB_KILL)
...
typedef Boolean (*WmFunction)(String, struct _ClientData *, XEvent *);
...
#define F_SUBCONTEXT_IB_ICONS (F_SUBCONTEXT_IB_IICON | F_SUBCONTEXT_IB_WICON)

#define F_SUBCONTEXT_IB_ALL                                                    \
  (F_SUBCONTEXT_IB_IBOX | F_SUBCONTEXT_IB_IICON | F_SUBCONTEXT_IB_WICON)
...
#define F_SUBCONTEXT_W_RBORDER                                                 \
  (F_SUBCONTEXT_W_RESIZE_NW | F_SUBCONTEXT_W_RESIZE_N |                        \
   F_SUBCONTEXT_W_RESIZE_NE | F_SUBCONTEXT_W_RESIZE_E |                        \
   F_SUBCONTEXT_W_RESIZE_SE | F_SUBCONTEXT_W_RESIZE_S |                        \
   F_SUBCONTEXT_W_RESIZE_SW | F_SUBCONTEXT_W_RESIZE_W)

#define F_SUBCONTEXT_W_BORDER (F_SUBCONTEXT_W_RBORDER | F_SUBCONTEXT_W_NBORDER)

#define F_SUBCONTEXT_W_TITLEBAR                                                \
  (F_SUBCONTEXT_W_SYSTEM | F_SUBCONTEXT_W_TITLE | F_SUBCONTEXT_W_MINIMIZE |    \
   F_SUBCONTEXT_W_MAXIMIZE)

#define F_SUBCONTEXT_W_FRAME (F_SUBCONTEXT_W_BORDER | F_SUBCONTEXT_W_TITLEBAR)

#define F_SUBCONTEXT_W_ALL                                                     \
  (F_SUBCONTEXT_W_FRAME | F_SUBCONTEXT_W_MATTE | F_SUBCONTEXT_W_CLIENT)
 ...
 * frame style types
 */
typedef enum _FrameStyle { WmRECESSED, WmSLAB } FrameStyle;
...
#ifndef IBM_169380
  XContext cmapWindowContextType; /* list of pCD's in WM_COLORMAP_WINDOWS
                                     context for XSaveContext */
#endif
...
#define ICON_APPEARANCE_STANDALONE                                             \
