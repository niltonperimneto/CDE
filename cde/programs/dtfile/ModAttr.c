...
#define ALL_FIELDS                                                             \
  HOST | DIR | NAME | FILETYPE | GROUP | OWNER | BITS | SIZE | MODTIME
#define ALL_BUT_ACCESS                                                         \
  HOST | DIR | NAME | FILETYPE | GROUP | OWNER | SIZE | MODTIME
...
static DialogResource resources[] = {
    {"host", XmRString, sizeof(String), XtOffset(ModAttrDataPtr, host),
     (XtPointer)NULL, _DtStringToString},

    {"directory", XmRString, sizeof(String),
     XtOffset(ModAttrDataPtr, directory), (XtPointer)NULL, _DtStringToString},

    {"name", XmRString, sizeof(String), XtOffset(ModAttrDataPtr, name),
     (XtPointer)NULL, _DtStringToString},

    {"link_name", XmRString, sizeof(String),
     XtOffset(ModAttrDataPtr, link_name), (XtPointer)NULL, _DtStringToString},

    {"access", XmRInt, sizeof(int), XtOffset(ModAttrDataPtr, accessBits),
...
static void Create(Display *display, Widget parent, Widget *return_widget,
                   XtPointer *dialog);
static void InstallChange(ModAttrRec *modAttr_rec, XtCallbackProc callback,
                          XtPointer client_data);
static void InstallClose(ModAttrRec *modAttr_rec, XtCallbackProc callback,
                         XtPointer client_data);
static void Destroy(ModAttrRec *modAttr_rec);
static XtPointer GetValues(ModAttrRec *modAttr_rec);
static XtPointer GetDefaultValues(void);
static XtPointer GetResourceValues(XrmDatabase data_base, char **name_list);
static void SetValues(ModAttrRec *modAttr_rec, ModAttrData *modAttr_data);
static void WriteResourceValues(DialogData *values, int fd, char **name_list);
static void FreeValues(ModAttrData *modAttr_data);
static void OkCallback(Widget w, ModAttrApply *apply_data, XtPointer call_data);
static short GetModAttrValues(ModAttrRec *modAttr_rec,
                              ModAttrData *modAttr_data, Boolean validate);
static void InvalidModAttrMessage(Widget w, int messageIndex);
static Boolean _LoadFileAttributes(String host, String dir, String file,
                                   ModAttrData *modAttr_data,
                                   unsigned long mask);
static void displayFSDialog(Widget w, dtFSData *fileSystem,
                            XmPushButtonCallbackStruct *cbs);
static void DontChangeCB(Widget w, XtPointer client_data, XtPointer call_data);
static void ChangeCB(Widget w, XtPointer client_data, XtPointer call_data);
...
static void Create(Display *display, Widget parent, Widget *return_widget,
  ...
  n = 0;
  XtSetArg(args[n], XmNmwmFunctions, MWM_FUNC_MOVE | MWM_FUNC_CLOSE);
  ++n;
  ...
  label_string =
      XmStringCreateLocalized(((char *)GETMESSAGE(21, 30, "Name: ")));
  n = 0;
  XtSetArg(args[n], XmNlabelString, label_string);
  n++;
  ...
  label_string =
      XmStringCreateLocalized((GETMESSAGE(21, 18, "Is Linked To: ")));
  n = 0;
  XtSetArg(args[n], XmNlabelString, label_string);
  n++;
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_FORM);
  ...
  n++;
  XtSetArg(args[n], XmNtopWidget, name);
  n++;
  XtSetArg(args[n], XmNtopOffset, 5);
  n++;
  XtSetArg(args[n], XmNtraversalOn, False);
  ...
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNleftWidget, link_label);
  n++;
  XtSetArg(args[n], XmNleftOffset, 0);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  ...
  label_string =
      XmStringCreateLocalized(((char *)GETMESSAGE(21, 3, "Owner Name: ")));
  n = 0;
  XtSetArg(args[n], XmNlabelString, label_string);
  n++;
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_FORM);
  ...
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, link_name);
  n++;
  ...
  label_string =
      XmStringCreateLocalized(((char *)GETMESSAGE(21, 4, "Group Name: ")));
  n = 0;
  XtSetArg(args[n], XmNlabelString, label_string);
  n++;
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_FORM);
  ...
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, ownerLabel);
  n++;
  XtSetArg(args[n], XmNtopOffset, 22);
  n++;
  XtSetArg(args[n], XmNtraversalOn, False);
  n++;
  ...
  n++;
  if (len[0] > len[1]) {
    XtSetArg(args[n], XmNleftWidget, ownerLabel);
    n++;
  } else {
    XtSetArg(args[n], XmNleftWidget, groupLabel);
    n++;
  }
  XtSetArg(args[n], XmNleftOffset, 0);
  n++;
  ...
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_OPPOSITE_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, groupLabel);
  n++;
  XtSetArg(args[n], XmNtopOffset, 0);
  n++;
  XtSetArg(args[n], XmNtraversalOn, False);
  ...
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNleftWidget, owner);
  n++;
  ...
  n++;
  XtSetArg(args[n], XmNhighlightThickness, 5);
  n++;
  ...
  n++;
  XtSetArg(args[n], XmNbehavior, XmICON_LABEL);
  n++;
  ...
  label_string =
      XmStringCreateLocalized(((char *)GETMESSAGE(21, 5, "Permissions:")));
  n = 0;
  XtSetArg(args[n], XmNlabelString, label_string);
  n++;
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_FORM);
  ...
  XmStringFree(label_string);
  XtAddCallback(permissionLabel, XmNhelpCallback, (XtCallbackProc)HelpRequestCB,
                HELP_PROPERTIES_DIALOG_STR);
  ...
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, permissionLabel);
  n++;
  ...
  XtAddCallback(permissionForm, XmNhelpCallback, (XtCallbackProc)HelpRequestCB,
                HELP_PROPERTIES_DIALOG_STR);

  /* Create the labels and toggles for the permissions */

  label_string = XmStringCreateLocalized(((char *)GETMESSAGE(21, 6, "Read")));
  n = 0;
  XtSetArg(args[n], XmNlabelString, label_string);
  n++;
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_POSITION);
  n++;
  XtSetArg(args[n], XmNleftPosition, 20);
  n++;
  ...
  label_string = XmStringCreateLocalized(((char *)GETMESSAGE(21, 7, "Write")));
  n = 0;
  XtSetArg(args[n], XmNlabelString, label_string);
  n++;
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_POSITION);
  n++;
  XtSetArg(args[n], XmNleftPosition, 45);
  n++;
  XtSetArg(args[n], XmNrightAttachment, XmATTACH_POSITION);
  n++;
  ...
  label_string =
      XmStringCreateLocalized(((char *)GETMESSAGE(21, 8, "Execute")));
  n = 0;
  XtSetArg(args[n], XmNlabelString, label_string);
  n++;
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_POSITION);
  n++;
  XtSetArg(args[n], XmNleftPosition, 70);
  n++;
  XtSetArg(args[n], XmNrightAttachment, XmATTACH_POSITION);
  n++;
  XtSetArg(args[n], XmNrightPosition, 95);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_FORM);
  n++;
  XtSetArg(args[n], XmNtopOffset, 10);
  ...
  label_string = XmStringCreateLocalized(((char *)GETMESSAGE(21, 9, "Owner:")));
  n = 0;
  XtSetArg(args[n], XmNlabelString, label_string);
  n++;
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_POSITION);
  n++;
  XtSetArg(args[n], XmNleftPosition, 5);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, readLabel);
  n++;
  XtSetArg(args[n], XmNtopOffset, 10);
  n++;
  XtSetArg(args[n], XmNtraversalOn, False);
  ...
  n = 0;
  XtSetArg(args[n], XmNlabelString, empty_label_string);
  n++;
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_POSITION);
  n++;
  ...
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_OPPOSITE_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, ownerPLabel);
  n++;
  XtSetArg(args[n], XmNtopOffset, 0);
  n++;
  XtSetArg(args[n], XmNbottomAttachment, XmATTACH_OPPOSITE_WIDGET);
  n++;
  XtSetArg(args[n], XmNbottomWidget, ownerPLabel);
  n++;
  XtSetArg(args[n], XmNshadowThickness, 0);
  n++;
  ownerRead = XmCreateToggleButtonGadget(permissionForm, "owner_read", args, n);
  ...
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_POSITION);
  n++;
  XtSetArg(args[n], XmNleftPosition, 54);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_OPPOSITE_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, ownerPLabel);
  ...
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_POSITION);
  n++;
  XtSetArg(args[n], XmNleftPosition, 78);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_OPPOSITE_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, ownerPLabel);
  ...
  label_string =
      XmStringCreateLocalized(((char *)GETMESSAGE(21, 10, "Group:")));
  n = 0;
  XtSetArg(args[n], XmNlabelString, label_string);
  n++;
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_POSITION);
  ...
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_OPPOSITE_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, groupPLabel);
  n++;
  XtSetArg(args[n], XmNtopOffset, 0);
  n++;
  XtSetArg(args[n], XmNbottomAttachment, XmATTACH_OPPOSITE_WIDGET);
  n++;
  XtSetArg(args[n], XmNbottomWidget, groupPLabel);
  n++;
  XtSetArg(args[n], XmNshadowThickness, 0);
  n++;
  groupRead = XmCreateToggleButtonGadget(permissionForm, "group_read", args, n);
  ...
  label_string =
      XmStringCreateLocalized(((char *)GETMESSAGE(21, 11, "Other:")));
  n = 0;
  XtSetArg(args[n], XmNlabelString, label_string);
  n++;
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_POSITION);
  ...
  n++;
  XtSetArg(args[n], XmNbottomOffset, 15);
  n++;
  XtSetArg(args[n], XmNtraversalOn, False);
  n++;
  ...
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_OPPOSITE_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, otherPLabel);
  n++;
  XtSetArg(args[n], XmNtopOffset, 0);
  n++;
  XtSetArg(args[n], XmNbottomAttachment, XmATTACH_OPPOSITE_WIDGET);
  n++;
  XtSetArg(args[n], XmNbottomWidget, otherPLabel);
  n++;
  XtSetArg(args[n], XmNshadowThickness, 0);
  n++;
  otherRead = XmCreateToggleButtonGadget(permissionForm, "other_read", args, n);
  ...
  /* Create the optional label and push button to invoke a file-system specific
   * dialog */
  /* Bottom and top attachments will be made when we know which of these widgets
   * will be mannaged */
  /* The callback will be registered in SetValues after the config file has been
   * read */
  ...
  XtSetArg(args[n], XmNleftPosition, 5);
  n++;
  fsWarning = XmCreateLabelGadget(permissionForm, "fs_warning_label", args, n);
  ...
  n++;
  fsPushButton =
      XmCreatePushButtonGadget(permissionForm, "fs_dialog_button", args, n);

  /* Create the field displaying the size */

  label_string = XmStringCreateLocalized(
      ((char *)GETMESSAGE(21, 12, "Size (in bytes): ")));
  n = 0;
  XtSetArg(args[n], XmNlabelString, label_string);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, permissionForm);
  n++;
  XtSetArg(args[n], XmNtopOffset, 10);
  n++;
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_FORM);
  ...
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNleftWidget, sizeLabel);
  n++;
  XtSetArg(args[n], XmNleftOffset, 0);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  ...
  label_string =
      XmStringCreateLocalized(((char *)GETMESSAGE(21, 13, "Modified: ")));
  n = 0;
  XtSetArg(args[n], XmNlabelString, label_string);
  n++;
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNleftWidget, size);
  n++;
  XtSetArg(args[n], XmNleftOffset, 20);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  ...
  XtSetArg(args[n], XmNleftOffset, 0);
  n++;
  XtSetArg(args[n], XmNleftWidget, modLabel);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, permissionForm);
  ...
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, sizeLabel);
  n++;
  XtSetArg(args[n], XmNtopOffset, 5);
  n++;
  XtSetArg(args[n], XmNtraversalOn, False);
  ...
  XtSetArg(args[n], XmNrightAttachment, XmATTACH_POSITION);
  n++;
  XtSetArg(args[n], XmNrightPosition, 32);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  n++;
  ...
  XtSetArg(args[n], XmNmarginHeight, 4);
  n++;
  XtSetArg(args[n], XmNuserData, flag);
  n++;
  ...
  n = 0;
  XtSetArg(args[n], XmNlabelString, cancelXmString);
  n++;
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_POSITION);
  n++;
  XtSetArg(args[n], XmNleftPosition, 35);
  n++;
  XtSetArg(args[n], XmNrightAttachment, XmATTACH_POSITION);
  n++;
  XtSetArg(args[n], XmNrightPosition, 65);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, separator);
  ...
  n = 0;
  XtSetArg(args[n], XmNlabelString, helpXmString);
  n++;
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_POSITION);
  n++;
  XtSetArg(args[n], XmNleftPosition, 68);
  n++;
  XtSetArg(args[n], XmNrightAttachment, XmATTACH_POSITION);
  n++;
...
static void InstallClose(ModAttrRec *modAttr_rec, XtCallbackProc callback,
  ...
  XtAddCallback(modAttr_rec->cancel, XmNactivateCallback, callback,
                client_data);
  ...
  if (modAttr_rec->fsPushButton != NULL)
    XtAddCallback(modAttr_rec->fsPushButton, XmNactivateCallback, callback,
                  client_data);

  delete_window_atom =
      XmInternAtom(XtDisplay(modAttr_rec->shell), "WM_DELETE_WINDOW", True);
...
static XtPointer GetResourceValues(XrmDatabase data_base, char **name_list) {
  ...
  (void)_LoadFileAttributes(modAttr_data->host, modAttr_data->directory,
                            modAttr_data->name, modAttr_data, ALL_BUT_ACCESS);
  return ((XtPointer)modAttr_data);
}
...
static void SetValues(ModAttrRec *modAttr_rec, ModAttrData *modAttr_data) {
  ...
  XmGetColors(XtScreen(modAttr_rec->bboard), colormap, background, &foreground,
  ...
  if (user_data && user_data->pw_uid == getuid() ||
    ...
    if (effective_user == root_user) {
      fullPath =
          ResolveLocalPathName(modAttr_data->host, modAttr_data->directory,
                               modAttr_data->name, home_host_name, &tt_status);

      if (TT_OK == tt_status) {
        /* Check for access rights (e.g. NFS mounted filesystem)  */
        mode = chmod(fullPath,
                     modAttr_data->accessBits + modAttr_data->setuidBits);
        XtFree(fullPath);
  ...
  if (sensitivity == True) {
    ...
    if (effective_user == root_user) {
      ...
      if (modAttr_data->owner) {
        if (getpwnam(modAttr_data->owner) == NULL) {
          char *newstring =
              XtMalloc(strlen(modAttr_data->owner) +
      ...
      if (modAttr_data->group) {
        if (getgrnam(modAttr_data->group) == NULL) {
          char *newstring =
              XtMalloc(strlen(modAttr_data->group) +
                       strlen(GETMESSAGE(21, 19, "Unknown")) + 10);
    ...
    if (modAttr_data->group) {
      ...
      XmTextFieldSetString(modAttr_rec->group, (GETMESSAGE(21, 19, "Unknown")));
    }
  } else {
    XtUnmanageChild(modAttr_rec->owner);
    XtUnmanageChild(modAttr_rec->group);
  ...
  if (modAttr_data->name) {
    ...
    temp =
        XtMalloc(strlen(modAttr_data->host) + strlen(modAttr_data->directory) +
  ...
  _DtCheckAndFreePixmapData(modAttr_data->filetype, toplevel,
  ...
  if (fsDialogAvailable(fullPath, &modAttr_rec->fileSystem)) {
    if (strlen(modAttr_rec->fileSystem.warningMessage) ==
        0) /* fs dialog is available and there is no warning message */
    {
      ...
      XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
      n++;
      XtSetArg(args[n], XmNtopWidget, modAttr_rec->otherPLabel);
      n++;
      XtSetArg(args[n], XmNtopOffset, 15);
      n++;
      XtSetArg(args[n], XmNbottomAttachment, XmATTACH_FORM);
    ...
    } else /* fs dialog is available and there is a warning message */
    {
      ...
      XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
      n++;
      XtSetArg(args[n], XmNtopWidget, modAttr_rec->fsWarning);
      n++;
      XtSetArg(args[n], XmNtopOffset, 15);
      n++;
      XtSetArg(args[n], XmNbottomAttachment, XmATTACH_FORM);
    ...
    XtAddCallback(modAttr_rec->fsPushButton, XmNactivateCallback,
                  (XtCallbackProc)displayFSDialog, &modAttr_rec->fileSystem);
    XtManageChild(modAttr_rec->fsPushButton);
  } else {
    if (strlen(modAttr_rec->fileSystem.warningMessage) ==
        0) /* fs dialog not available and there is no warning message */
    {
...
static void WriteResourceValues(DialogData *values, int fd, char **name_list) {
  ...
  _DtDialogPutResources(fd, name_list, MODIFY_ATTR, values->data, resources,
                        modAttrClass->resource_count);
}
...
static void OkCallback(Widget w, ModAttrApply *apply_data,
                       XtPointer call_data) {
  ...
  if (result == GMA_VALID) {
    ...
    if (question) {
      ...
      message = XtNewString(GETMESSAGE(
          21, 37,
          "You are changing the permissions on the Current\nFolder in a way "
          "that won't allow you to view\nthis folder any longer.  It will be "
    ...
    tmpmsg = GETMESSAGE(
        21, 35,
        "The Permissions dialog for the object\n\n%s/%s\n\nhas been closed "
        "because this object has been deleted\nfrom your system.");
    msg = XtMalloc(strlen(tmpmsg) + strlen(old->directory) + strlen(old->name) +
                   3);
...
static void InvalidModAttrMessage(Widget w, int messageIndex) {
  ...
  if (unknownUser == NULL) {
    tmpStr = GETMESSAGE(
        21, 31, "Owner Name is invalid.\nThe specified user does not exist.");
    unknownUser = XtNewString(tmpStr);
    tmpStr = GETMESSAGE(
        21, 32,
        "Group Name is invalid.\n\nNo group of users with this name has been "
        "created on your system.\nUse your system administration software if "
  ...
  if (file_data && (file_data->errnum == 0 || file_data->link)) {
    ...
    if (mask & FILETYPE) {
      ...
      modAttr_data->pixmapData = _DtRetrievePixmapData(
          file_data->logical_type, NULL, NULL, toplevel, LARGE);
    } else {
      modAttr_data->filetype = NULL;
      modAttr_data->pixmapData = NULL;
    }
...
Boolean LoadFileAttributes(String host, String dir, String file,
                           ModAttrData *modAttr_data) {
  FileData *file_data = NULL;
...

{
  ...
  case -1: /* error forking */
    ...
    n = 0;
    XtSetArg(args[n], XmNmessageString, xm_string);
    n++;
  ...
  case 0: /* child */
    ...
    /*   to display it                                        */
    s = (char *)XtMalloc(
        50 + strlen(GETMESSAGE(21, 27, "Error executing file system dialog")) +
        strlen(GETMESSAGE(21, 28, "Attempting to execute: ")) +
        strlen(fileSystem->fsDialogProgram) + strlen(fileSystem->path) +
    ...
    execl(errorScript, errorScript, /* argv[0] */
          s,                        /* argv[1] */
          NULL);
...
void ModAttrFreeValues(ModAttrData *modAttr_data) { FreeValues(modAttr_data); }
