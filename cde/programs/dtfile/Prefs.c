...
static void Create(Display *display, Widget parent, Widget *return_widget,
                   XtPointer *dialog);
static void InstallChange(PreferencesRec *preferences_rec,
                          XtCallbackProc callback, XtPointer client_data);
static void InstallClose(PreferencesRec *preferences_rec,
                         XtCallbackProc callback, XtPointer client_data);
static void Destroy(PreferencesRec *preferences_rec);
static XtPointer GetValues(PreferencesRec *preferences_rec);
static XtPointer GetDefaultValues(void);
static XtPointer GetResourceValues(XrmDatabase data_base, char **name_list);
static void SetValues(PreferencesRec *preferences_rec,
                      PreferencesData *preferences_data);
static void WriteResourceValues(DialogData *values, int fd, char **name_list);
static void FreeValues(PreferencesData *preferences_data);
static void ResetCallback(Widget w, XtPointer client_data, XtPointer call_data);
static void ToggleCallback(Widget w, XtPointer client_data,
                           XtPointer call_data);
static void OkCallback(Widget w, PreferencesApply *apply_data,
                       XtPointer call_data);
static void ApplyCallback(Widget w, PreferencesApply *apply_data,
                          XtPointer call_data);
static void GetPreferencesValues(PreferencesRec *preferences_rec,
                                 PreferencesData *preferences_data);
...
static DialogResource resources[] = {
    {"showType", SHOW_TYPE, sizeof(unsigned char),
     XtOffset(PreferencesDataPtr, show_type), (XtPointer)SINGLE_DIRECTORY,
     ShowTypeToString},

    {"treeFiles", TREE_FILES, sizeof(unsigned char),
     XtOffset(PreferencesDataPtr, tree_files), (XtPointer)TREE_FILES_NEVER,
     TreeFilesToString},

    {"view_single", VIEW, sizeof(unsigned char),
     XtOffset(PreferencesDataPtr, view_single), (XtPointer)BY_NAME_AND_ICON,
     ViewToString},

    {"view_tree", VIEW, sizeof(unsigned char),
     XtOffset(PreferencesDataPtr, view_tree), (XtPointer)BY_NAME_AND_SMALL_ICON,
     ViewToString},

    {"order", ORDER, sizeof(unsigned char), XtOffset(PreferencesDataPtr, order),
     (XtPointer)ORDER_BY_ALPHABETICAL, OrderToString},

    {"direction", DIRECTION_RESRC, sizeof(unsigned char),
     XtOffset(PreferencesDataPtr, direction), (XtPointer)DIRECTION_ASCENDING,
     DirectionToString},

    {"positionEnabled", RANDOM, sizeof(unsigned char),
     XtOffset(PreferencesDataPtr, positionEnabled), (XtPointer)RANDOM_OFF,
     RandomToString},
};
...
static void Create(Display *display, Widget parent, Widget *return_widget,
  ...
  */
  ...
  n = 0;
  XtSetArg(args[n], XmNtitleString, label_string);
  n++;
  ...
  n++;
  XtSetArg(args[n], XmNmarginWidth, offset);
  n++;
  XtSetArg(args[n], XmNmarginHeight, offset);
  n++;
  headers_frame = _DtCreateTitleBox(form, "headers_frame", args, n);
  XtManageChild(headers_frame);
  XtAddCallback(headers_frame, XmNhelpCallback, (XtCallbackProc)HelpRequestCB,
  ...
  n++;
  XtSetArg(args[n], XmNleftWidget, preferences_rec->show_iconic_path);
  n++;
  ...
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNleftWidget, preferences_rec->show_current_dir);
  n++;
  XtSetArg(args[n], XmNleftOffset, 10);
  n++;
  ...
  n++;
  XtSetArg(args[n], XmNtopWidget, headers_frame);
  n++;
  XtSetArg(args[n], XmNtopOffset, offset);
  n++;
  XtSetArg(args[n], XmNrightAttachment, XmATTACH_FORM);
  ...
  XtAddCallback(position_frame, XmNhelpCallback, (XtCallbackProc)HelpRequestCB,
  ...
  label_string =
      XmStringCreateLocalized((GETMESSAGE(23, 35, "Rows and Columns")));
  n = 0;
  XtSetArg(args[n], XmNlabelString, label_string);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_FORM);
  ...
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNleftWidget, preferences_rec->random_on);
  n++;
  XtSetArg(args[n], XmNleftOffset, 10);
  n++;
  XtSetArg(args[n], XmNindicatorType, XmONE_OF_MANY);
  ...
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, position_frame);
  n++;
  XtSetArg(args[n], XmNtopOffset, offset);
  n++;
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_FORM);
  ...
  label_string =
      XmStringCreateLocalized(((char *)GETMESSAGE(23, 8, "By Single Folder")));
  n = 0;
  XtSetArg(args[n], XmNlabelString, label_string);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_FORM);
  ...
  label_string =
      XmStringCreateLocalized(((char *)GETMESSAGE(23, 9, "By Tree")));
  n = 0;
  XtSetArg(args[n], XmNlabelString, label_string);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, temp);
  n++;
  XtSetArg(args[n], XmNtopOffset, offset);
  n++;
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_FORM);
  ...
  label_string =
      XmStringCreateLocalized(((char *)GETMESSAGE(23, 27, "Folders only")));
  n = 0;
  XtSetArg(args[n], XmNlabelString, label_string);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  ...
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_FORM);
  n++;
  XtSetArg(args[n], XmNleftOffset, 25);
  n++;
  XtSetArg(args[n], XmNindicatorType, XmONE_OF_MANY);
  n++;
  ...
  label_string = XmStringCreateLocalized(
      ((char *)GETMESSAGE(23, 28, "Folders, then Files")));
  n = 0;
  XtSetArg(args[n], XmNlabelString, label_string);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  ...
  label_string = XmStringCreateLocalized(
      ((char *)GETMESSAGE(23, 29, "Folders and Files")));
  n = 0;
  XtSetArg(args[n], XmNlabelString, label_string);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  ...
  label_string =
      XmStringCreateLocalized(((char *)GETMESSAGE(23, 31, "Representation")));
  n = 0;
  XtSetArg(args[n], XmNtitleString, label_string);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  ...
  XtSetArg(args[n], XmNleftOffset, 10);
  n++;
  XtSetArg(args[n], XmNleftWidget, show_frame);
  n++;
  XtSetArg(args[n], XmNrightAttachment, XmATTACH_FORM);
  n++;
  XtSetArg(args[n], XmNrightOffset, offset);
  ...
  n++;
  XtSetArg(args[n], XmNbottomWidget, show_frame);
  n++;
  XtSetArg(args[n], XmNmarginWidth, offset);
  n++;
  XtSetArg(args[n], XmNmarginHeight, offset);
  ...
  label_string =
      XmStringCreateLocalized(((char *)GETMESSAGE(23, 32, "By Name Only")));
  n = 0;
  XtSetArg(args[n], XmNlabelString, label_string);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_FORM);
  ...
  label_string =
      XmStringCreateLocalized(((char *)GETMESSAGE(23, 33, "By Large Icons")));
  n = 0;
  XtSetArg(args[n], XmNlabelString, label_string);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  ...
  label_string =
      XmStringCreateLocalized(((char *)GETMESSAGE(23, 34, "By Small Icons")));
  n = 0;
  XtSetArg(args[n], XmNlabelString, label_string);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  ...
  label_string = XmStringCreateLocalized(
      ((char *)GETMESSAGE(23, 6, "By Name, date, size ...")));
  n = 0;
  XtSetArg(args[n], XmNlabelString, label_string);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  ...
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, view_frame);
  n++;
  XtSetArg(args[n], XmNtopOffset, offset);
  n++;
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_FORM);
  ...
  n++;
  XtSetArg(args[n], XmNrightWidget, show_frame);
  n++;
  XtSetArg(args[n], XmNmarginWidth, offset);
  n++;
  XtSetArg(args[n], XmNmarginHeight, offset);
  ...
  label_string =
      XmStringCreateLocalized(((char *)GETMESSAGE(23, 12, "Alphabetically")));
  n = 0;
  XtSetArg(args[n], XmNlabelString, label_string);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_FORM);
  ...
  label_string =
      XmStringCreateLocalized(((char *)GETMESSAGE(23, 11, "By File Type")));
  n = 0;
  XtSetArg(args[n], XmNlabelString, label_string);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  ...
  label_string =
      XmStringCreateLocalized(((char *)GETMESSAGE(23, 13, "By Date")));
  n = 0;
  XtSetArg(args[n], XmNlabelString, label_string);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  ...
  label_string =
      XmStringCreateLocalized(((char *)GETMESSAGE(23, 14, "By Size")));
  ...
  label_string =
      XmStringCreateLocalized(((char *)GETMESSAGE(23, 15, "Direction")));
  n = 0;
  XtSetArg(args[n], XmNtitleString, label_string);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  ...
  XtSetArg(args[n], XmNbottomAttachment, XmATTACH_OPPOSITE_WIDGET);
  n++;
  XtSetArg(args[n], XmNbottomWidget, order_frame);
  n++;
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_OPPOSITE_WIDGET);
  n++;
  XtSetArg(args[n], XmNleftWidget, view_frame);
  n++;
  XtSetArg(args[n], XmNrightAttachment, XmATTACH_FORM);
  n++;
  XtSetArg(args[n], XmNrightOffset, offset);
  ...
  XmStringFree(label_string);
  XtAddCallback(direction_frame, XmNhelpCallback, (XtCallbackProc)HelpRequestCB,
  ...
  label_string =
      XmStringCreateLocalized(((char *)GETMESSAGE(23, 16, "Ascending")));
  ...
  label_string =
      XmStringCreateLocalized(((char *)GETMESSAGE(23, 17, "Descending")));
  ...
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, order_frame);
  n++;
  XtSetArg(args[n], XmNtopOffset, offset);
  n++;
  ...
  n++;
  XtSetArg(args[n], XmNrightPosition, 19);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  n++;
  ...
  n++;
  preferences_rec->ok = temp = XmCreatePushButtonGadget(form, "ok", args, n);
  XtManageChild(temp);
  XtAddCallback(temp, XmNhelpCallback, (XtCallbackProc)HelpRequestCB,
                HELP_PREFERENCES_DIALOG_STR);

  n = 0;
  XtSetArg(args[n], XmNlabelString, applyXmString);
  n++;
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_POSITION);
  n++;
  XtSetArg(args[n], XmNleftPosition, 21);
  n++;
  XtSetArg(args[n], XmNrightAttachment, XmATTACH_POSITION);
  n++;
  XtSetArg(args[n], XmNrightPosition, 39);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, separator);
  ...
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_POSITION);
  n++;
  XtSetArg(args[n], XmNleftPosition, 41);
  n++;
  XtSetArg(args[n], XmNrightAttachment, XmATTACH_POSITION);
  n++;
  XtSetArg(args[n], XmNrightPosition, 59);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, separator);
  ...
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_POSITION);
  n++;
  XtSetArg(args[n], XmNleftPosition, 61);
  n++;
  XtSetArg(args[n], XmNrightAttachment, XmATTACH_POSITION);
  n++;
  XtSetArg(args[n], XmNrightPosition, 79);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, separator);
  ...
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_POSITION);
  n++;
  XtSetArg(args[n], XmNleftPosition, 81);
  n++;
  XtSetArg(args[n], XmNrightAttachment, XmATTACH_POSITION);
  n++;
...
static void InstallClose(PreferencesRec *preferences_rec,
  ...
  XtAddCallback(preferences_rec->close, XmNactivateCallback, callback,
                client_data);

  delete_window_atom =
      XmInternAtom(XtDisplay(preferences_rec->shell), "WM_DELETE_WINDOW", True);
  XmRemoveWMProtocols(preferences_rec->shell, &delete_window_atom, 1);
  XmAddWMProtocolCallback(preferences_rec->shell, delete_window_atom, callback,
...
static void WriteResourceValues(DialogData *values, int fd, char **name_list) {
  ...
  _DtDialogPutResources(fd, name_list, PreferencesName, values->data, resources,
                        preferencesClass->resource_count);
}
...
static void ResetCallback(Widget w, XtPointer client_data,
                          XtPointer call_data) {
...
static void GetPreferencesValues(PreferencesRec *preferences_rec,
  ...
  XtGetValues(preferences_rec->show_multiple, args, 1);
  if (set)
    preferences_data->show_type = MULTIPLE_DIRECTORY;
  ...
  if (set)
    preferences_data->direction = DIRECTION_DESCENDING;

  XtGetValues(preferences_rec->random_on, args, 1);
  if (set)
    preferences_data->positionEnabled = RANDOM_ON;
...
void ShowTypeToString(int fd, XtPointer value, char *out_buf) {
  unsigned char *val = (unsigned char *)value;
  char *buf = NULL;

  if (*val == SINGLE_DIRECTORY)
    buf = Single_directory;
  else if (*val == MULTIPLE_DIRECTORY)
    buf = DirectoryTree;

  _DtStringToString(fd, (XtPointer)&buf, out_buf);
}
...
void StringToShowType(XrmValuePtr args, Cardinal *num_args, XrmValue *from_val,
                      XrmValue *to_val) {
...
void TreeFilesToString(int fd, XtPointer value, char *out_buf) {
  unsigned char *val = (unsigned char *)value;
  char *buf = NULL;

  if (*val == TREE_FILES_NEVER)
    buf = Tree_files_never;
  else if (*val == TREE_FILES_CHOOSE)
    buf = Tree_files_choose;
  else if (*val == TREE_FILES_ALWAYS)
...
void StringToTreeFiles(XrmValuePtr args, Cardinal *num_args, XrmValue *from_val,
                       XrmValue *to_val) {
  char *in_str = (char *)(from_val->addr);
  static unsigned char i;
...
void ViewToString(int fd, XtPointer value, char *out_buf) {
  unsigned char *val = (unsigned char *)value;
  char *buf = NULL;

  if (*val == BY_NAME)
    buf = By_name;
  else if (*val == BY_NAME_AND_ICON)
    buf = By_name_and_icon;
  else if (*val == BY_NAME_AND_SMALL_ICON)
    buf = By_name_and_small_icon;
  else if (*val == BY_ATTRIBUTES)
    buf = By_attributes;
...
void StringToView(XrmValuePtr args, Cardinal *num_args, XrmValue *from_val,
                  XrmValue *to_val) {
  char *in_str = (char *)(from_val->addr);
  static unsigned char i;
...
void OrderToString(int fd, XtPointer value, char *out_buf) {
  unsigned char *val = (unsigned char *)value;
  char *buf = NULL;

  if (*val == ORDER_BY_FILE_TYPE)
    buf = Order_by_file_type;
  else if (*val == ORDER_BY_ALPHABETICAL)
    buf = Order_by_alphabetical;
  else if (*val == ORDER_BY_DATE)
    buf = Order_by_date;
  else if (*val == ORDER_BY_SIZE)
    buf = Order_by_size;
...
void StringToOrder(XrmValuePtr args, Cardinal *num_args, XrmValue *from_val,
                   XrmValue *to_val) {
  char *in_str = (char *)(from_val->addr);
  static unsigned char i;
...
void DirectionToString(int fd, XtPointer value, char *out_buf) {
  unsigned char *val = (unsigned char *)value;
  char *buf = NULL;

  if (*val == DIRECTION_ASCENDING)
    buf = Direction_ascending;
  else if (*val == DIRECTION_DESCENDING)
...
void RandomToString(int fd, XtPointer value, char *out_buf) {
  unsigned char *val = (unsigned char *)value;
  char *buf = NULL;

  if (*val == RANDOM_ON)
    buf = Random_on;
  else if (*val == RANDOM_OFF)
    buf = Random_off;
...
void StringToDirection(XrmValuePtr args, Cardinal *num_args, XrmValue *from_val,
                       XrmValue *to_val) {
  char *in_str = (char *)(from_val->addr);
  static unsigned char i;
...
void StringToRandom(XrmValuePtr args, Cardinal *num_args, XrmValue *from_val,
                    XrmValue *to_val) {
  char *in_str = (char *)(from_val->addr);
  static unsigned char i;
