...
void RenameDone(XtPointer client_data, char *data, int rc);
...
static void FileTypePreviewCB(Widget w, XtPointer client_data,
                              XtPointer call_data);
static void MakeFileOk(Widget w, XtPointer client_data, XtPointer call_data);
static void MakeFileApply(Widget w, XtPointer client_data, XtPointer call_data);
static void MakeFileDone(XtPointer client_data, char *to, int rc);
static void ApplyFileDone(XtPointer client_data, char *to, int rc);
static void DialogCancel(Widget w, XtPointer client_data, XtPointer call_data);
...
void ShowRenameFileDialog(Widget w, XtPointer client_data,
                          XtPointer call_data) {
...
void ShowCopyFileDialog(Widget w, XtPointer client_data, XtPointer call_data) {
  FileMgrRec *file_mgr_rec;
  DialogData *dialog_data;
  FileMgrData *file_mgr_data;
  static FileViewData
      *file_view_data; /* static because it is passed to RenameOk callback */
  ...
  XtSetArg(args[n], XmNtitle, tempStr);
  n++;
  ...
  n++;
#endif
  XtSetArg(args[n], XmNuserData, file_mgr_rec);
  n++;
  ...
  n++;
  XtSetArg(args[n], XmNtopWidget, current_name);
  n++;
  ...
  label_string =
      XmStringCreateLocalized(((char *)GETMESSAGE(10, 8, "File Type")));
  ...
  n++;
  XtSetArg(args[n], XmNrightWidget, file_type_box);
  n++;
  XtSetArg(args[n], XmNrightOffset, 5);
  n++;
  ...
  label_string = XmStringCreateLocalized(
      ((char *)GETMESSAGE(10, 34, "Destination Folder: ")));
  ...
  XtSetArg(args[n], XmNleftOffset, 5);
  n++;
  XtSetArg(args[n], XmNleftWidget, dir_label);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_FORM);
  n++;
  XtSetArg(args[n], XmNrightAttachment, XmATTACH_FORM);
  ...
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, dir_form);
  n++;
  XtSetArg(args[n], XmNtopOffset, 5);
  n++;
  XtSetArg(args[n], XmNrightAttachment, XmATTACH_WIDGET);
  ...
  label_string =
      XmStringCreateLocalized(((char *)GETMESSAGE(10, 38, "Name for copy : ")));
  ...
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNleftWidget, file_label);
  n++;
  XtSetArg(args[n], XmNleftOffset, 5);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_FORM);
  ...
  call_struct = (DialogCallbackStruct *)XtMalloc(sizeof(DialogCallbackStruct));
  ...
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, file_type_box);
  n++;
  XtSetArg(args[n], XmNtopOffset, 5);
  n++;
  ...
  n++;
  XtSetArg(args[n], XmNrightPosition, 21);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  n++;
  ...
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_POSITION);
  n++;
  XtSetArg(args[n], XmNleftPosition, 22);
  n++;
  XtSetArg(args[n], XmNrightAttachment, XmATTACH_POSITION);
  n++;
  XtSetArg(args[n], XmNrightPosition, 42);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, separator);
  ...
  label_string =
      XmStringCreateLocalized(((char *)GETMESSAGE(10, 36, "Show Icon")));
  ...
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_POSITION);
  n++;
  XtSetArg(args[n], XmNleftPosition, 43);
  n++;
  XtSetArg(args[n], XmNrightAttachment, XmATTACH_POSITION);
  n++;
  XtSetArg(args[n], XmNrightPosition, 78);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, separator);
  ...
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_POSITION);
  n++;
  XtSetArg(args[n], XmNleftPosition, 79);
  n++;
  XtSetArg(args[n], XmNrightAttachment, XmATTACH_POSITION);
  n++;
...
void ShowMoveFileDialog(Widget w, XtPointer client_data, XtPointer call_data) {
  FileMgrRec *file_mgr_rec;
  DialogData *dialog_data;
  static FileMgrData
      *file_mgr_data; /* static because it is passed to RenameOk callback */
  FileViewData *file_view_data;
  ...
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNleftWidget, new_name);
  n++;
  ...
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, new_name);
  n++;
  XtSetArg(args[n], XmNtopOffset, 10);
  n++;
  separator = XmCreateSeparatorGadget(form, "separator", args, n);
...
void ShowLinkFileDialog(Widget w, XtPointer client_data, XtPointer call_data) {
  FileMgrRec *file_mgr_rec;
  DialogData *dialog_data;
  static FileMgrData
      *file_mgr_data; /* static because it is passed to RenameOk callback */
  ...
  XtSetArg(args[n], XmNlabelString, label_string);
  n++;
  XtSetArg(args[n], XmNrightWidget, dir_text);
  n++;
  XtSetArg(args[n], XmNrightAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNrightOffset, 5);
  ...
  n++;
  XtSetArg(args[n], XmNleftWidget, dir_text);
  n++;
  XtSetArg(args[n], XmNleftOffset, 0);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, dir_label);
  n++;
  XtSetArg(args[n], XmNtopOffset, 5);
  n++;
  XtSetArg(args[n], XmNtraversalOn, True);
  ...
  XtSetArg(args[n], XmNlabelString, label_string);
  n++;
  XtSetArg(args[n], XmNrightWidget, file_text);
  n++;
  XtSetArg(args[n], XmNrightAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNrightOffset, 5);
  ...
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, file_label);
  n++;
  XtSetArg(args[n], XmNtopOffset, 10);
  n++;
  separator = XmCreateSeparatorGadget(form, "separator", args, n);
...
static void RenameOk(Widget w, XtPointer client_data, XtPointer call_data) {
  ...
  if (strlen(new_dir) == 0)
    msg = XtNewString(
        GETMESSAGE(10, 11, "A file or folder cannot have a blank name."));
#ifdef _CHECK_FOR_SPACES
  else if (DtStrchr(new_dir, ' ') != NULL || DtStrchr(new_dir, '\t') != NULL)
  ...
  GetTarget(call_struct->host_name, call_struct->directory_name, new, to_host,
            to_dir, to_file);
  ...
  FileMoveCopy(call_struct->file_mgr_data, to_file, to_dir, to_host, host_set,
               file_set, file_count, modifiers, RenameDone, (XtPointer)data);
...
void RenameDone(XtPointer client_data, char *data, int rc) {
  RenameDoneData *done_data = (RenameDoneData *)client_data;
  DialogCallbackStruct *call_struct = done_data->call_struct;
  ...
  if (rc == 0) {
    ...
    call_struct->file_mgr_rec->menuStates |= done_data->btnMask;
...
static Boolean GetToPath(char *to, char *new_name, char *host_in,
  ...
  if (strncmp(new_name, "/", 1) == 0) {
    if ((path = (char *)ResolveLocalPathName(
             host_in, new_name, NULL, home_host_name, &tt_status)) == NULL)
      return (False);
  } else {
    if (strcmp(dir_in, "/") == 0)
    ...
    if ((path = (char *)ResolveLocalPathName(host_in, to, NULL, home_host_name,
                                             &tt_status)) == NULL)
      return (False);
  }
...
static void FileTypePreview(Widget w, String new_name, XtPointer client_data,
  ...
  orig_name =
      ResolveLocalPathName(call_struct->host_name, call_struct->directory_name,
                           call_struct->file_name, home_host_name, &tt_status);
  ...
  else if (*new_name == 0x0 && call_struct->original_physical_type == DtDATA)
    file_type = XtNewString(LT_DATA);
  else if (link_path = _DtFollowLink(whole_name)) {
    if (strcmp(orig_name, whole_name) == 0)
      file_type = (char *)DtDtsDataToDataType(orig_name, NULL, 0, NULL, NULL,
                                              NULL, NULL);
    else {
      if (call_struct->menu_widget == *renameBtn) {
        ...
        if ((link_path = _DtFollowLink(orig_name)) &&
          ...
          file_type = (char *)DtDtsDataToDataType(new_link_path, NULL, 0, NULL,
                                                  NULL, NULL, NULL);
        } else {
        ...
        */
        ...
        file_type = (char *)DtDtsDataToDataType(link_path, NULL, 0, &fileStat,
                                                NULL, NULL, NULL);
        umask(creationMask);
      }
    }
  ...
  if (file_type) {
    if (call_struct->previous_file_type &&
      ...
      if (Flag == False) {
        ...
        tmpStr = GETMESSAGE(
            10, 41, "The correct icon for this datatype is already shown.");
    ...
    if (DtActionExists(file_type)) {
      ...
      char *str =
          (char *)DtDtsDataTypeToAttributeValue(file_type, FM_TYPE_LABEL, NULL);
      if (str) {
        string = XmStringCreateLocalized(str);
    ...
    XtSetArg(args[n], XmNstring, string);
    n++;

    pixmapData =
        _DtRetrievePixmapData(file_type, call_struct->file_name,
                              call_struct->directory_name, toplevel, LARGE);
    if (pixmapData)
    ...
    _DtCheckAndFreePixmapData(file_type, toplevel,
...
void ShowMakeFileDialog(Widget w, XtPointer client_data, XtPointer call_data) {
  FileMgrRec *file_mgr_rec;
  DialogData *dialog_data;
  FileMgrData *file_mgr_data;
  ...
  if (w == *create_directoryBtn) {
    ...
    label_string = XmStringCreateLocalized(
        ((char *)GETMESSAGE(10, 16, "New Folder Name: ")));
  } else if (w == *create_dataBtn) {
    /* Ignore accelerators when we're insensitive */
    if (file_mgr_rec->create_dataBtn_child) {
      XSetInputFocus(XtDisplay(w), XtWindow(file_mgr_rec->create_dataBtn_child),
                     RevertToParent, CurrentTime);
      return;
    }
    ...
    label_string =
        XmStringCreateLocalized(((char *)GETMESSAGE(10, 7, "New File Name: ")));
  }
  XtFree(tempStr);
  ...
  */
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_FORM);
  n++;
  XtSetArg(args[n], XmNtopOffset, 30);
  n++;
  XtSetArg(args[n], XmNtraversalOn, False);
  n++;
  new_name = XmCreateLabelGadget(form, "new_name", args, n);
  ...
  */
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_POSITION);
  n++;
  XtSetArg(args[n], XmNleftPosition, 75);
  n++;
  /*
  ...
  */
  ...
  XtAddCallback(apply, XmNactivateCallback, MakeFileApply,
                (XtPointer)call_struct);
  ...
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_POSITION);
  n++;
  XtSetArg(args[n], XmNleftPosition, 60);
  n++;
  XtSetArg(args[n], XmNrightAttachment, XmATTACH_POSITION);
  n++;
  ...
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_POSITION);
  n++;
  XtSetArg(args[n], XmNleftPosition, 80);
  n++;
  XtSetArg(args[n], XmNrightAttachment, XmATTACH_POSITION);
  n++;
  XtSetArg(args[n], XmNrightPosition, 99);
...
static void MakeFileOk(Widget w, XtPointer client_data, XtPointer call_data) {
  ...
  msg = NULL;
  if (length == 0) {
    msg = XtNewString(GETMESSAGE(
        10, 22, "Cannot create a file or folder with a blank name."));
  }
  ...
  */
  ...
  MakeFile(w, call_struct->host_name, call_struct->directory_name, new_name,
           type, MakeFileDone, (XtPointer)data);
}
...
static void MakeFileApply(Widget w, XtPointer client_data,
                          XtPointer call_data) {
  DialogCallbackStruct *call_struct = (DialogCallbackStruct *)client_data;
  char *new_name;
  unsigned char type;
  ...
  */
  ...
  MakeFile(w, call_struct->host_name, call_struct->directory_name, new_name,
           type, ApplyFileDone, (XtPointer)data);
...
int RecheckFlag(Widget parent, Widget w) {
  Arg args[2];
  XtArgVal flag;
...
void ResetFlag(Widget parent, Widget w) {
  Arg args[2];
  XtArgVal flag0;
  int flag;
