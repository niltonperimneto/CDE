 ...
 */
void vwr_destroy_tree(ViewerNode *tree);

void vwr_delete_tree(Viewer *v, ViewerNode *node);

void vwr_reset(Viewer *v);

VNode vwr_traverse_tree(VNode tree, int (*fn)(VNode));

void vwr_init_elements(VNode vnode);

/*
 * Viewer graphics routines.
 */
VNode vwr_locate_node(Viewer *v, int x, int y);

void vwr_get_cond(VNode tree, VNode **array, /* RETURN */
                  int *num,                  /* RETURN */
                  int (*cond)(VNode));

void vwr_num_cond(VNode tree, int *num, /* RETURN */
                  int (*cond)(VNode));

void vwr_repaint(Viewer *v);
