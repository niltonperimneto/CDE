...
#ifndef _DtCv_TEXT_HILITE_T
#define _DtCv_TEXT_HILITE_T
typedef enum {
...
#define _DtCvSetTypeToLine(x) (((x) & ~(_DtCvPRIMARY_MASK)) | _DtCvLINE)
#define _DtCvSetTypeToMarker(x) (((x) & ~(_DtCvPRIMARY_MASK)) | _DtCvMARKER)
#define _DtCvSetTypeToNoop(x) (((x) & ~(_DtCvPRIMARY_MASK)) | _DtCvNOOP)
#define _DtCvSetTypeToRegion(x) (((x) & ~(_DtCvPRIMARY_MASK)) | _DtCvREGION)
#define _DtCvSetTypeToString(x) (((x) & ~(_DtCvPRIMARY_MASK)) | _DtCvSTRING)
#define _DtCvSetTypeToTable(x) (((x) & ~(_DtCvPRIMARY_MASK)) | _DtCvTABLE)
/*
 * set segment flags
 */
 ...
 * get segment flags
 */
#define _DtCvIsSegController(x) ((((x)->type) & _DtCvCONTROLLER) ? 1 : 0)
#define _DtCvIsSegBlockLine(x) ((((x)->type) & _DtCvBLOCK_LINE) ? 1 : 0)
#define _DtCvIsSegGhostLink(x) ((((x)->type) & _DtCvGHOST_LINK) ? 1 : 0)
#define _DtCvIsSegHyperText(x) ((((x)->type) & _DtCvHYPER_TEXT) ? 1 : 0)
#define _DtCvIsSegInLine(x) ((((x)->type) & _DtCvIN_LINE) ? 1 : 0)
#define _DtCvIsSegNewLine(x) ((((x)->type) & _DtCvNEW_LINE) ? 1 : 0)
#define _DtCvIsSegNonBreakingChar(x) ((((x)->type) & _DtCvNON_BREAK) ? 1 : 0)
#define _DtCvIsSegPageBreak(x) ((((x)->type) & _DtCvPAGE_BREAK) ? 1 : 0)
#define _DtCvIsSegRegChar(x) ((((x)->type) & _DtCvWIDE_CHAR) ? 0 : 1)
#define _DtCvIsSegSubScript(x) ((((x)->type) & _DtCvSUB_SCRIPT) ? 1 : 0)
#define _DtCvIsSegSuperScript(x) ((((x)->type) & _DtCvSUPER_SCRIPT) ? 1 : 0)
#define _DtCvIsSegWideChar(x) ((((x)->type) & _DtCvWIDE_CHAR) ? 1 : 0)
/*
 * segment access
 */
 ...
 * container access
 */
#define _DtCvContainerOfSeg(x) ((x)->handle.container)
#define _DtCvContainerBMarginOfSeg(x) ((x)->handle.container.bmargin)
#define _DtCvContainerBorderOfSeg(x) ((x)->handle.container.border)
#define _DtCvContainerFlowOfSeg(x) ((x)->handle.container.flow)
#define _DtCvContainerFMarginOfSeg(x) ((x)->handle.container.fmargin)
#define _DtCvContainerIdOfSeg(x) ((x)->handle.container.id)
#define _DtCvContainerJustifyCharOfSeg(x) ((x)->handle.container.justify_char)
#define _DtCvContainerJustifyOfSeg(x) ((x)->handle.container.justify)
#define _DtCvContainerLeadingOfSeg(x) ((x)->handle.container.leading)
#define _DtCvContainerLineWidthOfSeg(x) ((x)->handle.container.bdr_info.width)
#define _DtCvContainerLineDataOfSeg(x) ((x)->handle.container.bdr_info.data)
#define _DtCvContainerListOfSeg(x) ((x)->handle.container.seg_list)
#define _DtCvContainerLMarginOfSeg(x) ((x)->handle.container.lmargin)
#define _DtCvContainerOrientOfSeg(x) ((x)->handle.container.orient)
#define _DtCvContainerPercentOfSeg(x) ((x)->handle.container.percent)
#define _DtCvContainerRMarginOfSeg(x) ((x)->handle.container.rmargin)
#define _DtCvContainerTMarginOfSeg(x) ((x)->handle.container.tmargin)
#define _DtCvContainerTypeOfSeg(x) ((x)->handle.container.type)
#define _DtCvContainerVJustifyOfSeg(x) ((x)->handle.container.vjustify)
#define _DtCvContainerVOrientOfSeg(x) ((x)->handle.container.vorient)
