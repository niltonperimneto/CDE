 ...
 ******************************************************************************/
static int AddRowToTable(FormatStruct *my_struct, const SDLMask *element_types,
                         enum SdlElement sig_element, SDLMask *exceptions,
                         SDLMask *process_mask);
static int AllocateBlock(FormatStruct *my_struct, const SDLMask *element_types,
                         enum SdlElement sig_element, SDLMask *exceptions,
                         SDLMask *process_mask);
static int Cdata(FormatStruct *my_struct, const SDLMask *element_types,
                 enum SdlElement sig_element, SDLMask *exceptions,
                 SDLMask *process_mask);
static int CheckForSnb(FormatStruct *my_struct, const SDLMask *element_types,
                       enum SdlElement sig_element, SDLMask *exceptions,
                       SDLMask *process_mask);
static int CheckType(FormatStruct *my_struct, const SDLMask *element_types,
                     enum SdlElement sig_element, SDLMask *exceptions,
                     SDLMask *process_mask);
static int CleanUpBlock(FormatStruct *my_struct, const SDLMask *element_types,
                        enum SdlElement sig_element, SDLMask *exceptions,
                        SDLMask *process_mask);
static int ClearAndCheckSnref(FormatStruct *my_struct,
                              const SDLMask *element_types,
                              enum SdlElement sig_element, SDLMask *exceptions,
                              SDLMask *process_mask);
static int ColInfoToTableInfo(FormatStruct *my_struct,
                              const SDLMask *element_types,
                              enum SdlElement sig_element, SDLMask *exceptions,
                              SDLMask *process_mask);
static int CopyAnchorId(FormatStruct *my_struct, const SDLMask *element_types,
                        enum SdlElement sig_element, SDLMask *exceptions,
                        SDLMask *process_mask);
static int CopyDocInfo(FormatStruct *my_struct, const SDLMask *element_types,
                       enum SdlElement sig_element, SDLMask *exceptions,
                       SDLMask *process_mask);
static int CopyIdInfo(FormatStruct *my_struct, const SDLMask *element_types,
                      enum SdlElement sig_element, SDLMask *exceptions,
                      SDLMask *process_mask);
static int ResolveSpcInfo(FormatStruct *my_struct, const SDLMask *element_types,
                          enum SdlElement sig_element, SDLMask *exceptions,
                          SDLMask *process_mask);
static int CopyEntryInfo(FormatStruct *my_struct, const SDLMask *element_types,
                         enum SdlElement sig_element, SDLMask *exceptions,
                         SDLMask *process_mask);
static int CopyTossInfo(FormatStruct *my_struct, const SDLMask *element_types,
                        enum SdlElement sig_element, SDLMask *exceptions,
                        SDLMask *process_mask);
static int FakeEnd(FormatStruct *my_struct, const SDLMask *element_types,
                   enum SdlElement sig_element, SDLMask *exceptions,
                   SDLMask *process_mask);
static _DtCvSegment *FindSnbEntry(_DtCvSegment *snb, char *target);
static char *GetInterpCmd(SdlOption interp_type);
static int IfInfo(FormatStruct *my_struct, const SDLMask *element_types,
                  enum SdlElement sig_element, SDLMask *exceptions,
                  SDLMask *process_mask);
static int InitLast(FormatStruct *my_struct, const SDLMask *element_types,
                    enum SdlElement sig_element, SDLMask *exceptions,
                    SDLMask *process_mask);
static int LoadGraphic(FormatStruct *my_struct, const SDLMask *element_types,
                       enum SdlElement sig_element, SDLMask *exceptions,
                       SDLMask *process_mask);
static int MarkFound(FormatStruct *my_struct, const SDLMask *element_types,
                     enum SdlElement sig_element, SDLMask *exceptions,
                     SDLMask *process_mask);
static int OnlyOne(FormatStruct *my_struct, const SDLMask *element_types,
                   enum SdlElement sig_element, SDLMask *exceptions,
                   SDLMask *process_mask);
static int OnlyOneEach(FormatStruct *my_struct, const SDLMask *element_types,
                       enum SdlElement sig_element, SDLMask *exceptions,
                       SDLMask *process_mask);
static int OneToN(FormatStruct *my_struct, const SDLMask *element_types,
                  enum SdlElement sig_element, SDLMask *exceptions,
                  SDLMask *process_mask);
static int ParseSDL(FormatStruct *my_struct, enum SdlElement cur_element,
                    enum SdlElement sig_element, SDLMask *cur_except,
                    SDLMask *process_mask);
static int ProcessEnterAttr(FormatStruct *my_struct,
                            const SDLMask *element_types,
                            enum SdlElement sig_element, SDLMask *cur_except,
                            SDLMask *process_mask);
static int ProcessExitAttr(FormatStruct *my_struct,
                           const SDLMask *element_types,
                           enum SdlElement sig_element, SDLMask *cur_except,
                           SDLMask *process_mask);
static int ProcessSDLMarkup(FormatStruct *my_struct,
                            enum SdlElement cur_element,
                            enum SdlElement sig_element, SDLMask *cur_except,
                            SDLMask *process_mask);
static int RegisterLink(FormatStruct *my_struct, const SDLMask *element_types,
                        enum SdlElement sig_element, SDLMask *exceptions,
                        SDLMask *process_mask);
static int RegisterSnbLink(FormatStruct *my_struct,
                           const SDLMask *element_types,
                           enum SdlElement sig_element, SDLMask *exceptions,
                           SDLMask *process_mask);
static int RegisterSwitch(FormatStruct *my_struct, const SDLMask *element_types,
                          enum SdlElement sig_element, SDLMask *exceptions,
                          SDLMask *process_mask);
static int ResolveIf(FormatStruct *my_struct, _DtCvSegment *prev_data);
static int SaveItemInfo(FormatStruct *my_struct, const SDLMask *element_types,
                        enum SdlElement sig_element, SDLMask *exceptions,
                        SDLMask *process_mask);
static int SaveLangCharSet(FormatStruct *my_struct,
                           const SDLMask *element_types,
                           enum SdlElement sig_element, SDLMask *exceptions,
                           SDLMask *process_mask);
static int SetSaveSnref(FormatStruct *my_struct, const SDLMask *element_types,
                        enum SdlElement sig_element, SDLMask *exceptions,
                        SDLMask *process_mask);
static int SetTransit(FormatStruct *my_struct, const SDLMask *element_types,
                      enum SdlElement sig_element, SDLMask *exceptions,
                      SDLMask *process_mask);
static int SetType(FormatStruct *my_struct, const SDLMask *element_types,
                   enum SdlElement sig_element, SDLMask *exceptions,
                   SDLMask *process_mask);
static int ZeroOrOne(FormatStruct *my_struct, const SDLMask *element_types,
                     enum SdlElement sig_element, SDLMask *exceptions,
                     SDLMask *process_mask);
static int ZeroToN(FormatStruct *my_struct, const SDLMask *element_types,
                   enum SdlElement sig_element, SDLMask *exceptions,
                   SDLMask *process_mask);
...
#define ElTableCellIds(x) _DtCvCellIdsOfTableSeg(((x)->el_info.w.table_info))
#define ElTableColNum(x) _DtCvNumColsOfTableSeg(((x)->el_info.w.table_info))
#define ElTableColWidths(x) _DtCvColWOfTableSeg(((x)->el_info.w.table_info))
#define ElTableColJust(x) _DtCvColJustifyOfTableSeg(((x)->el_info.w.table_info))
#define ElTableList(x) _DtCvCellsOfTableSeg(((x)->el_info.w.table_info))
...
#define MySaveString(seg_list, my_struct, string, cur_link, multi_len,         \
                     nl_flag)                                                  \
  _DtHelpCeSaveString(my_struct->ui_info->client_data, seg_list,               \
                      &(my_struct->last_seg), &(my_struct->prev_data), string, \
                      my_struct->my_fonts, cur_link, multi_len,                \
                      my_struct->flags, my_struct->ui_info->load_font,         \
                      my_struct->resolve_font, nl_flag)

#define SDL_WRAPPER _DtCvAPP_FLAG1
#define SetSdlWrapper(x) _DtCvSetAppFlag1(x)
#define IsSdlWrapper(x) ((x) & SDL_WRAPPER)

#define SetDupFlag(x) (FrmtPrivInfoPtr(x)->dup_flag = True)
#define ClearDupFlag(x) (FrmtPrivInfoPtr(x)->dup_flag = False)
...
#define ClearSegLinks(x) (((x)->type) & ~(_DtCvHYPER_TEXT | _DtCvGHOST_LINK))
...
#define SDL_ENTITY_SYSTEM_NOTATIONS                                            \
  SDLInitMaskTwelve(SdlElementGraphic, SdlElementText, SdlElementAudio,        \
                    SdlElementVideo, SdlElementAnimate, SdlElementCrossDoc,    \
                    SdlElementManPage, SdlElementTextFile, SdlElementSysCmd,   \
                    SdlElementCallback, SdlElementScript, SdlElementSwitch)
...
#define SDL_ENTITY_CLASSK                                                      \
  {"acro", SdlClassAcro}, {"book", SdlClassBook}, {"emph", SdlClassEmph},      \
      {"jargon", SdlClassJargon}, {"l10n", SdlClassL10n},                      \
      {NameStr, SdlClassName}, {"quote", SdlClassQuote},                       \
      {ProductStr, SdlClassProduct}, {"termdef", SdlClassTermdef},             \
      {"term", SdlClassTerm}, {"mach-in", SdlClassMachIn},                     \
      {"mach-out", SdlClassMachOut}, {"mach-cont", SdlClassMachCont},          \
...
#define SDL_ENTITY_CLASSH                                                      \
  {"label", SdlClassLabel}, {(HeadStr + 1), SdlClassHead},                     \
      {"caption", SdlClassCaption}, {"annotation", SdlClassAnnotation},        \
      {"phead", SdlClassPHead}, {                                              \
...
#define SDL_ENTITY_CLASSF                                                      \
  {"table", SdlClassTable}, {"cell", SdlClassCell}, {"list", SdlClassList},    \
      {"item", SdlClassItem}, {(TextStr + 1), SdlClassText}, {                 \
...
#define SDL_ENTITY_CLASSG                                                      \
  {"figure", SdlClassFigure}, {"in-line", SdlClassInLine},                     \
      {ButtonStr, SdlClassButton}, {"icon", SdlClassIcon}, {                   \
...
#define SDL_ENTITY_CLASSP                                                      \
  {"super", SdlClassSuper}, { "sub", SdlClassSub }
...
#define SDL_ENTITY_SIMPLE                                                      \
  SDLInitMaskSeven(SdlElementKey, SdlElementSphrase, SdlElementRev,            \
...
#define SDL_ENTITY_ATOMIC                                                      \
  SDLInitMaskNine(SdlElementKey, SdlElementSphrase, SdlElementRev,             \
                  SdlElementIf, SdlElementSpc, SdlElementSnRef,                \
...
static _CEInterpData InterpData[] = {
    {SdlInterpKsh, "ksh"}, {SdlInterpCsh, "csh"},   {SdlInterpSh, "sh"},
    {SdlInterpTcl, "tcl"}, {_DtCvOPTION_BAD, NULL},
};
...
static OptionList apps[] = {
    {AllStr, SdlAppAll}, {"help", SdlAppHelp}, {"tutorial", SdlAppTutorial},
    {"ref", SdlAppRef},  {"sys", SdlAppSys},   {NULL, _DtCvOPTION_BAD}};
...
static OptionList frmtTypes[] = {{"literal", SdlTypeLiteral},
                                 {"lined", SdlTypeLined},
                                 {DynamicStr, SdlTypeDynamic},
                                 {NULL, _DtCvOPTION_BAD}};

static OptionList idTypes[] = {
    {(VirpageStr + 1), SdlIdVirpage},   {(BlockStr + 1), SdlIdBlock},
    {(FormStr + 1), SdlIdForm},         {(ParaStr + 1), SdlIdPara},
    {(CParaStr + 1), SdlIdCPara},       {(HeadStr + 1), SdlIdHead},
    {(SubHeadStr + 1), SdlIdSubHead},   {(AnchorStr + 1), SdlIdAnchor},
    {(SwitchStr + 1), SdlIdSwitch},     {(SnrefStr + 1), SdlIdSnRef},
    {(GraphicStr + 1), SdlIdGraphic},   {(TextStr + 1), SdlIdText},
    {(AudioStr + 1), SdlIdAudio},       {(VideoStr + 1), SdlIdVideo},
    {(AnimateStr + 1), SdlIdAnimate},   {(CrossdocStr + 1), SdlIdCrossDoc},
    {(ManpageStr + 1), SdlIdManPage},   {(TextfileStr + 1), SdlIdTextFile},
    {(SyscmdStr + 1), SdlIdSysCmd},     {(ScriptStr + 1), SdlIdScript},
    {(CallbackStr + 1), SdlIdCallback}, {NULL, _DtCvOPTION_BAD},
};
...
static OptionList interpreters[] = {
    {"ksh", SdlInterpKsh}, {"tcl", SdlInterpTcl},   {"csh", SdlInterpCsh},
    {"sh", SdlInterpSh},   {NULL, _DtCvOPTION_BAD},
};

static SDLAttributeOptions SDLOptionsList[] = {
    {SDL_ATTR_CLASSH, hclass},       {SDL_ATTR_CLASSF, fclass},
    {SDL_ATTR_CLASSK, kclass},       {SDL_ATTR_CLASSFG, fgclass},
    {SDL_ATTR_CLASSP, pclass},       {SDL_ATTR_CLASSG, gclass},
    {SDL_ATTR_HDR, bool_types},      {SDL_ATTR_APP, apps},
    {SDL_ATTR_TIMING, timing},       {SDL_ATTR_TYPEFRMT, frmtTypes},
    {SDL_ATTR_BORDER, borders},      {SDL_ATTR_JUSTIFY1, justify1},
    {SDL_ATTR_JUSTIFY2, justify2},   {SDL_ATTR_VJUST, vjust},
    {SDL_ATTR_ORIENT, orient},       {SDL_ATTR_VORIENT, vorient},
    {SDL_ATTR_PLACEMENT, placement}, {SDL_ATTR_STACK, stacking},
    {SDL_ATTR_FLOW, flow},           {SDL_ATTR_WINDOW, window},
    {SDL_ATTR_TRAVERSAL, traversal}, {SDL_ATTR_TYPEID, idTypes},
    {SDL_ATTR_INTERP, interpreters}, {(unsigned long)-1, NULL}};
...
static SDLFontSpecList SDLFontList[] = {
    {SDL_ATTR_STYLE, styles},    {SDL_ATTR_SPACING, spacing},
    {SDL_ATTR_WEIGHT, weights},  {SDL_ATTR_SLANT, slants},
    {SDL_ATTR_SPECIAL, special}, {(unsigned long)-1, NULL}};
...
static SDLAttribute SDLAttributeList[] = {
    {"abbrev", SdlAttrDataTypeCdata, SdlElementSpecific, SDL_ATTR_ABBREV,
     SDLAttrOffset(ElementInfoPtr, elstr1)},

    {"app", SdlAttrDataTypeEnum, SdlIgnore, SDL_ATTR_APP, 0},
    {"author", SdlAttrDataTypeCdata, SdlIgnore, SDL_ATTR_AUTHOR, 0},

    {"b-margin", SdlAttrDataTypeNumber, SdlContainerSpecific, SDL_ATTR_BMARGIN,
     SDLAttrOffset(_DtCvContainerPtr, bmargin)},
    {"border", SdlAttrDataTypeEnum, SdlContainerSpecific, SDL_ATTR_BORDER,
     SDLAttrOffset(_DtCvContainerPtr, border)},
    {"branches", SdlAttrDataTypeCdata, SdlElementSpecific, SDL_ATTR_BRANCHES,
     SDLAttrOffset(ElementInfoPtr, elstr1)},

    {ButtonStr, SdlAttrDataTypeId, SdlIgnore, SDL_ATTR_BUTTON, 0},

    {"cells", SdlAttrDataTypeId, SdlElementSpecific, SDL_ATTR_CELLS,
     SDLAttrOffset(ElementInfoPtr, elstr1)},
    {"charset", SdlAttrDataTypeCdata, SdlElementSpecific, SDL_ATTR_CHARSET,
     SDLAttrOffset(ElementInfoPtr, char_set)},
    {"class", SdlAttrDataTypeEnum, SdlElementSpecific, SDL_ATTR_CLASS,
     SDLAttrOffset(ElementInfoPtr, match.clan)},
    {"colj", SdlAttrDataTypeCdata, SdlElementSpecific, SDL_ATTR_COLJ,
     SDLAttrOffset(ElementInfoPtr, elstr1)},
    {"color", SdlAttrDataTypeCdata, SdlFontSpecific, SDL_ATTR_COLOR,
     SDLAttrOffset(_DtHelpFontHintPtr, color)},
    {"colw", SdlAttrDataTypeCdata, SdlElementSpecific, SDL_ATTR_COLW,
     SDLAttrOffset(ElementInfoPtr, elstr2)},
    {"command", SdlAttrDataTypeCdata, SdlElementSpecific, SDL_ATTR_COMMAND,
     SDLAttrOffset(ElementInfoPtr, w.snb_info.xid)},
    {"count", SdlAttrDataTypeNumber, SdlElementSpecific, SDL_ATTR_COUNT,
     SDLAttrOffset(ElementInfoPtr, nums.count)},
    {"data", SdlAttrDataTypeCdata, SdlElementSpecific, SDL_ATTR_DATA,
     SDLAttrOffset(ElementInfoPtr, w.snb_info.xid)},

    {"descript", SdlAttrDataTypeCdata, SdlIgnore, SDL_ATTR_DESCRIPT, 0},

    {"doc-id", SdlAttrDataTypeCdata, SdlElementSpecific, SDL_ATTR_DOCID,
     SDLAttrOffset(ElementInfoPtr, w.doc_info.doc_id)},
    {"enter", SdlAttrDataTypeCdata, SdlElementSpecific, SDL_ATTR_ENTER,
     SDLAttrOffset(ElementInfoPtr, elstr1)},
    {"exit", SdlAttrDataTypeCdata, SdlElementSpecific, SDL_ATTR_EXIT,
     SDLAttrOffset(ElementInfoPtr, elstr2)},
    {"first-page", SdlAttrDataTypeId, SdlElementSpecific, SDL_ATTR_FRST_PG,
     SDLAttrOffset(ElementInfoPtr, w.doc_info.first_pg)},
    {"flow", SdlAttrDataTypeEnum, SdlContainerSpecific, SDL_ATTR_FLOW,
     SDLAttrOffset(_DtCvContainerPtr, flow)},
    {"f-margin", SdlAttrDataTypeNumber, SdlContainerSpecific, SDL_ATTR_FMARGIN,
     SDLAttrOffset(_DtCvContainerPtr, fmargin)},
    {"format", SdlAttrDataTypeCdata, SdlElementSpecific, SDL_ATTR_FORMAT,
     SDLAttrOffset(ElementInfoPtr, w.snb_info.format)},

    {"hdr", SdlAttrDataTypeEnum, SdlIgnore, SDL_ATTR_HDR, 0},

    {"headw", SdlAttrDataTypeNumber, SdlContainerSpecific, SDL_ATTR_HEADWDTH,
     SDLAttrOffset(_DtCvContainerPtr, percent)},
    {"id", SdlAttrDataTypeId, SdlElementSpecific, SDL_ATTR_ID,
     SDLAttrOffset(ElementInfoPtr, id)},

    {"interp", SdlAttrDataTypeEnum, SdlElementSpecific, SDL_ATTR_INTERP,
     SDLAttrOffset(ElementInfoPtr, interp)},
    {"justify", SdlAttrDataTypeEnum, SdlContainerSpecific, SDL_ATTR_JUSTIFY,
     SDLAttrOffset(_DtCvContainerPtr, justify)},
    {"l-margin", SdlAttrDataTypeNumber, SdlContainerSpecific, SDL_ATTR_LMARGIN,
     SDLAttrOffset(_DtCvContainerPtr, lmargin)},
    {"language", SdlAttrDataTypeCdata, SdlElementSpecific, SDL_ATTR_LANGUAGE,
     SDLAttrOffset(ElementInfoPtr, language)},
    {"length", SdlAttrDataTypeNumber, SdlIgnore, SDL_ATTR_LENGTH, 0},

    {"level", SdlAttrDataTypeNumber, SdlElementSpecific, SDL_ATTR_LEVEL,
     SDLAttrOffset(ElementInfoPtr, match.level)},

    {"license", SdlAttrDataTypeCdata, SdlIgnore, SDL_ATTR_LICENSE, 0},
    {"linkinfo", SdlAttrDataTypeCdata, SdlIgnore, SDL_ATTR_LINKINFO, 0},

    {"locs", SdlAttrDataTypeCdata, SdlElementSpecific, SDL_ATTR_LOCS,
     SDLAttrOffset(ElementInfoPtr, w.entry_info.locs)},
    {"main", SdlAttrDataTypeCdata, SdlElementSpecific, SDL_ATTR_MAIN,
     SDLAttrOffset(ElementInfoPtr, w.entry_info.main)},
    {"method", SdlAttrDataTypeCdata, SdlElementSpecific, SDL_ATTR_METHOD,
     SDLAttrOffset(ElementInfoPtr, w.snb_info.method)},
    {NameStr, SdlAttrDataTypeCdata, SdlElementSpecific, SDL_ATTR_NAME,
     SDLAttrOffset(ElementInfoPtr, elstr1)},
    {"ncols", SdlAttrDataTypeNumber, SdlTableSpecific, SDL_ATTR_NCOLS,
     SDLAttrOffset(_DtCvSegmentPtr, handle.table.num_cols)},
    {"offset", SdlAttrDataTypeNumber, SdlElementSpecific, SDL_ATTR_OFFSET,
     SDLAttrOffset(ElementInfoPtr, nums.offset)},
    {(TopVOrientStr + 5), SdlAttrDataTypeEnum, SdlContainerSpecific,
     SDL_ATTR_ORIENT, SDLAttrOffset(_DtCvContainerPtr, orient)},

    {"placement", SdlAttrDataTypeEnum, SdlIgnore, SDL_ATTR_PLACEMENT, 0},
    {"phrase", SdlAttrDataTypeCdata, SdlIgnore, SDL_ATTR_PHRASE, 0},

    {"pointsz", SdlAttrDataTypeNumber, SdlFontSpecific, SDL_ATTR_POINTSZ,
     SDLAttrOffset(_DtHelpFontHintPtr, pointsz)},

    {"pub-id", SdlAttrDataTypeCdata, SdlIgnore, SDL_ATTR_PUBID, 0},
    {"prodpn", SdlAttrDataTypeCdata, SdlIgnore, SDL_ATTR_PRODPN, 0},
    {ProductStr, SdlAttrDataTypeCdata, SdlIgnore, SDL_ATTR_PRODUCT, 0},
    {"prodver", SdlAttrDataTypeCdata, SdlIgnore, SDL_ATTR_PRODVER, 0},

    {"r-margin", SdlAttrDataTypeNumber, SdlContainerSpecific, SDL_ATTR_RMARGIN,
     SDLAttrOffset(_DtCvContainerPtr, rmargin)},
    {"rid", SdlAttrDataTypeId, SdlElementSpecific, SDL_ATTR_RID,
     SDLAttrOffset(ElementInfoPtr, id)},
    {"rlevel", SdlAttrDataTypeNumber, SdlElementSpecific, SDL_ATTR_RLEVEL,
     SDLAttrOffset(ElementInfoPtr, match.level)},
    {"rssi", SdlAttrDataTypeCdata, SdlElementSpecific, SDL_ATTR_RSSI,
     SDLAttrOffset(ElementInfoPtr, match.ssi)},

    {"sdldtd", SdlAttrDataTypeCdata, SdlElementSpecific, SDL_ATTR_SDLDTD,
     SDLAttrOffset(ElementInfoPtr, w.doc_info.sdldtd)},

    {"set-width", SdlAttrDataTypeNumber, SdlFontSpecific, SDL_ATTR_SETWIDTH,
     SDLAttrOffset(_DtHelpFontHintPtr, set_width)},
    {"slant", SdlAttrDataTypeFont, SdlFontSpecific, SDL_ATTR_SLANT,
     SDLAttrOffset(_DtHelpFontHintPtr, slant)},
    {"sort", SdlAttrDataTypeCdata, SdlElementSpecific, SDL_ATTR_SORT,
     SDLAttrOffset(ElementInfoPtr, w.entry_info.sort)},
    {"spacing", SdlAttrDataTypeFont, SdlFontSpecific, SDL_ATTR_SPACING,
     SDLAttrOffset(_DtHelpFontHintPtr, spacing)},
    {"special", SdlAttrDataTypeFont, SdlFontSpecific, SDL_ATTR_SPECIAL,
     SDLAttrOffset(_DtHelpFontHintPtr, special)},

    {"srcdtd", SdlAttrDataTypeCdata, SdlIgnore, SDL_ATTR_SRCDTD, 0},
    {"srch-wt", SdlAttrDataTypeNumber, SdlIgnore, SDL_ATTR_SRCHWT, 0},

    {"ssi", SdlAttrDataTypeCdata, SdlElementSpecific, SDL_ATTR_SSI,
     SDLAttrOffset(ElementInfoPtr, match.ssi)},

    {"stack", SdlAttrDataTypeEnum, SdlIgnore, SDL_ATTR_STACK, 0},

    {"style", SdlAttrDataTypeFont, SdlFontSpecific, SDL_ATTR_STYLE,
     SDLAttrOffset(_DtHelpFontHintPtr, style)},
    {"syns", SdlAttrDataTypeCdata, SdlElementSpecific, SDL_ATTR_SYNS,
     SDLAttrOffset(ElementInfoPtr, w.entry_info.syns)},
    {"t-margin", SdlAttrDataTypeNumber, SdlContainerSpecific, SDL_ATTR_TMARGIN,
     SDLAttrOffset(_DtCvContainerPtr, tmargin)},

    {(TextStr + 1), SdlAttrDataTypeCdata, SdlIgnore, SDL_ATTR_TEXT, 0},

    {"timestmp", SdlAttrDataTypeCdata, SdlElementSpecific, SDL_ATTR_TIMESTAMP,
     SDLAttrOffset(ElementInfoPtr, w.doc_info.timestamp)},
    {"timing", SdlAttrDataTypeEnum, SdlElementSpecific, SDL_ATTR_TIMING,
     SDLAttrOffset(ElementInfoPtr, timing)},
    {"type", SdlAttrDataTypeEnum, SdlElementSpecific, SDL_ATTR_TYPE,
     SDLAttrOffset(ElementInfoPtr, sdl_type)},

    {"traversal", SdlAttrDataTypeEnum, SdlIgnore, SDL_ATTR_TRAVERSAL, 0},

    {"typenam", SdlAttrDataTypeCdata, SdlFontSpecific, SDL_ATTR_TYPENAM,
     SDLAttrOffset(_DtHelpFontHintPtr, typenam)},
    {"typenamb", SdlAttrDataTypeCdata, SdlFontSpecific, SDL_ATTR_TYPENAMB,
     SDLAttrOffset(_DtHelpFontHintPtr, typenamb)},
    {"typenami", SdlAttrDataTypeCdata, SdlFontSpecific, SDL_ATTR_TYPENAMI,
     SDLAttrOffset(_DtHelpFontHintPtr, typenami)},
    {"typenamib", SdlAttrDataTypeCdata, SdlFontSpecific, SDL_ATTR_TYPENAMIB,
     SDLAttrOffset(_DtHelpFontHintPtr, typenamib)},

    {"version", SdlAttrDataTypeCdata, SdlIgnore, SDL_ATTR_VERSION, 0},

    {(TopVJustStr + 4), SdlAttrDataTypeEnum, SdlContainerSpecific,
     SDL_ATTR_VJUST, SDLAttrOffset(_DtCvContainerPtr, vjustify)},

    {(TopVOrientStr + 4), SdlAttrDataTypeEnum, SdlContainerSpecific,
     SDL_ATTR_VORIENT, SDLAttrOffset(_DtCvContainerPtr, vorient)},

    {"weight", SdlAttrDataTypeFont, SdlFontSpecific, SDL_ATTR_WEIGHT,
     SDLAttrOffset(_DtHelpFontHintPtr, weight)},
    {"window", SdlAttrDataTypeEnum, SdlElementSpecific, SDL_ATTR_WINDOW,
     SDLAttrOffset(ElementInfoPtr, window)},

    {"xid", SdlAttrDataTypeCdata, SdlElementSpecific, SDL_ATTR_XID,
     SDLAttrOffset(ElementInfoPtr, w.snb_info.xid)},

    {"xlfd", SdlAttrDataTypeCdata, SdlFontSpecific, SDL_ATTR_XLFD,
     SDLAttrOffset(_DtHelpFontHintPtr, xlfd)},
    {"xlfdb", SdlAttrDataTypeCdata, SdlFontSpecific, SDL_ATTR_XLFDB,
     SDLAttrOffset(_DtHelpFontHintPtr, xlfdb)},
    {"xlfdi", SdlAttrDataTypeCdata, SdlFontSpecific, SDL_ATTR_XLFDI,
     SDLAttrOffset(_DtHelpFontHintPtr, xlfdi)},
    {"xlfdib", SdlAttrDataTypeCdata, SdlFontSpecific, SDL_ATTR_XLFDIB,
...
static SDLContent VStructContent[] = {
    SDL_ENTITY_GENERATED_ELEMENTS{SDLInitMask(SdlElementNone), NULL},
};
...
static SDLElementAttrList SnbAttrList[] = {
    {SDL_ATTR_VERSION, SdlAttrValueImplied, NULL}, {-1, SdlAttrValueBad, NULL}};
...
static SDLContent FormContent[] = {
    {SDLInitMask(SdlElementHead), ZeroToN},
    {SDLInitMaskTwo(SdlElementFstyle, SdlElementFdata), OnlyOneEach},
...
static SDLElementAttrList AnchorAttrList[] = {
    {SDL_ATTR_ID, SdlAttrValueRequired, NULL}, {-1, SdlAttrValueBad, NULL}};
...
static SDLElementAttrList SnrefAttrList[] = {
    {SDL_ATTR_ID, SdlAttrValueImpliedDef, NULL}, {-1, SdlAttrValueBad, NULL}};
...
static SDLElementAttrList CondAttrList[] = {
    {SDL_ATTR_INTERP, SdlAttrValueImplied, "ksh"}, {-1, SdlAttrValueBad, NULL}};
...
static SDLElementAttrList SpcAttrList[] = {
    {SDL_ATTR_NAME, SdlAttrValueRequired, NULL}, {-1, SdlAttrValueBad, NULL}};
/*-----------------------------------------------------------------------------
...
static SDLElementAttrList LoidsAttrList[] = {
    {SDL_ATTR_COUNT, SdlAttrValueImplied, NULL}, {-1, SdlAttrValueBad, NULL}};
...
static SDLElementAttrList PhraseAttrList[] = {
    {SDL_ATTR_TEXT, SdlAttrValueRequired, NULL}, {-1, SdlAttrValueBad, NULL}};
...
static SDLElementInfo SdlElementList[] = {
    {"<alttext", "</alttext", 3, 3, SdlElementAltText,
     SDLInitMask(SdlElementNone), NULL, AltTextContent, False, False, False,
     False, SdlToSnb},

    {AnchorStr, NULL, 4, 0, SdlElementAnchor, SDLInitMask(SdlElementNone),
     AnchorAttrList, AnchorContent, False, True, False, False, SdlToMarker},

    {AnimateStr, NULL, 4, 0, SdlElementAnimate, SDLInitMask(SdlElementNone),
     NotationAttrList, NULL, False, True, False, False, SdlToNone},

    {AudioStr, NULL, 3, 0, SdlElementAudio, SDLInitMask(SdlElementNone),
     NotationAttrList, NULL, False, True, False, False, SdlToNone},

    {BlockStr, "</block", 2, 3, SdlElementBlock, SDLInitMask(SdlElementNone),
     BlockAttrList, BlockContent, False, True, True, True, SdlToContainer},

    {CallbackStr, NULL, 3, 0, SdlElementCallback, SDLInitMask(SdlElementNone),
     CallbackAttrList, CallbackContent, True, False, False, False,
     SdlToContainer},

    {"<cond", "</cond", 3, 4, SdlElementCond, SDLInitMask(SdlElementNone),
     CondAttrList, CondContent, False, True, False, False, SdlToContainer},

    {CParaStr, "</cp", 3, 3, SdlElementCPara, SDLInitMask(SdlElementNone),
     ParaAttrList, CParaContent, True, True, True, True, SdlToContainer},

    {CrossdocStr, NULL, 3, 0, SdlElementCrossDoc, SDLInitMask(SdlElementNone),
     IdAndXidAttrList, CrossDocContent, True, True, False, False,
     SdlToContainer},

    {"<else", "</else", 3, 4, SdlElementElse, SDLInitMask(SdlElementNone), NULL,
     ThenElseContent, False, False, False, False, SdlToContainer},

    {"<entry", "</entry", 3, 4, SdlElementEntry, SDLInitMask(SdlElementNone),
     EntryAttrList, EntryContent, False, True, False, False, SdlToContainer},

    {"<fdata", "</fdata", 3, 4, SdlElementFdata, SDLInitMask(SdlElementNone),
     NULL, FdataContent, False, False, False, False, SdlToNone},
     ...
     */
    {"<formstyle", NULL, 6, 0, SdlElementFormStyle, SDLInitMask(SdlElementNone),
     FormStyleAttrList, FormStyleContent, False, True, False, False,
     SdlToContainer},

    {FormStr, "</form", 5, 4, SdlElementForm, SDLInitMask(SdlElementNone),
     FormAttrList, FormContent, False, True, False, True, SdlToContainer},

    {"<frmtstyle", NULL, 4, 0, SdlElementFrmtStyle, SDLInitMask(SdlElementNone),
     FrmtStyleAttrList, FrmtStyleContent, False, True, False, False,
     SdlToContainer},

    {"<frowvec", NULL, 4, 0, SdlElementFrowvec, SDLInitMask(SdlElementNone),
     FrowvecAttrList, FrowvecContent, False, True, False, False, SdlToNone},

    {"<fstyle", "</fstyle", 3, 4, SdlElementFstyle, SDLInitMask(SdlElementNone),
     FstyleAttrList, FstyleContent, False, True, False, False, SdlToNone},

    {GraphicStr, NULL, 4, 0, SdlElementGraphic, SDLInitMask(SdlElementNone),
     NotationAttrList, GraphicContent, True, True, False, False, SdlToSnb},

    {"<grphstyle", NULL, 4, 0, SdlElementGrphStyle, SDLInitMask(SdlElementNone),
     GrphStyleAttrList, GrphStyleContent, False, True, False, False,
     SdlToContainer},
     ...
     * before the short element so that tests will check it first.
     */
    {"<headstyle", NULL, 6, 0, SdlElementHeadStyle, SDLInitMask(SdlElementNone),
     HeadStyleAttrList, HeadStyleContent, False, True, True, False,
     SdlToContainer},

    {HeadStr, "</head", 5, 6, SdlElementHead, SDLInitMask(SdlElementNone),
     HeadAttrList, HeadContent, False, True, True, True, SdlToContainer},

    {"<id", NULL, 3, 0, SdlElementId, SDLInitMask(SdlElementNone), IdAttrList,
     IdContent, False, True, False, False, SdlToContainer},

    {"<if", "</if", 3, 4, SdlElementIf, SDLInitMask(SdlElementNone), NULL,
     IfContent, False, False, False, False, SdlToContainer},

    {"<index", "</index", 3, 4, SdlElementIndex, SDLInitMask(SdlElementNone),
     IndexAttrList, IndexContent, False, True, False, False, SdlToContainer},

    {"<keystyle", NULL, 6, 0, SdlElementKeyStyle, SDLInitMask(SdlElementNone),
     KeyStyleAttrList, KeyStyleContent, False, True, False, False,
     SdlToContainer},

    {"<key", "</key", 4, 3, SdlElementKey, SDLInitMask(SdlElementLink),
     KeyAttrList, KeyContent, True, True, False, True, SdlToContainer},

    {"<link", "</link", 3, 4, SdlElementLink, SDLInitMask(SdlElementLink),
     LinkAttrList, LinkContent, False, True, False, False, SdlToContainer},

    {"<loids", "</loids", 4, 5, SdlElementLoids, SDLInitMask(SdlElementNone),
     LoidsAttrList, LoidsContent, False, True, False, False, SdlToContainer},

    {"<lophrases", "</lophrases", 4, 5, SdlElementLoPhrases,
     SDLInitMask(SdlElementNone), LoPhraseAttrList, LoPhraseContent, False,
     True, False, False, SdlToNone},

    {ManpageStr, NULL, 2, 0, SdlElementManPage, SDLInitMask(SdlElementNone),
     IdAndXidAttrList, ManPageContent, True, True, False, False,
     SdlToContainer},

    {"<notes", NULL, 2, 0, SdlElementNotes, SDLInitMask(SdlElementNone), NULL,
     NULL, False, True, False, False, SdlToNone},

    {"<phrase", NULL, 3, 0, SdlElementPhrase, SDLInitMask(SdlElementNone),
     PhraseAttrList, NULL, False, True, False, False, SdlToNone},

    {ParaStr, "</p", 2, 3, SdlElementPara, SDLInitMask(SdlElementNone),
     ParaAttrList, ParaContent, True, True, False, True, SdlToContainer},

    {"<refitem", "</refitem", 4, 5, SdlElementRefItem,
     SDLInitMask(SdlElementNone), RefItemAttrList, RefItemContent, False, True,
     False, True, SdlToSnb},

    {"<rel-docs", NULL, 6, 0, SdlElementRelDocs, SDLInitMask(SdlElementNone),
     NULL, NULL, False, False, False, False, SdlToNone},

    {"<rel-file", NULL, 6, 0, SdlElementRelFile, SDLInitMask(SdlElementNone),
     NULL, NULL, False, False, False, False, SdlToNone},

    {"<rev", "</rev", 4, 5, SdlElementRev, SDLInitMask(SdlElementRev), NULL,
     RevContent, True, False, False, False, SdlToNone},

    {ScriptStr, "</script", 3, 4, SdlElementScript, SDLInitMask(SdlElementNone),
     ScriptAttrList, ScriptContent, False, True, False, False, SdlToSnb},

    {"<sdldoc", "</sdldoc", 3, 4, SdlElementSdlDoc, SDLInitMask(SdlElementNone),
     SdlDocAttrList, SdlDocContent, False, True, False, False, SdlToContainer},

    {"<snb", "</snb", 4, 5, SdlElementSnb, SDLInitMask(SdlElementNone),
     SnbAttrList, SnbContent, False, True, False, False, SdlToContainer},

    {SnrefStr, "</snref", 4, 5, SdlElementSnRef, SDLInitMask(SdlElementNone),
     SnrefAttrList, SnrefContent, False, True, False, False, SdlToContainer},

    {"<spc", NULL, 4, 0, SdlElementSpc, SDLInitMask(SdlElementNone),
     SpcAttrList, SpcContent, False, True, False, False, SdlToSpc},

    {"<sphrase", "</sphrase>", 4, 4, SdlElementSphrase,
     SDLInitMask(SdlElementNone), SphraseAttrList, SphraseContent, False, True,
     False, True, SdlToContainer},

    {SubHeadStr, "</subhead", 3, 4, SdlElementSubHead,
     SDLInitMask(SdlElementNone), HeadAttrList, SubHeadContent, False, True,
     True, True, SdlToContainer},

    {SwitchStr, "</switch", 3, 4, SdlElementSwitch, SDLInitMask(SdlElementNone),
     SwitchAttrList, SwitchContent, True, True, False, False, SdlToContainer},

    {SyscmdStr, NULL, 3, 0, SdlElementSysCmd, SDLInitMask(SdlElementNone),
     SysCmdAttrList, SysCmdContent, True, True, False, False, SdlToContainer},

    {TextfileStr, NULL, 6, 0, SdlElementTextFile, SDLInitMask(SdlElementNone),
     TextFileAttrList, TextFileContent, True, True, False, False,
     SdlToContainer},

    {TextStr, "</text", 4, 4, SdlElementText, SDLInitMask(SdlElementNone),
     TextAttrList, TextContent, True, False, False, False, SdlToSnb},

    {"<then", "</then", 3, 4, SdlElementThen, SDLInitMask(SdlElementNone), NULL,
     ThenElseContent, False, False, False, False, SdlToContainer},

    {"<toss", "</toss", 3, 4, SdlElementToss, SDLInitMask(SdlElementNone),
     TossAttrList, TossContent, False, True, False, False, SdlToContainer},

    {VideoStr, NULL, 4, 0, SdlElementVideo, SDLInitMask(SdlElementNone),
     NotationAttrList, NULL, False, True, False, False, SdlToNone},

    {VirpageStr, "</virpage", 4, 4, SdlElementVirpage,
     SDLInitMask(SdlElementNone), VirpageAttrList, VirpageContent, False, True,
     False, True, SdlToContainer},

    {VirpageStr, "</virpage", 4, 4, SdlElementTitle,
     SDLInitMask(SdlElementNone), VirpageAttrList, VirpageHeadContent, False,
     True, False, True, SdlToContainer},

    {"<vstruct", "</vstruct", 3, 4, SdlElementVStruct,
     SDLInitMask(SdlElementNone), VStructAttrList, VStructContent, False, True,
     False, False, SdlToNone},

    {"<!--", NULL, 3, 0, SdlElementComment, SDLInitMask(SdlElementNone), NULL,
     NULL, False, True, False, False, SdlToNone},

    {"<!doctype", NULL, 3, 0, SdlElementDocType, SDLInitMask(SdlElementNone),
     NULL, NULL, False, True, False, False, SdlToNone},

    {"<!sgml", NULL, 3, 0, SdlElementSgml, SDLInitMask(SdlElementNone), NULL,
     NULL, False, True, False, False, SdlToNone},

    {NULL, NULL, 0, 0, SdlElementCdata, SDLInitMask(SdlElementNone), NULL,
     CdataContent, False, False, False, False, SdlToNone},
};
 ...
 *
 *****************************************************************************/
static _DtCvSegment *CompressTable(FormatStruct *my_struct, _DtCvSegment *seg) {
  ...
  if (NULL != seg) {
    ...
    if (1 == _DtCvNumColsOfTableSeg(seg) &&
       ...
       */
      _DtHelpFreeSegments(seg, _DtCvFALSE, my_struct->ui_info->destroy_region,
 ...
 *
 *****************************************************************************/
static void PropagateJustification(_DtCvSegment *seg, _DtCvFrmtOption justify) {
 ...
 *
 ******************************************************************************/
static void FreeAttributes(enum SdlElement element, ElementInfo *cur_info,
    ...
    while (myList->sdl_attr_define != -1) {
      if (SDLIsStrAttrSet(*cur_info, myList->sdl_attr_define) &&
        ...
        while (attrib->sdl_attr_define != -1 &&
               !ATTRS_EQUAL(attrib->data_type, myList->sdl_attr_define,
 ...
 *
 *****************************************************************************/
static _DtCvSegment *DuplicateElement(
    _DtCvPointer client_data, _DtCvSegment *toss, _DtCvSegment *src_seg,
    _DtCvSegment **prev_data, _DtCvSegment **last_seg,
    void (*load_font)(void *, char *, const char *, _DtHelpFontHints, void **),
    _DtCvValue (*resolve_spc)(void *, char *, const char *, _DtHelpFontHints,
                              const char *, void **, _DtCvUnit *, _DtCvUnit *,
                              _DtCvUnit *),
    _DtCvUnit line_height, int ave_char, _DtHelpFontHints srcFonts,
    int link_idx, _DtCvValue vis_link) {
  ...
  while (src_seg != NULL) {
    ...
    *newSeg = *src_seg;
      ...
      if (NULL != match) {
        if (NULL != toss) {
          _DtHelpCeMergeSdlAttribInfo(
              _DtHelpCeMatchSemanticStyle(toss, match->clan, match->level,
                                          match->ssi),
              newSeg, &curFonts, NULL, NULL, NULL);
          /*
           ...
           */
          if (line_height > 0) {
            TMarginOfSeg(newSeg) = TMarginOfSeg(newSeg) * line_height;
            BMarginOfSeg(newSeg) = BMarginOfSeg(newSeg) * line_height;
          }
        }
      }
      _DtCvContainerListOfSeg(newSeg) =
          DuplicateElement(client_data, toss, _DtCvContainerListOfSeg(src_seg),
                           &prevData, &lastSeg, load_font, resolve_spc,
                           line_height, ave_char, curFonts, link_idx, vis_link);
    ...
    case _DtCvSTRING:
       ...
       */
      (load_font)(client_data, _DtHelpFontHintsLang(curFonts),
                  _DtHelpFontHintsCharSet(curFonts), curFonts,
    ...
    case _DtCvREGION:
      ...
      if (False == region->inited) {
        _DtHelpDASpcInfo *spcInfo = (_DtHelpDASpcInfo *)region->handle;

        (resolve_spc)(client_data, _DtHelpFontHintsLang(curFonts),
                      _DtHelpFontHintsCharSet(curFonts), curFonts,
                      spcInfo->name, &(_DtCvInfoOfRegionSeg(newSeg)),
       ...
       */
      if (NULL != match &&
          (SdlClassInLine == match->clan || SdlClassButton == match->clan ||
 ...
 *
 ******************************************************************************/
static _DtCvSegment *ResolveSnref(FormatStruct *my_struct, _DtCvSegment *snref,
                                  char *snref_id) {
  ...
  if (NULL != my_struct->snb) {
    ...
    while (False == found && NULL != refItem) {
      ...
      if (NULL != _DtCvContainerIdOfSeg(refItem))
        snbEntry = FindSnbEntry(my_struct->snb, _DtCvContainerIdOfSeg(refItem));
      else
    ...
    if (True == found) {
      ...
      if (SdlElementScript == priv->sdl_el_type) {
         ...
         * get the data to run
         */
        runData = _DtCvStringOfStringSeg(_DtCvContainerListOfSeg(snbEntry));

        if (NULL == interpStr ||
            -1 == _DtCvRunInterp(my_struct->ui_info->exec_filter,
                                 my_struct->ui_info->client_data, interpStr,
                                 runData, &newData) ||
        ...
        if (NULL != match && NULL != my_struct->toss)
          _DtHelpCeMergeSdlAttribInfo(
              _DtHelpCeMatchSemanticStyle(my_struct->toss, match->clan,
                                          match->level, match->ssi),
              newSeg, my_struct->my_fonts, NULL, NULL, NULL);

        if (0 != MySaveString(&newSeg, my_struct, newData, my_struct->cur_link,
                              my_struct->mb_len, False)) {
          free(newData);
          return NULL;
        }
        ...
        if (NULL != snbEntry) {
          ...
          newSeg = DuplicateElement(
              my_struct->ui_info->client_data, my_struct->toss, snbEntry,
              &(my_struct->prev_data), NULL, my_struct->ui_info->load_font,
              my_struct->ui_info->resolve_spc,
              my_struct->ui_info->line_height / 2, my_struct->ui_info->avg_char,
              *(my_struct->my_fonts), my_struct->cur_link, True);
     ...
     */
      ...
      (my_struct->ui_info->load_font)(
          ...
          *(my_struct->my_fonts), &(_DtCvFontOfStringSeg(newSeg)));
    }
    ...
    if (NULL == my_struct->un_snrefs)
      ...
      my_struct->un_snrefs = (UnresSnref *)realloc(
          (void *)my_struct->un_snrefs, (sizeof(UnresSnref) * (count + 1)));
    if (NULL != my_struct->un_snrefs) {
 ...
 *
 ******************************************************************************/
static _DtHelpFontHints *AllocateFontInfo(FormatStruct *my_struct) {
 ...
 *
 ******************************************************************************/
static _DtCvSegment **ConvertToList(_DtCvSegment *segs) {
  ...
  while (NULL != segs) {
    ...
    ptr = (_DtCvSegment **)_DtCvAddPtrToArray((void **)ptr, (void *)segs);
 ...
 *
 ******************************************************************************/
static void DestroyFontInfo(FormatStruct *my_struct) {
  /*
 ...
 *
 ******************************************************************************/
static int FreeFontInfo(FormatStruct *my_struct) {
 ...
 *
 ******************************************************************************/
static int ResolveAsyncBlock(FormatStruct *my_struct, _DtCvSegment *table_seg) {
  char c;
  char *next;
  char *start = NULL;
        ...
        *next = '\0';
        ...
        if (NULL != cellSegs) {
          while (False == found && NULL != *cellSegs) {
            if (_DtCvStrCaseCmpLatin1(_DtCvContainerIdOfSeg(*cellSegs),
                                      start) == 0)
              found = True;
            else
              cellSegs++;
        ...
        if (False == found) {
          ...
          while (False == found && NULL != asyncSegs) {
            if (_DtCvStrCaseCmpLatin1(_DtCvContainerIdOfSeg(asyncSegs),
                                      start) == 0)
              found = True;
            else
          ...
          if (True == found) {
            ...
            newSeg = DuplicateElement(my_struct->ui_info->client_data,
                                      my_struct->toss, asyncSegs, &lastSrc,
                                      &lastNext, my_struct->ui_info->load_font,
                                      my_struct->ui_info->resolve_spc,
                                      my_struct->ui_info->line_height / 2,
                                      my_struct->ui_info->avg_char,
                                      *(my_struct->my_fonts), -1, False);
             ...
             */
            _DtCvCellsOfTableSeg(table_seg) =
                (_DtCvSegment **)_DtCvAddPtrToArray(
                    (void **)_DtCvCellsOfTableSeg(table_seg), (void *)newSeg);
          }
        }
        /*
 ...
 *
 ******************************************************************************/
static int ProcessString(FormatStruct *my_struct, _DtCvValue last_flag,
                         _DtCvValue nl_flag, _DtCvValue mod_str,
                         _DtCvValue cpy_str, _DtCvValue process_flag,
                         char *string, int byte_len, int *idx) {
  if (mod_str == True)
    string[*idx] = '\0';

  if (process_flag == True &&
      MySaveString(&(my_struct->seg_list), my_struct, string,
                   my_struct->cur_link, byte_len, nl_flag) != 0) {
    MyFree(string);
    return -1;
  }
 ...
 *
 ******************************************************************************/
static void CompressLinkSeg(_DtCvSegment *p_seg) {
  void *pChar;
  int wcFlag;
 ...
 *
 ******************************************************************************/
static int ProcessNonBreakChar(FormatStruct *my_struct, _DtCvValue process_flag,
                               char *break_str, char *string, int byte_len,
                               int *idx) {
  if (ProcessString(my_struct, False, False, True, False, process_flag, string,
                    byte_len, idx) != 0)
    return -1;
 ...
 *
 ******************************************************************************/
static int MoveString(char **string, int *max_len, int *idx) {
  int i = *idx;
  int myLen = *max_len;
  char *src = *string;
 ...
 *
 *****************************************************************************/
static int SetUp(_DtHelpVolumeHdl volume, CESDLVolume **sdl_vol,
                 FormatStruct *frmt_struct, _DtCvSegment *toss,
                 const _FrmtUiInfo *ui_info, int fd, _DtCvValue lang,
                 _DtCvValue flag) {
 ...
 *
 *****************************************************************************/
static void AddToAsyncList(FormatStruct *my_struct, _DtCvSegment *block_seg) {
 ...
 *
 ******************************************************************************/
static int CheckOptionList(int attr_value_type, const char *attr,
                           _DtCvValue check, SdlOption cur_num,
                           SdlOption *num) {
  int i = 0;
  int lowerChar;
  int result = -1;
 ...
 *
 ******************************************************************************/
static int CheckFontList(int attr_value_type, char *attr,
 ...
 *
 ******************************************************************************/
static int TestLookAhead(FormatStruct *my_struct, enum SdlElement token_value,
                         _DtCvValue end_flag, int remove_flag) {
 ...
 *
 ******************************************************************************/
static int MatchSDLElement(FormatStruct *my_struct, const char *sdl_string,
                           enum SdlElement sdl_element, int sig_chars,
                           _DtCvValue end_flag) {
  int i;
 ...
 *
 ******************************************************************************/
static void SetAttributeFlag(ElementInfoPtr cur_info,
 ...
 *
 ******************************************************************************/
static void InitAttributes(_DtCvSegment *p_seg, _DtHelpFontHints *font_specs,
        ...
        if (pAttr->data_type == SdlAttrDataTypeNumber) {
          ...
          *numPtr1 = ((SDLNumber)atoi(attr_list->def_string));
          ...
          (void)CheckOptionList(
              attr_list->sdl_attr_define, attr_list->def_string,
          ...
          if ((attr_list->sdl_attr_define & SDL_ATTR_CLASS & ~(VALUE_MASK)) &&
              ElInfoClan(element_info) != defNum)
            SetAttributeFlag(element_info, attr_list->sdl_attr_define);
          *enumPtr1 = defNum;
...
#ifdef DEBUG
static char *ElToName(enum SdlElement el) {
  switch (el) {
  case SdlElementNone:
    return ("None");
  case SdlElementComment:
    return ("Comment");
  case SdlElementSdlDoc:
    return ("SdlDoc");
  case SdlElementVStruct:
    return ("VStruct");
  case SdlElementVirpage:
    return ("Virpage");
  case SdlElementHead:
    return ("Head");
  ...
  case SdlElementPara:
    return ("Para");
  case SdlElementCPara:
    return ("CPara");
  case SdlElementFdata:
    return ("Fdata");
  case SdlElementFstyle:
    return ("Fstyle");
  case SdlElementFrowvec:
    return ("Frowvec");
  case SdlElementKey:
    return ("Key");
  case SdlElementCdata:
    return ("Cdata");
  case SdlElementGraphic:
    return ("Graphic");
  case SdlElementText:
    return ("Text");
  case SdlElementAudio:
    return ("Audio");
  case SdlElementVideo:
    return ("Video");
  case SdlElementAnimate:
    return ("Animate");
  ...
  case SdlElementElse:
    return ("Else");
  case SdlElementDocument:
    return ("Document");
  case SdlElementSgml:
    return ("Sgml");
  case SdlElementDocType:
    return ("DocType");
  case SdlElementLoids:
    return ("Loids");
  case SdlElementToss:
    return ("Toss");
  case SdlElementLoPhrases:
    return ("LoPhrases");
  case SdlElementPhrase:
    return ("Phrase");
  case SdlElementIndex:
    return ("Index");
  case SdlElementEntry:
    return ("Entry");
  case SdlElementRelDocs:
    return ("RelDocs");
  case SdlElementRelFile:
    return ("RelFile");
  case SdlElementNotes:
    return ("Notes");
  case SdlElementKeyStyle:
    return ("KeyStyle");
  case SdlElementHeadStyle:
    return ("HeadStyle");
  case SdlElementFormStyle:
    return ("FormStyle");
  case SdlElementFrmtStyle:
    return ("FrmtStyle");
  case SdlElementGrphStyle:
    return ("GrphStyle");
  case SdlElementId:
    return ("Id");
  case SdlElementBlockAsync:
    return ("BlockAsync");
  case SdlElementTitle:
    return ("Title");
  case SdlPcDataFollows:
    return ("Follows");
  }
  return ("Unknown");
}
 ...
 *
 ******************************************************************************/
static int ProcessSDLAttribute(FormatStruct *my_struct, _DtCvSegment *p_seg,
                               _DtHelpFontHints *font_specs,
                               ElementInfo *element_info,
                               const SDLElementAttrList *attr_list,
                               char *attr_name) {
  ...
  if (pAttr->data_type != SdlAttrDataTypeInvalid) {
    ...
    case SdlAttrDataTypeCdata:
      result =
          _DtHelpCeGetSdlAttributeCdata(my_struct->my_file, False, &attrValue);
      break;
    ...
    case SdlAttrDataTypeFont:
      result =
          _DtHelpCeGetSdlAttributeCdata(my_struct->my_file, False, &attrValue);
      if (result != -1)
        result = CheckFontList(attr_list->sdl_attr_define, attrValue, &fontNum);
      break;
    ...
    case SdlAttrDataTypeEnum:
      result =
          _DtHelpCeGetSdlAttributeCdata(my_struct->my_file, False, &attrValue);
      if (result != -1)
        result = CheckOptionList(attr_list->sdl_attr_define, attrValue, False,
                                 (SdlOption)_DtCvOPTION_BAD, &attrNum);
      break;
 ...
 *
 ******************************************************************************/
static int VerifyAttrList(ElementInfoPtr el_info,
                          const SDLElementAttrList *attr_list) {
  long value = 0;
  while (attr_list->sdl_attr_define != -1) {
 ...
 *
 ******************************************************************************/
static void MergeTossInfo(FormatStruct *my_struct, _DtCvSegment *cur_contain,
                          _DtHelpFontHints *font_specs) {
  ...
  tossSeg = _DtHelpCeMatchSemanticStyle(my_struct->toss, ElClan(my_struct),
                                        ElLevel(my_struct), ElSsi(my_struct));
  _DtHelpCeMergeSdlAttribInfo(
      tossSeg, cur_contain, font_specs, &(my_struct->el_info),
      &(my_struct->el_info.str1_values), &(my_struct->el_info.str2_values));
 ...
 *
 ******************************************************************************/
static int ParseElementStart(FormatStruct *my_struct, SDLElementInfo element,
  ...
  case SdlToContainer:
    ...
    _DtCvContainerLeadingOfSeg(segPtr) = my_struct->ui_info->leading;
    ...
    if (element.formatting) {
       ...
       */
      _DtCvContainerVJustifyOfSeg(segPtr) = ContainerPtrToVJustify(active);
      _DtCvContainerJustifyOfSeg(segPtr) = ContainerPtrToJustify(active);
      /*
 ...
 *
 ******************************************************************************/
static int ParseElementAttr(FormatStruct *my_struct,
                            enum SdlElement cur_element,
                            const SDLElementAttrList *attribs, _DtCvValue flag,
                            _DtCvValue process_flag) {
  int result = 0;
  ...
  if (attribs == NULL || process_flag == False) {
    ...
    if (flag || attribs != NULL)
      result =
          _DtHelpCeSkipCdata(my_struct->my_file,
    ...
    if (result != -1)
      result = _DtHelpCeGetSdlAttribute(my_struct->my_file,
                                        MAX_ATTRIBUTE_LENGTH, attribName);
  ...
  do {
    result = _DtHelpCeGetSdlAttribute(my_struct->my_file, MAX_ATTRIBUTE_LENGTH,
                                      attribName);
    if (result == 0)
      result = ProcessSDLAttribute(my_struct, mySeg, my_struct->my_fonts,
                                   &(my_struct->el_info), attribs, attribName);
  } while (result == 0);
    ...
    if (NULL != mySeg && _DtCvIsSegContainer(mySeg)) {
      ...
      if (my_struct->ui_info->avg_char > 0) {
        _DtCvContainerLMarginOfSeg(mySeg) =
            _DtCvContainerLMarginOfSeg(mySeg) * my_struct->ui_info->avg_char;

        _DtCvContainerRMarginOfSeg(mySeg) =
            _DtCvContainerRMarginOfSeg(mySeg) * my_struct->ui_info->avg_char;

        _DtCvContainerFMarginOfSeg(mySeg) =
            _DtCvContainerFMarginOfSeg(mySeg) * my_struct->ui_info->avg_char;
      }
      /*
      ...
      if (my_struct->ui_info->line_height / 2 > 0) {
         ...
         */
        TMarginOfSeg(mySeg) =
            TMarginOfSeg(mySeg) * (my_struct->ui_info->line_height / 2);
        BMarginOfSeg(mySeg) =
            BMarginOfSeg(mySeg) * (my_struct->ui_info->line_height / 2);
      }
      ...
      if (_DtCvBORDER_NONE != _DtCvContainerBorderOfSeg(mySeg))
        _DtCvContainerLineWidthOfSeg(mySeg) = my_struct->ui_info->line_width;
    }
  }
 ...
 *
 ******************************************************************************/
static int ParseElementEnd(FormatStruct *my_struct, _DtCvSegment *if_prev,
                           SDLElementInfo element, _DtCvValue process_flag,
                           _DtCvValue end_flag) {
  char *id;
  _DtCvSegment *newSeg;
  _DtCvSegment *segList;

  if (MatchSDLElement(my_struct, element.element_end_str, element.sdl_element,
                      element.end_sig_chars, True) != 0 ||
      (end_flag == False &&
  ...
  if (process_flag == True) {
    ...
    if (NULL != pElement && my_struct->seg_list == NULL &&
        element.elim_flag == True && ElType(my_struct) != SdlElementKey &&
      ...
      if (ElType(my_struct) == SdlElementLink)
        _DtLinkDbRemoveLink(my_struct->my_links, my_struct->cur_link);
      ...
      case SdlElementSubHead:
        if (SDLIsAttrSet(my_struct->el_info, SDL_ATTR_ABBREV) &&
            ElAbbrev(my_struct) != NULL && strlen(ElAbbrev(my_struct))) {
          AbbrevOfSeg(my_struct->add_seg) = (void *)ElAbbrev(my_struct);
      ...
      case SdlElementSnRef:
        ...
        if (newSeg != pElement) {
          ...
          if (NULL != id) {
             ...
             */
            _DtCvIdOfMarkerSeg(pElement) = _DtCvContainerIdOfSeg(pElement);
            pElement->type = _DtCvSetTypeToMarker(pElement->type);
            newSeg = pElement;
          }
     ...
     */
    FreeAttributes(ElType(my_struct), &(my_struct->el_info),
                   my_struct->my_fonts);
 ...
 *
 ******************************************************************************/
static int FindAndFix(FormatStruct *my_struct) {
...
static int MarkFound(FormatStruct *my_struct, const SDLMask *element_types,
  ...
  if (SDLSearchMask(process_mask, SdlElementCdata) &&
     ...
     */
    if (pSeg != NULL && _DtCvIsSegString(pSeg) && _DtCvIsSegRegChar(pSeg) &&
        !(_DtCvIsSegNewLine(pSeg))) {
      char *strPtr;
      int len = _DtCvStrLen(_DtCvStringOfStringSeg(pSeg), 0);

      _DtCvStringOfStringSeg(pSeg) =
          (char *)realloc(_DtCvStringOfStringSeg(pSeg), len + 2);
      if (_DtCvStringOfStringSeg(pSeg) == NULL)
        return -1;

      strPtr = (char *)_DtCvStrPtr(_DtCvStringOfStringSeg(pSeg), 0, len);
      *strPtr++ = ' ';
      *strPtr = '\0';
...
static int RegisterLink(FormatStruct *my_struct, const SDLMask *element_types,
  ...
  case SdlWindowNew:
    winType = _DtCvWindowHint_NewWindow;
    break;
  case SdlWindowPopup:
    winType = _DtCvWindowHint_PopupWindow;
    break;
  default:
    break;
  }

  my_struct->cur_link = _DtLinkDbAddLink(
      my_struct->my_links, NULL, rid, _DtCvLinkType_SameVolume, winType, NULL);
...
static int ZeroOrOne(FormatStruct *my_struct, const SDLMask *element_types,
  ...
  if (my_struct->parsed == SdlElementNone)
    result = _DtHelpCeReturnSdlElement(
        my_struct->my_file, SdlElementList,
        SDLSearchMask(element_types, SdlElementCdata), &(my_struct->parsed),
        &(my_struct->remember), &(my_struct->end_flag));
  ...
  if (result == 0 && my_struct->end_flag == False &&
    ...
    if (my_struct->parsed != SdlElementCdata ||
      ...
      result = ParseSDL(my_struct, my_struct->parsed, sig_element, exceptions,
                        process_mask);
...
static int OnlyOneEach(FormatStruct *my_struct, const SDLMask *element_types,
  ...
  while (result == 0 && SDLCheckMask(myMask)) {
    if (my_struct->parsed == SdlElementNone)
      result = _DtHelpCeReturnSdlElement(
          my_struct->my_file, SdlElementList,
          SDLSearchMask(myMask, SdlElementCdata), &(my_struct->parsed),
          &(my_struct->remember), &(my_struct->end_flag));
 ...
 *
 ******************************************************************************/
static int Cdata(FormatStruct *my_struct, const SDLMask *cur_element,
                 enum SdlElement sig_element, SDLMask *exceptions,
                 SDLMask *process_mask) {
  int i;
  int reason;
...
#define ESC_STRING_LEN 4
            ...
            if (myLen - i < ESC_STRING_LEN) {
              ...
              string = (char *)realloc(string, sizeof(char) * (myLen + 1));
              if (string == NULL)
                return -1;
            }
          ...
          if (string[i] == '\n') {
            if (ProcessString(my_struct, True, True, True, True, processFlag,
                              string, saveLen, &i) != 0)
              return -1;
          } else if (string[i] == ' ') {
            if (ProcessNonBreakChar(my_struct, processFlag, spaceStr, string,
                                    saveLen, &i) != 0)
              return -1;
          } else if (string[i] == '-') {
            if (ProcessNonBreakChar(my_struct, processFlag, dashStr, string,
                                    saveLen, &i) != 0)
              return -1;
          } else
            my_struct->last_was_space = False;
          ...
          if (type == SdlTypeCdata)
            i++;
          else if (type == SdlTypeDynamic || type == SdlTypeUnlinedLiteral) {
            ...
            if (processFlag == True &&
                MySaveString(&(my_struct->seg_list), my_struct, string,
                             my_struct->cur_link, saveLen, True) != 0) {
              MyFree(string);
              return -1;
            }
          ...
          if (False == my_struct->save_blank && type != SdlTypeLiteral &&
  ...
  do {
    my_struct->parsed = SdlElementNone;
    reason = _DtHelpCeGetSdlCdata(
        my_struct->my_file, type, multiLen, nlToSpace,
        &my_struct->last_was_space, &my_struct->last_was_nl,
        &my_struct->last_was_mb, &nonBreakChar,
        (processFlag == True ? &string : ((char **)NULL)), &myLen);
    if (reason < 0)
      return -1;
    ...
    if (string != NULL && *string != '\0') {
       ...
       * save the string.
       */
      if (MySaveString(&(my_struct->seg_list), my_struct, string,
                       my_struct->cur_link, saveLen,
    ...
    if (2 == reason && True == processFlag) {
      ...
      my_struct->flags = _DtCvSetTypeToNonBreak(my_struct->flags);
      if (MySaveString(&(my_struct->seg_list), my_struct, string,
                       my_struct->cur_link, saveLen, False) != 0) {
        MyFree(string);
        return -1;
      }
      my_struct->flags = my_struct->flags & ~(_DtCvNON_BREAK);
 ...
 *
 ******************************************************************************/
static int ProcessEnterAttr(FormatStruct *my_struct, const SDLMask *cur_element,
                            enum SdlElement sig_element, SDLMask *exceptions,
                            SDLMask *process_mask) {
  /*
 ...
 *
 ******************************************************************************/
static int ProcessExitAttr(FormatStruct *my_struct, const SDLMask *cur_element,
                           enum SdlElement sig_element, SDLMask *exceptions,
                           SDLMask *process_mask) {
  /*
 ...
 *
 ******************************************************************************/
static int FakeEnd(FormatStruct *my_struct, const SDLMask *cur_element,
                   enum SdlElement sig_element, SDLMask *exceptions,
                   SDLMask *process_mask) {
 ...
 *
 ******************************************************************************/
static int AddRowToTable(FormatStruct *my_struct, const SDLMask *cur_element,
                         enum SdlElement sig_element, SDLMask *exceptions,
                         SDLMask *process_mask) {
  if (SDLSearchMask(process_mask, SdlElementFrowvec) != False) {
    ElTableCellIds(my_struct) = (char **)_DtCvAddPtrToArray(
        (void **)ElTableCellIds(my_struct), ElTableCellId(my_struct));
 ...
 *
 ******************************************************************************/
static int SaveLangCharSet(FormatStruct *my_struct, const SDLMask *cur_element,
                           enum SdlElement sig_element, SDLMask *exceptions,
                           SDLMask *process_mask) {
  char **info;
 ...
 *
 ******************************************************************************/
static int CopyDocInfo(FormatStruct *my_struct, const SDLMask *cur_element,
                       enum SdlElement sig_element, SDLMask *exceptions,
                       SDLMask *process_mask) {
  SDLDocInfo *docInfo;
 ...
 *
 ******************************************************************************/
static int CopyAnchorId(FormatStruct *my_struct, const SDLMask *cur_element,
                        enum SdlElement sig_element, SDLMask *exceptions,
                        SDLMask *process_mask) {
 ...
 *
 ******************************************************************************/
static int LoadGraphic(FormatStruct *my_struct, const SDLMask *cur_element,
                       enum SdlElement sig_element, SDLMask *exceptions,
                       SDLMask *process_mask) {
  int result = 0;
    ...
    if (_DtHelpCeAllocSegment(1, NULL, NULL, &cvRegion) == 0) {
      ...
      if (NULL != my_struct->ui_info->load_graphic &&
          (*(my_struct->ui_info->load_graphic))(
              my_struct->ui_info->client_data, my_struct->vol_name,
              my_struct->id_string, ElSnbXid(my_struct), ElSnbFormat(my_struct),
              ElSnbMethod(my_struct), &(_DtCvWidthOfRegionSeg(cvRegion)),
...
static int ColInfoToTableInfo(FormatStruct *my_struct,
  ...
  if (SDLSearchMask(process_mask, SdlElementForm) != False) {
    ...
    for (i = 0; i < mySize; i++) {
      ...
      case 'r':
      case 'R':
        colJust[i] = _DtCvJUSTIFY_RIGHT;
        break;
      case 'c':
      case 'C':
        colJust[i] = _DtCvJUSTIFY_CENTER;
        break;
      case 'd':
      case 'D':
        colJust[i] = _DtCvJUSTIFY_NUM;
        break;
      case 'l':
      case 'L':
        colJust[i] = _DtCvJUSTIFY_LEFT;
        break;
 ...
 *
 ******************************************************************************/
static int CopyIdInfo(FormatStruct *my_struct, const SDLMask *cur_element,
                      enum SdlElement sig_element, SDLMask *exceptions,
                      SDLMask *process_mask) {
  SDLIdInfo *idInfo;
 ...
 *
 ******************************************************************************/
static int RegisterSnbLink(FormatStruct *my_struct, const SDLMask *cur_element,
                           enum SdlElement sig_element, SDLMask *exceptions,
                           SDLMask *process_mask) {
  int linkType;
  int len = 0;
  ...
  if (0 > _DtLinkDbAddLink(my_struct->my_links,
                           _DtCvContainerIdOfSeg(my_struct->add_seg), fileSpec,
                           linkType, _DtCvWindowHint_Original, NULL))
    return -1;
 ...
 *
 ******************************************************************************/
static int RegisterSwitch(FormatStruct *my_struct, const SDLMask *cur_element,
                          enum SdlElement sig_element, SDLMask *exceptions,
                          SDLMask *process_mask) {
  int result = -1;
  char *interpStr;
  ...
  if (NULL != interpStr) {
    if (0 == _DtLinkDbAddSwitch(
                 my_struct->my_links, _DtCvContainerIdOfSeg(my_struct->add_seg),
                 interpStr, _DtCvStringOfStringSeg(my_struct->add_seg),
 ...
 *
 ******************************************************************************/
static int ResolveSpcInfo(FormatStruct *my_struct, const SDLMask *cur_element,
                          enum SdlElement sig_element, SDLMask *exceptions,
                          SDLMask *process_mask) {
  _DtCvSegment *mySeg = my_struct->add_seg;
  ...
  if (SDLSearchMask(process_mask, ElType(my_struct)) != False) {
    ...
    if (_SdlFontModeResolve == my_struct->resolve_font)
      (*(my_struct->ui_info->resolve_spc))(
          my_struct->ui_info->client_data, ElLanguage(my_struct),
          ElCharSet(my_struct), *(my_struct->my_fonts), ElSpcName(my_struct),
      ...
      if (_SdlFontModeSave == my_struct->resolve_font) {
        ...
        _DtHelpFontHintsLang(spcInfo->spc_fonts) = ElLanguage(my_struct);
        _DtHelpFontHintsCharSet(spcInfo->spc_fonts) = ElCharSet(my_struct);
 ...
 *
 ******************************************************************************/
static int CopyTossInfo(FormatStruct *my_struct, const SDLMask *cur_element,
                        enum SdlElement sig_element, SDLMask *exceptions,
                        SDLMask *process_mask) {
 ...
 *
 ******************************************************************************/
static int CopyEntryInfo(FormatStruct *my_struct, const SDLMask *cur_element,
                         enum SdlElement sig_element, SDLMask *exceptions,
                         SDLMask *process_mask) {
 ...
 *
 ******************************************************************************/
static int InitLast(FormatStruct *my_struct, const SDLMask *cur_element,
                    enum SdlElement sig_element, SDLMask *exceptions,
                    SDLMask *process_mask) {
  /*
   ...
   */
  if (NULL != my_struct->add_seg && (SdlTypeLiteral == ElFrmtType(my_struct) ||
 ...
 *
 ******************************************************************************/
static int SetTransit(FormatStruct *my_struct, const SDLMask *cur_element,
                      enum SdlElement sig_element, SDLMask *exceptions,
                      SDLMask *process_mask) {
  if (ElTiming(my_struct) == SdlTimingAsync)
    my_struct->resolve_font = _SdlFontModeNone;
...
static int ParseSDL(FormatStruct *my_struct, enum SdlElement cur_element,
  ...
  if (cur_element != SdlElementCdata) {
    if (ParseElementStart(my_struct, SdlElementList[i], processFlag) != 0 ||
        ParseElementAttr(my_struct, cur_element, SdlElementList[i].attrib_list,
                         SdlElementList[i].cdata_flag, processFlag) != 0)
      result = -1;
  }
  ...
  while (result == 0 && content != NULL &&
    ...
    result = (*(content->model))(my_struct, content->mask, sig_element,
                                 cur_except, process_mask);
    content++;
  }
  ...
  if (cur_element != SdlElementCdata) {
    if (result == 0 && SdlElementList[i].element_end_str != NULL)
      result = ParseElementEnd(my_struct, ifPrevData, SdlElementList[i],
                               processFlag, my_struct->faked_end);
    else {
      /*
       * free the attributes for this element.
       */
...
static int ProcessSDLMarkup(FormatStruct *my_struct,
                            ...
                            SDLMask *process_mask) {
  int result =
      ParseSDL(my_struct, cur_element, sig_element, cur_except, process_mask);
 ...
 * Purpose:
 ******************************************************************************/
static int ProcessContent(FormatStruct *my_struct, const SDLContent *content,
                          enum SdlElement sig_element, SDLMask *exceptions,
                          SDLMask *process_mask) {
  int result = 0;
 ...
 *
 ******************************************************************************/
static _DtCvSegment *SearchForController(_DtCvSegment *p_seg) {
  while (NULL != p_seg &&
 ...
 *
 ******************************************************************************/
static int FormatSDLTitle(char *filename, int offset, int fd,
                          FormatStruct *my_struct) {
  int result = 0;
  ...
  */
   ...
   */
  result = _DtHelpCeFileOpenAndSeek(filename, offset, fd, &(my_struct->my_file),
                                    NULL);
  if (result != -1) {
 ...
 *
 ******************************************************************************/
static void SetGhostLink(_DtCvLinkDb link_data, _DtCvSegment *segments,
                         int link_idx) {
  while (segments != NULL) {
    if (!(_DtCvIsSegContainer(segments))) {
      ...
      SetGhostLink(link_data, _DtCvContainerListOfSeg(segments), link_idx);
 ...
 *
 ******************************************************************************/
static void CreateAsciiString(_DtCvSegment *p_seg, _DtCvSegment *snb,
                              _DtCvValue *nl_flag, char **ret_string) {
  int newLen;
  int len;
  ...
  while (p_seg != NULL) {
    ...
    if (_DtCvIsSegString(p_seg)) {
      ...
      newLen =
          _DtCvStrLen(_DtCvStringOfStringSeg(p_seg), _DtCvIsSegWideChar(p_seg));
      ...
      if (_DtCvIsSegWideChar(p_seg))
        wcstombs(&((*ret_string)[len]),
                 (wchar_t *)_DtCvStringOfStringSeg(p_seg), newLen + 1);
      else
      ...
      *nl_flag = False;
      ...
      CreateAsciiString(_DtCvContainerListOfSeg(p_seg), snb, nl_flag,
                        ret_string);
 ...
 *
 ******************************************************************************/
static void CreateAsciiAbbrev(_DtCvSegment *p_el, char **ret_abbrev) {
  *ret_abbrev = NULL;
 ...
 *
 ******************************************************************************/
static void CleanUpToc(FormatStruct *my_struct, _DtCvSegment *p_seg, int level,
                       _DtCvValue target) {
  level--;
  if (level < 0)
    level = 0;
  ...
  while (p_seg != NULL) {
    ...
    if (_DtCvIsSegContainer(p_seg)) {
      ...
      CleanUpToc(my_struct, _DtCvContainerListOfSeg(p_seg), level, target);
    } else if (_DtCvIsSegString(p_seg)) {
      _DtHelpFontHints *font_specs =
          (_DtHelpFontHints *)_DtCvFontOfStringSeg(p_seg);
      ...
      (my_struct->ui_info->load_font)(
          my_struct->ui_info->client_data, _DtHelpFontHintsLang(*font_specs),
          _DtHelpFontHintsCharSet(*font_specs), *font_specs,
      ...
      if (_DtHelpDASpc == pReg->type) {
        ...
        _DtHelpFontHintsWeight(pSpc->spc_fonts) = _DtHelpFontWeightMedium;

        if (True == target)
          _DtHelpFontHintsWeight(pSpc->spc_fonts) = _DtHelpFontWeightBold;

        result = (*(my_struct->ui_info->resolve_spc))(
            my_struct->ui_info->client_data,
            _DtHelpFontHintsLang(pSpc->spc_fonts),
            _DtHelpFontHintsCharSet(pSpc->spc_fonts), pSpc->spc_fonts,
            pSpc->name, &(_DtCvInfoOfRegionSeg(p_seg)),
            &(_DtCvWidthOfRegionSeg(p_seg)), &(_DtCvHeightOfRegionSeg(p_seg)),
 ...
 *
 ******************************************************************************/
static int AddEntryToToc(FormatStruct *my_struct, _DtHelpVolumeHdl volume,
                         int fd, int level, char *lang, const char *char_set,
                         _DtCvSegment *toss, _DtCvSegment *info_seg,
                         _DtCvValue target, _DtCvSegment **ret_snb,
                         _DtCvSegment **seg_list, _DtCvSegment **prev_list) {
  int result = 0;
  ...
  if (SetUp(NULL, NULL, my_struct, toss, my_struct->ui_info, fd, False,
            False) != 0)
    return -1;
  ...
  if (result != -1) {
    ...
    if (my_struct->seg_list != NULL)
      headEl =
          SearchForController(_DtCvContainerListOfSeg(my_struct->seg_list));
    ...
    if (headEl == NULL) {
      ...
      if (MySaveString(&(addSeg), my_struct, _DtCvContainerIdOfSeg(info_seg),
      ...
      if (NULL != my_struct->seg_list) {
         ...
         */
        _DtHelpFreeSegments(_DtCvContainerListOfSeg(my_struct->seg_list),
                            _DtCvTRUE, my_struct->ui_info->destroy_region,
                            my_struct->ui_info->client_data);
      } else {
        /*
         * create a container for the segment.
         */
        if (_DtHelpCeAllocSegment(
                my_struct->malloc_size, &(my_struct->alloc_size),
                &(my_struct->block_list), &(my_struct->seg_list)) != 0) {
     ...
     */
      ...
      if (MySaveString(&(_DtCvContainerListOfSeg(headEl)), my_struct, myPtr, -1,
                       my_struct->mb_len, False) != 0) {
        /*
         * free the segments
         */
        _DtHelpFreeSegments(my_struct->seg_list, _DtCvTRUE,
    ...
    if (headEl != NULL) {
      int linkIndex = _DtLinkDbAddLink(
          my_struct->my_links, NULL, _DtCvContainerIdOfSeg(info_seg),
          _DtCvLinkType_SameVolume, _DtCvWindowHint_CurrentWindow, NULL);
 ...
 *
 ******************************************************************************/
static int ExpandToc(FormatStruct *my_struct, _DtHelpVolumeHdl volume, int fd,
                     char *lang, const char *char_set, _DtCvSegment *toss,
                     int level, char **path_list, _DtCvSegment **id_seg,
                     _DtCvSegment **ret_snb, _DtCvSegment **seg_list,
    ...
    if (_SdlSegToSdlIdInfoType(pEl) == SdlIdVirpage) {
      if (segLev == level) {
        ...
        if (found == False && *path_list != NULL &&
          ...
          tst = _DtCvStrCaseCmpLatin1(*path_list, _DtCvContainerIdOfSeg(pEl));
         ...
         */
        result = AddEntryToToc(
            my_struct, volume, fd, segLev, lang, char_set, toss, pEl,
            (tst == 0 && path_list[1] == NULL ? True : False), ret_snb,
            seg_list, prev_list);
        ...
        *id_seg = _DtCvNextSeg((*id_seg));
        ...
        if (tst == 0) {
          result =
              ExpandToc(my_struct, volume, fd, lang, char_set, toss, segLev + 1,
                        &path_list[1], id_seg, ret_snb, seg_list, prev_list);
          found = True;
          tst = 1;
        }
 ...
 *
 ******************************************************************************/
static int CreateTitleChunks(
    _DtCvSegment *toss, _DtCvSegment *p_seg, _DtCvSegment *snb,
    SDLMask *stop_mask, const char *lang, const char *char_set,
    _DtCvValue (*resolve_spc)(void *, char *, const char *, _DtHelpFontHints,
                              const char *, void **, _DtCvUnit *, _DtCvUnit *,
                              _DtCvUnit *),
    _DtCvPointer client_data, int *ret_cnt, void ***ret_chunks) {
  long type;
  int cnt;
  int result = 0;
  const char *myLang;
    ...
    if (_DtCvIsSegString(p_seg)) {
      ...
      *ret_cnt = *ret_cnt + 3;
      if (*ret_chunks == NULL)
        ...
        *ret_chunks =
            (void **)realloc(*ret_chunks, sizeof(void *) * (*ret_cnt));
      if (*ret_chunks == NULL)
        return -1;
      ...
      if (_DtCvIsSegWideChar(p_seg)) {
        int len =
            _DtCvStrLen(_DtCvStringOfStringSeg(p_seg), 1) * MB_CUR_MAX + 1;

        ptr = malloc(sizeof(char *) * len);
        if (NULL != ptr)
          wcstombs((char *)ptr, (wchar_t *)_DtCvStringOfStringSeg(p_seg), len);
      } else
      ...
      if (_DtHelpDASpc == daRegion->type) {
        if (False == daRegion->inited) {
          _DtHelpDASpcInfo *pSpc = (_DtHelpDASpcInfo *)daRegion->handle;
          /*
           * allocate the spc!
           */
          result = (*(resolve_spc))(
              client_data, _DtHelpFontHintsLang(pSpc->spc_fonts),
              _DtHelpFontHintsCharSet(pSpc->spc_fonts), pSpc->spc_fonts,
              pSpc->name, &(_DtCvInfoOfRegionSeg(p_seg)),
              &(_DtCvWidthOfRegionSeg(p_seg)), &(_DtCvHeightOfRegionSeg(p_seg)),
              &(_DtCvAscentOfRegionSeg(p_seg)));
      ...
      result = CreateTitleChunks(toss, _DtCvContainerListOfSeg(p_seg), snb,
                                 stop_mask, myLang, mySet, resolve_spc,
                                 client_data, ret_cnt, ret_chunks);
 ...
 *
 ******************************************************************************/
static int ProcessSegmentsToChunks(
    _DtCvSegment *toss, _DtCvSegment *head_el, _DtCvSegment *snb_el,
    SDLMask *stop_mask, const char *lang, const char *char_set,
    _DtCvValue (*resolve_spc)(void *, char *, const char *, _DtHelpFontHints,
                              const char *, void **, _DtCvUnit *, _DtCvUnit *,
                              _DtCvUnit *),
    _DtCvPointer client_data, void ***ret_chunks) {
  int cnt = 0;
  int result = 0;

  result = CreateTitleChunks(toss, _DtCvContainerListOfSeg(head_el), snb_el,
                             stop_mask, lang, char_set, resolve_spc,
                             client_data, &cnt, ret_chunks);
 ...
 *		sdldoc element.
 ******************************************************************************/
static _DtCvSegment *GetSdlDocSnb(_DtHelpVolumeHdl volume) {
 ...
 ******************************************************************************/
static int GetDocumentTitle(_DtHelpVolumeHdl volume, _FrmtUiInfo *ui_info,
                            _SdlFontMode mode, _DtCvValue flag,
                            _DtCvSegment **ret_seg) {
  int result = -1;
  short procFlag = True;
  CESDLVolume *sdlVol;
  ...
  if (sdlVol->title_processed == False) {
    ...
    if (_DtHelpCeFileOpenAndSeek(_DtHelpCeGetVolumeName(volume), 0, -1,
      ...
      if (ProcessContent(&frmtStruct, SDLDocumentContent, SdlElementNone,
                         startExcept, skipMask) != -1 &&
          ProcessSDLMarkup(&frmtStruct, SdlElementVStruct, SdlElementNone,
                           startExcept, skipMask) != -1 &&
          ProcessContent(&frmtStruct, HeadAndSnb, SdlElementNone, startExcept,
                         processMask) != -1) {
        ...
        _DtHelpFreeSegments(frmtStruct.seg_list, _DtCvFALSE,
                            ui_info->destroy_region, ui_info->client_data);
 ...
 * Purpose:
 ******************************************************************************/
const SDLAttribute *_DtHelpCeGetSdlAttributeList(void) {
 ...
 *
 ******************************************************************************/
int _DtHelpCeFrmtSdlPathAndChildren(_DtHelpVolumeHdl volume,
                                    _FrmtUiInfo *ui_info, int fd,
                                    char *target_id,
                                    _DtCvTopicPtr *ret_handle) {
  char *lang;
  const char *charSet;
  ...
  *ret_handle = NULL;
  ...
  if (_SdlIdInfoPtrRlevel(info) > 0) {
    ...
    result = AddEntryToToc(&frmtStruct, volume, fd, _SdlIdInfoPtrRlevel(info),
                           lang, charSet, _DtHelpCeGetSdlVolToss(volume, fd),
                           loids, (topicMap[1] == NULL ? True : False), &snb,
                           &mySegList, &myPrevSeg);
    /*
     * format the children.
     */
    if (result != -1 && _DtCvNextSeg(loids) != NULL) {
      ...
      result = ExpandToc(&frmtStruct, volume, fd, lang, charSet,
                         ...
                         _SdlIdInfoPtrRlevel(info) + 1, &topicMap[1], &loids,
 ...
 *
 ******************************************************************************/
int _DtHelpCeFrmtSdlVolumeInfo(char *filename, _DtHelpVolumeHdl volume,
                               time_t *ret_time) {
  int result = 0;
  char *numPtr;
  CESDLVolume *sdlVol;
  ...
  if (SetUp(volume, &sdlVol, &frmtStruct, NULL, &DefUiInfo, -1, True, False) !=
      0)
    return -1;
  ...
  if (result == 0) {
    result = _DtHelpCeFileOpenAndSeek(filename, 0, -1, &(frmtStruct.my_file),
                                      ret_time);
    if (result != -1) {
      result = ProcessContent(&frmtStruct, SDLDocumentContent, SdlElementNone,
                              startExcept, processMask);
    ...
    if (result != -1) {
       ...
       */
      sdlVol->sdl_info =
          (SDLDocInfo *)FrmtPrivInfoPtr(frmtStruct.seg_list)->doc_info;
 ...
 * Purpose:
 ******************************************************************************/
int _DtHelpCeFrmtSDLTitleToAscii(_DtHelpVolumeHdl volume, int offset,
                                 char **ret_title, char **ret_abbrev) {
  int result = 0;
  FormatStruct frmtStruct;
  ...
  *ret_title = NULL;
  ...
  if (result != -1 && frmtStruct.seg_list != NULL) {
    ...
    if (pHeadSeg != NULL) {
      CreateAsciiString(_DtCvContainerListOfSeg(pHeadSeg), frmtStruct.snb,
                        &nlFlag, ret_title);
 ...
 *
 ******************************************************************************/
char *_DtHelpCeFrmtSdlVolumeAbstractToAscii(_DtHelpVolumeHdl volume) {
  int offset;
  char *abstr = NULL;
  _DtCvSegment *pSeg;
  _DtCvSegment *pSnb;
  ...
  if (_DtHelpCeFindSdlId(volume, "_abstract", lockInfo.fd, NULL, &offset) ==
      True) {
    int result = 0;
    SDLMask startExcept[SDL_MASK_LEN] = SDLInitMask(SdlElementNone);
    SDLMask processMask[SDL_MASK_LEN] = SDLSetAllBits;
    ...
    if (SetUp(volume, &sdlVol, &frmtStruct, NULL, &DefUiInfo, lockInfo.fd, True,
              False) != 0)
      return NULL;
     ...
     */
    result = _DtHelpCeFileOpenAndSeek(_DtHelpCeGetVolumeName(volume), offset,
                                      lockInfo.fd, &(frmtStruct.my_file), NULL);
    if (result != -1) {
      result = ProcessSDLMarkup(&frmtStruct, SdlElementVirpage, SdlElementNone,
                                startExcept, processMask);
 ...
 * Purpose:
 ******************************************************************************/
int _DtHelpCeFrmtSDLVolTitleToAscii(_DtHelpVolumeHdl volume,
                                    _FrmtUiInfo *ui_info, char **ret_title) {
  char *abbrev = NULL;
  int result = 0;
  _DtCvSegment *pHeadSeg;
  _DtHelpCeLockInfo lockInfo;
  ...
  *ret_title = NULL;
  ...
  result =
      GetDocumentTitle(volume, ui_info, _SdlFontModeNone, False, &pHeadSeg);
  _DtHelpCeUnlockVolume(lockInfo);
  ...
  if (result == 0) {
    ...
    if (0 != result && pHeadSeg != NULL &&
      ...
      CreateAsciiString(_DtCvContainerListOfSeg(pHeadSeg), GetSdlDocSnb(volume),
                        &nlFlag, ret_title);
      if (abbrev != NULL)
        free(abbrev);
 ...
 * Purpose:
 ******************************************************************************/
int _DtHelpCeGetSdlTitleChunks(_DtHelpVolumeHdl volume, char *loc_id,
                               _FrmtUiInfo *ui_info, void ***ret_chunks) {
  int result = 0;
  int offset;
  FormatStruct frmtStruct;
  CESDLVolume *sdlVol;
  SDLMask stopMask[SDL_MASK_LEN] = SDLInitMask(SdlElementSubHead);
  ...
  *ret_chunks = NULL;
  ...
  if (result != -1 && frmtStruct.seg_list != NULL) {
    ...
    if (NULL != headEl && _DtCvIsSegContainer(headEl) &&
      ...
      result = ProcessSegmentsToChunks(
          frmtStruct.toss, headEl, pSnbEl, stopMask,
          _DtHelpCeGetSdlVolLanguage(volume), _DtHelpCeGetSdlVolCharSet(volume),
          ui_info->resolve_spc, ui_info->client_data, ret_chunks);
    }
  } else
    result = -1;
  ...
  if (frmtStruct.snb != NULL)
    _DtHelpFreeSegments(frmtStruct.snb, _DtCvFALSE, ui_info->destroy_region,
                        ui_info->client_data);
 ...
 * Purpose:
 ******************************************************************************/
int _DtHelpCeGetSdlVolTitleChunks(_DtHelpVolumeHdl volume_handle,
                                  _FrmtUiInfo *ui_info, void ***ret_chunks) {
  int result = -2;
  _DtCvSegment *pHeadSeg;
  CESDLVolume *sdlVol;
   ...
   * get the head element
   */
  if (GetDocumentTitle(volume_handle, ui_info, _SdlFontModeResolve, True,
                       &pHeadSeg) == -1)
    return -1;
  ...
  if (pHeadSeg != NULL)
    result = ProcessSegmentsToChunks(
        _DtHelpCeGetSdlVolToss(volume_handle, -1), pHeadSeg,
        GetSdlDocSnb(volume_handle), stopMask,
        _DtHelpCeGetSdlVolLanguage(volume_handle),
        _DtHelpCeGetSdlVolCharSet(volume_handle), ui_info->resolve_spc,
        ui_info->client_data, ret_chunks);
  if (result != 0) {
    result = _DtHelpCeGetSdlTitleChunks(volume_handle, "_title", ui_info,
                                        ret_chunks);
    if (result != 0)
      result = _DtHelpCeGetSdlTitleChunks(volume_handle, "_hometopic", ui_info,
                                          ret_chunks);
  }
 ...
 ******************************************************************************/
_DtCvSegment *_DtHelpCeGetSdlVolToss(_DtHelpVolumeHdl volume, int fd) {
  CESDLVolume *sdlVol;
  FormatStruct frmtStruct;
  SDLMask skipMask[SDL_MASK_LEN] = SDLClearAllBits;
  SDLMask startExcept[SDL_MASK_LEN] = SDLInitMask(SdlElementNone);
  ...
  if (sdlVol->toss == NULL &&
      SetUp(volume, NULL, &frmtStruct, NULL, &DefUiInfo, fd, True, False) ==
          0 &&
      _DtHelpCeFileOpenAndSeek(_DtHelpCeGetVolumeName(volume), 0, fd,
                               &(frmtStruct.my_file), NULL) != -1) {
    if (ProcessContent(&frmtStruct, SDLDocumentContent, SdlElementNone,
                       startExcept, skipMask) != -1 &&
        ProcessSDLMarkup(&frmtStruct, SdlElementVStruct, SdlElementToss,
                         startExcept, skipMask) != -1)
 ...
 ******************************************************************************/
int _DtHelpCeGetSdlVolIndex(_DtHelpVolumeHdl volume) {
  int result = -1;
  CESDLVolume *sdlVol;
  FormatStruct frmtStruct;
  SDLMask skipMask[SDL_MASK_LEN] = SDLClearAllBits;
  ...
  if (_DtHelpCeFileOpenAndSeek(_DtHelpCeGetVolumeName(volume), 0, -1,
    ...
    if (ProcessContent(&frmtStruct, SDLDocumentContent, SdlElementNone,
                       startExcept, skipMask) != -1 &&
        ProcessSDLMarkup(&frmtStruct, SdlElementVStruct, SdlElementIndex,
                         startExcept, skipMask) != -1) {
 ...
 ******************************************************************************/
int _DtHelpCeGetSdlVolIds(_DtHelpVolumeHdl volume, int fd,
                          _DtCvSegment **ret_ids) {
  int result = 0;
  CESDLVolume *sdlVol;
  FormatStruct frmtStruct;
  ...
  *ret_ids = NULL;
  ...
  if (sdlVol->loids == NULL) {
    result = -1;
    if (SetUp(NULL, NULL, &frmtStruct, NULL, &DefUiInfo, -1, False, False) !=
            -1 &&
        _DtHelpCeFileOpenAndSeek(_DtHelpCeGetVolumeName(volume), 0, fd,
                                 &(frmtStruct.my_file), NULL) != -1) {
      if (ProcessContent(&frmtStruct, SDLDocumentContent, SdlElementNone,
                         startExcept, skipMask) != -1) {
        if (ProcessSDLMarkup(&frmtStruct, SdlElementVStruct, SdlElementLoids,
                             startExcept, skipMask) != -1) {
 ...
 *
 ******************************************************************************/
int _DtHelpCeParseSdlTopic(_DtHelpVolumeHdl volume, _FrmtUiInfo *ui_info,
                           int fd, int offset, char *id_string, int rich_text,
                           _DtCvTopicPtr *ret_handle) {
  int result = 0;
  SDLMask startExcept[SDL_MASK_LEN] = SDLInitMask(SdlElementNone);
  SDLMask processMask[SDL_MASK_LEN] = SDLSetAllBits;
  ...
  *ret_handle = NULL;
  ...
  if (SetUp(volume, &sdlVol, &frmtStruct, NULL, ui_info, fd, True, rich_text) !=
      0)
    return -1;
  ...
  result = _DtHelpCeFileOpenAndSeek(_DtHelpCeGetVolumeName(volume), offset, fd,
