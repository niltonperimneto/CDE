...
typedef struct _DtHelpListStruct DtHelpListStruct;
typedef struct _DtHelpCommonHelpStuff _DtHelpCommonHelpStuff;
 ...
 *
 ***************************************************************************/
extern void _DtHelpCB(Widget widget, XtPointer clientData, XtPointer callData);
 ...
 *
 *****************************************************************************/
extern void _DtHelpListFree(struct _DtHelpListStruct **pHead);
 ...
 *
 *****************************************************************************/
extern struct _DtHelpListStruct *
_DtHelpListAdd(char *locationId, Widget widget,
               struct _DtHelpCommonHelpStuff *help,
               struct _DtHelpListStruct **pHead);
