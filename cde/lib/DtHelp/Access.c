...
static int GetVolumeKeywords(_DtHelpVolume vol, char ***retKeywords);
static int VolumeLoad(char *volFile, _DtHelpVolume *retVol);
static int VolumeUnload(_DtHelpVolume vol);
 ...
 *
 ******************************************************************************/
static int CheckVolList(_DtHelpVolume vol, _DtHelpVolume *ret_prev) {
  _DtHelpVolume myVol;
 ...
 *
 ******************************************************************************/
static int RereadVolume(_DtHelpVolume vol) {
  int result;
  char ***topicList;
 ...
 *
 ******************************************************************************/
static int GetKeywordTopics(_DtHelpVolume vol, char *keyword,
                            char ***retTopics) {
  char **keywords;
  char **nextKey;
  int index;
...
/******************************************************************************
 * Function:	static int GetVolumeKeywords(_DtHelpVolume vol,char
 * ***keywords);
 *
 ...
 *
 *****************************************************************************/
static int GetTopicTitleAndAbbrev(_DtHelpVolume volume, char *id,
                                  char **ret_name, char **ret_abbrev) {
  int result = 0;
  int offset;
    ...
    if (0 == _DtHelpCeGetVolumeFlag(volume)) {
      ...
      if (result == 0) {
        ...
        if (_DtHelpCeReadBuf(file, buffer, BUFF_SIZE) != -1) {
          result = 0;
          bufPtr = buffer;
          if (_DtHelpCeGetCcdfTopicAbbrev(NULL, file, buffer, &bufPtr,
                                          BUFF_SIZE, MB_CUR_MAX, ret_name, NULL,
                                          ret_abbrev) != 0)
            result = -3;
        }
      ...
      _DtHelpProcessLock();
      if (_DtHelpCeFrmtSDLTitleToAscii(volume, offset, ret_name, ret_abbrev) !=
          0)
        result = -3;
      _DtHelpProcessUnlock();
    }
 ...
 *
 *****************************************************************************/
static int FileOpenRtnFd(char *name, int *ret_fd) {
  char *inFile = NULL;
 ...
 ******************************************************************************/
/*****************************************************************************
 * Function: char *_DtHelpCeExpandPathname (char *spec, char *filename, char
 * *type, char *suffix, char *lang, _DtSubstitutionRec *subs, int num)
 *
 * Parameters:
 ...
 *
 *****************************************************************************/
char *_DtHelpCeExpandPathname(char *spec, char *filename, char *type,
                              char *suffix, char *lang,
                              _DtSubstitutionRec *subs, int num) {
  int i;
  int len = 1;
  char *ptr;
  char *subString;
      ...
      default:
        ...
        if (i < MY_NUM) {
          if (mySubs[i].substitution != NULL) {
            ...
            if (((int)(ptr - pathName + strlen(subString))) > MAXPATHLEN) {
 ...
 *
 *****************************************************************************/
int _DtHelpCeGetLangSubParts(char *lang, char **subLang, char **subTer,
                             char **subCodeSet) {
  int len;
  char *ptr;
  char *sLang = NULL;
 ...
 *
 *****************************************************************************/
int _DtHelpCeGetUncompressedFileName(char *name, char **ret_name) {
  char *inFile = NULL;
  char tmpName[MAXPATHLEN + 1];
  int result = 1;
 ...
 *
 ******************************************************************************/
int _DtHelpCeCompressPathname(char *basePath) {
  int len;
  int result;
  short char1;
  short char2;
 ...
 *
 ******************************************************************************/
char *_DtHelpCeTracePathName(char *path) {
  int result;
  int len;
  char c;
  char *ptr;
 ...
 *
 ******************************************************************************/
char *_DtHelpCeTraceFilenamePath(char *file_path) {
  int result;
  int done = False;
  char *newPath;
  char *oldName;
 ...
 *
 *****************************************************************************/
char *_DtHelpCeGetVolumeName(_DtHelpVolumeHdl volume_handle) {
  char *volFile;
 ...
 *
 *****************************************************************************/
int _DtHelpCeFileOpenAndSeek(char *name, int offset, int fd,
                             BufFilePtr *ret_file, time_t *ret_time) {
  ...
  if (bytesRead != 4) { /* something's wrong in reading the file */
    if (fd == -1)
      close(tmpFd);
    return -1;
  }

  if (!*fileMagic) { /* started with compressed file magic number */
     ...
     */
    myInfo->fd = tmpFd;
    myInfo->size = (((fileMagic[1] * 256) + fileMagic[2]) * 256) + fileMagic[3];
 ...
 *
 ******************************************************************************/
int _DtHelpOpenVolume(char *volFile, _DtHelpVolumeHdl *retVol) {
  int result = 0;
 ...
 *
 ******************************************************************************/
int _DtHelpCeUpVolumeOpenCnt(_DtHelpVolumeHdl volume) {
 ...
 *
 ******************************************************************************/
int _DtHelpCloseVolume(_DtHelpVolumeHdl volume) {
  _DtHelpVolume prevVol;
  _DtHelpVolume vol = (_DtHelpVolume)volume;
 ...
 *
 *****************************************************************************/
int _DtHelpCeGetTopTopicId(_DtHelpVolumeHdl volume, char **ret_idString) {
  int found = False;
  _DtHelpVolume vol = (_DtHelpVolume)volume;
 ...
 *
 *****************************************************************************/
int _DtHelpCeFindId(_DtHelpVolumeHdl volume, char *target_id, int fd,
                    char **ret_name, int *ret_offset) {
  _DtHelpVolume vol = (_DtHelpVolume)volume;
  int result;
...
/*****************************************************************************
 * Function: int _DtHelpCeGetKeywordList (_DtHelpVolume vol, char
 * ***ret_keywords)
 *
 * Parameters:	vol		Specifies the loaded volume
 ...
 *
 *****************************************************************************/
int _DtHelpCeGetKeywordList(_DtHelpVolumeHdl volume, char ***ret_keywords) {
  int nameCount = -1;
  _DtHelpVolume vol = (_DtHelpVolume)volume;
...
/*****************************************************************************
 * Function: int _DtHelpCeFindKeyword (_DtHelpVolume vol, char *target, char
 * ***ret_ids)
 *
 * Parameters:	vol		Specifies the loaded volume
 ...
 *
 *****************************************************************************/
int _DtHelpCeFindKeyword(_DtHelpVolumeHdl volume, char *target,
                         char ***ret_ids) {
  int nameCount = -1;
  _DtHelpVolume vol = (_DtHelpVolume)volume;
 ...
 *
 *****************************************************************************/
int _DtHelpGetTopicTitle(_DtHelpVolumeHdl volume, char *id, char **ret_title) {
  int result;
  char *abbrevTitle;
  _DtHelpVolume vol = (_DtHelpVolume)volume;

  if (volume == NULL || id == NULL || CheckVolList(vol, NULL) == -1 ||
      ret_title == NULL) {
    errno = EINVAL;
    return -1;
  }
 ...
 *
 *****************************************************************************/
int _DtHelpCeMapTargetToId(_DtHelpVolumeHdl volume, char *target_id,
                           char **ret_id) {
  _DtHelpVolume vol = (_DtHelpVolume)volume;
  int result;
 ...
 *
 *****************************************************************************/
char *_DtHelpGetVolumeLocale(_DtHelpVolumeHdl volume) {
  _DtHelpVolume vol = (_DtHelpVolume)volume;
  char *result;
 ...
 *
 *****************************************************************************/
int _DtHelpCeGetDocStamp(_DtHelpVolumeHdl volume, char **ret_doc,
                         char **ret_time) {
  _DtHelpVolume vol = (_DtHelpVolume)volume;
  int result;
 ...
 *
 *****************************************************************************/
int _DtHelpCeGetTopicChildren(_DtHelpVolumeHdl volume, char *topic_id,
                              char ***retTopics) {
  _DtHelpVolume vol = (_DtHelpVolume)volume;
  int result;
 ...
 *
 *****************************************************************************/
int _DtHelpCeGetVolumeFlag(_DtHelpVolumeHdl volume) {
  _DtHelpVolume vol = (_DtHelpVolume)volume;
 ...
 *
 *****************************************************************************/
int _DtHelpCeUnlockVolume(_DtHelpCeLockInfo lock_info) {
 ...
 *
 *****************************************************************************/
int _DtHelpCeIsTopTopic(_DtHelpVolumeHdl volume, const char *id) {
  int result = -1;
  char *topicId = NULL;
  char *topId = NULL;
  _DtHelpVolume vol = (_DtHelpVolume)volume;
