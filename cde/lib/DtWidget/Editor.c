...
extern char *_XmStringSourceGetString(XmTextWidget tw, XmTextPosition from,
                                      XmTextPosition to,
...
static void Initialize(Widget rw, Widget nw, ArgList al, Cardinal *num_args);

static void VariableInitialize(DtEditorWidget new);

static void ValidateResources(DtEditorWidget new, DtEditorWidget request);

static Widget CreateText(DtEditorWidget parent);

static void extractFontMetrics(DtEditorWidget w, XmFontList fontlist,
                               int *height, int *width);

static void getFontMetrics(DtEditorWidget w);

static void Destroy(Widget widget);

static void SetStatusLine(DtEditorWidget ew, Boolean statusLineOn);

static Widget CreateStatusLine(DtEditorWidget parent);

static Boolean SetValues(Widget cw, Widget rw, Widget nw);

static void _DtEditorGetCenterToggleLabel(Widget wid, int resource_offset,
                                          XtArgVal *value);

static void _DtEditorGetChangeAllButtonLabel(Widget wid, int resource_offset,
                                             XtArgVal *value);

static void _DtEditorGetChangeButtonLabel(Widget wid, int resource_offset,
                                          XtArgVal *value);

static void _DtEditorGetChangeFieldLabel(Widget wid, int resource_offset,
                                         XtArgVal *value);

static void _DtEditorGetColumns(Widget wid, int resource_offset,
                                XtArgVal *value);

static void _DtEditorGetCurrentLineLabel(Widget wid, int resource_offset,
                                         XtArgVal *value);

static void _DtEditorGetCursorPosition(Widget wid, int resource_offset,
                                       XtArgVal *value);

static void _DtEditorGetFindButtonLabel(Widget wid, int resource_offset,
                                        XtArgVal *value);

static void _DtEditorGetFindFieldLabel(Widget wid, int resource_offset,
                                       XtArgVal *value);

static void _DtEditorGetFormatAllButtonLabel(Widget wid, int resource_offset,
                                             XtArgVal *value);

static void _DtEditorGetFormatParagraphButtonLabel(Widget wid,
                                                   int resource_offset,
                                                   XtArgVal *value);

static void _DtEditorGetJustifyToggleLabel(Widget wid, int resource_offset,
                                           XtArgVal *value);

static void _DtEditorGetLeftAlignToggleLabel(Widget wid, int resource_offset,
                                             XtArgVal *value);

static void _DtEditorGetLeftMarginFieldLabel(Widget wid, int resource_offset,
                                             XtArgVal *value);

static void _DtEditorGetMaxLength(Widget wid, int resource_offset,
                                  XtArgVal *value);

static void _DtEditorGetMisspelledListLabel(Widget wid, int resource_offset,
                                            XtArgVal *value);
...
static void _DtEditorGetRows(Widget wid, int resource_offset, XtArgVal *value);

static void _DtEditorGetScrollLeftSide(Widget wid, int resource_offset,
                                       XtArgVal *value);

static void _DtEditorGetScrollTopSide(Widget wid, int resource_offset,
                                      XtArgVal *value);

static void _DtEditorGetTextBackground(Widget wid, int resource_offset,
                                       XtArgVal *value);

static void _DtEditorGetTextForeground(Widget wid, int resource_offset,
                                       XtArgVal *value);

static void _DtEditorGetTopCharacter(Widget wid, int resource_offset,
                                     XtArgVal *value);

static void _DtEditorGetLineCountLabel(Widget wid, int resource_offset,
                                       XtArgVal *value);
...
static void BackwardChar(Widget w, XEvent *event, char **params,
                         Cardinal *num_params);

static void BackwardPara(Widget w, XEvent *event, char **params,
                         Cardinal *num_params);

static void BackwardWord(Widget w, XEvent *event, char **params,
                         Cardinal *num_params);

static void BeginningOfFile(Widget w, XEvent *event, char **params,
                            Cardinal *num_params);

static void BeginningOfLine(Widget w, XEvent *event, char **params,
                            Cardinal *num_params);

static void ClearSelection(Widget w, XEvent *event, char **params,
                           Cardinal *num_params);

static void CopyClipboard(Widget w, XEvent *event, char **params,
                          Cardinal *num_params);

static void CutClipboard(Widget w, XEvent *event, char **params,
                         Cardinal *num_params);

static void DeleteNextChar(Widget w, XEvent *event, char **params,
                           Cardinal *num_params);

static void DeleteNextWord(Widget w, XEvent *event, char **params,
                           Cardinal *num_params);

static void DeletePrevChar(Widget w, XEvent *event, char **params,
                           Cardinal *num_params);

static void DeletePrevWord(Widget w, XEvent *event, char **params,
                           Cardinal *num_params);

static void DeleteToEOL(Widget w, XEvent *event, char **params,
                        Cardinal *num_params);

static void DeleteToSOL(Widget w, XEvent *event, char **params,
                        Cardinal *num_params);

static void DeselectAll(Widget w, XEvent *event, char **params,
                        Cardinal *num_params);

static void EndOfFile(Widget w, XEvent *event, char **params,
                      Cardinal *num_params);

static void EndOfLine(Widget w, XEvent *event, char **params,
                      Cardinal *num_params);

static void ForwardChar(Widget w, XEvent *event, char **params,
                        Cardinal *num_params);

static void ForwardPara(Widget w, XEvent *event, char **params,
                        Cardinal *num_params);

static void ForwardWord(Widget w, XEvent *event, char **params,
                        Cardinal *num_params);

static void GoToLine(Widget w, XEvent *event, char **params,
                     Cardinal *num_params);

static void GoToLine_I(Widget w, XEvent *event, char **params,
                       Cardinal *num_params);

static void Help(Widget w, XEvent *event, char **params, Cardinal *num_params);

static void InsertString(Widget w, XEvent *event, char **params,
                         Cardinal *num_params);

static void KeySelect(Widget w, XEvent *event, char **params,
                      Cardinal *num_params);

static void NewlineAndBackup(Widget w, XEvent *event, char **params,
                             Cardinal *num_params);

static void NewlineAndIndent(Widget w, XEvent *event, char **params,
                             Cardinal *num_params);

static void NextPage(Widget w, XEvent *event, char **params,
                     Cardinal *num_params);

static void PageLeft(Widget w, XEvent *event, char **params,
                     Cardinal *num_params);

static void PageRight(Widget w, XEvent *event, char **params,
                      Cardinal *num_params);

static void PasteClipboard(Widget w, XEvent *event, char **params,
                           Cardinal *num_params);

static void PreviousPage(Widget w, XEvent *event, char **params,
                         Cardinal *num_params);

static void ProcessCancel(Widget w, XEvent *event, char **params,
                          Cardinal *num_params);

static void ProcessDown(Widget w, XEvent *event, char **params,
                        Cardinal *num_params);

static void ProcessShiftDown(Widget w, XEvent *event, char **params,
                             Cardinal *num_params);

static void ProcessShiftUp(Widget w, XEvent *event, char **params,
                           Cardinal *num_params);

static void ProcessUp(Widget w, XEvent *event, char **params,
                      Cardinal *num_params);

static void QuoteNextChar(Widget w, XEvent *event, char **params,
                          Cardinal *num_params);

static void QuoteNextChar_I(Widget w, XEvent *event, char **params,
                            Cardinal *num_params);

static void SelectAll(Widget w, XEvent *event, char **params,
                      Cardinal *num_params);

static void ToggleInsertMode(Widget w, XEvent *event, char **params,
                             Cardinal *num_params);

static void ToggleInsertMode_I(Widget w, XEvent *event, char **params,
                               Cardinal *num_params);

static void UndoEdit(Widget w, XEvent *event, char **params,
                     Cardinal *num_params);

static void UndoEdit_I(Widget w, XEvent *event, char **params,
                       Cardinal *num_params);

static void Call_TextSelectCallback(DtEditorWidget editor);

static void Call_TextDeselectCallback(DtEditorWidget editor);

static void Editor_SetSelectionProc(XmTextSource source, XmTextPosition left,
                                    XmTextPosition right, Time set_time);

static void CallHelpCallback(DtEditorWidget editor, int reason);

static void HelpEditWindowCB(Widget w, caddr_t client_data, caddr_t call_data);

static void HelpStatusCurrentLineCB(Widget w, caddr_t client_data,
                                    caddr_t call_data);

static void HelpStatusTotalLinesCB(Widget w, caddr_t client_data,
                                   caddr_t call_data);

static void HelpStatusMessageCB(Widget w, caddr_t client_data,
                                caddr_t call_data);

static void HelpStatusOverstrikeCB(Widget w, caddr_t client_data,
                                   caddr_t call_data);

static void RegisterDropZone(DtEditorWidget w);

static void UnregisterDropZone(DtEditorWidget w);

static void SetInfoDialogTitle(DtEditorWidget editor);

static int FormatText(AdjRecPtr pAdjRec);

static void AdjustParaCB(Widget w, caddr_t client_data, caddr_t call_data);

static void AdjustAllCB(Widget w, caddr_t client_data, caddr_t call_data);

static DtEditorErrorCode DoAdjust(DtEditorWidget editor, int leftMargin,
                                  int rightMargin, unsigned int alignment,
                                  XmTextPosition start, XmTextPosition end);

static void SetFormatDialogTitle(DtEditorWidget editor);

static void ResetFormatDialog(DtEditorWidget editor);

static void CreateFormatDialog(DtEditorWidget editor);

static void GetAdjustSettings(DtEditorWidget pPad,
                              DtEditorFormatSettings *formatSettings);

static void UpdateOverstrikeIndicator(DtEditorWidget widget,
...
static XmSyntheticResource syn_resources[] = {
    ...
    {DtNcolumns, sizeof(short),
     XtOffset(DtEditorWidget, editor.editStuff.columns), _DtEditorGetColumns,
     NULL},
    ...
    {DtNchangeAllButtonLabel, sizeof(XmString),
     XtOffset(DtEditorWidget, editor.searchStuff.changeAllButtonLabel),
    ...
    {DtNformatAllButtonLabel, sizeof(XmString),
     XtOffset(DtEditorWidget, editor.formatStuff.formatAllButtonLabel),
     _DtEditorGetFormatAllButtonLabel, NULL},
    {DtNformatParagraphButtonLabel, sizeof(XmString),
     XtOffset(DtEditorWidget, editor.formatStuff.formatParaButtonLabel),
    ...
    {DtNleftAlignToggleLabel, sizeof(XmString),
     XtOffset(DtEditorWidget, editor.formatStuff.leftAlignToggleLabel),
     _DtEditorGetLeftAlignToggleLabel, NULL},
    {DtNleftMarginFieldLabel, sizeof(XmString),
     XtOffset(DtEditorWidget, editor.formatStuff.leftMarginFieldLabel),
    ...
    {DtNmisspelledListLabel, sizeof(XmString),
     XtOffset(DtEditorWidget, editor.searchStuff.misspelledListLabel),
     _DtEditorGetMisspelledListLabel, NULL},
    {DtNrightAlignToggleLabel, sizeof(XmString),
     XtOffset(DtEditorWidget, editor.formatStuff.rightAlignToggleLabel),
     _DtEditorGetRightAlignToggleLabel, NULL},
    {DtNrightMarginFieldLabel, sizeof(XmString),
     XtOffset(DtEditorWidget, editor.formatStuff.rightMarginFieldLabel),
     _DtEditorGetRightMarginFieldLabel, NULL},
    {DtNrows, sizeof(short), XtOffset(DtEditorWidget, editor.editStuff.rows),
...
static XtResource resources[] = {
    {DtNautoShowCursorPosition, DtCAutoShowCursorPosition, XmRBoolean,
     sizeof(Boolean),
     XtOffset(DtEditorWidget, editor.editStuff.autoShowCursorPos), XmRImmediate,
     (XtPointer)True},
    ...
    {DtNblinkRate, DtCBlinkRate, XmRInt, sizeof(int),
     XtOffset(DtEditorWidget, editor.editStuff.blinkRate), XmRImmediate,
     (XtPointer)500},
    {DtNcenterToggleLabel, DtCCenterToggleLabel, XmRXmString, sizeof(XmString),
     XtOffset(DtEditorWidget, editor.formatStuff.centerToggleLabel),
     XmRImmediate, (XtPointer)DtUNSPECIFIED},
    {DtNchangeAllButtonLabel, DtCChangeAllButtonLabel, XmRXmString,
     sizeof(XmString),
     XtOffset(DtEditorWidget, editor.searchStuff.changeAllButtonLabel),
     XmRImmediate, (XtPointer)DtUNSPECIFIED},
    {DtNchangeButtonLabel, DtCChangeButtonLabel, XmRXmString, sizeof(XmString),
     XtOffset(DtEditorWidget, editor.searchStuff.changeButtonLabel),
     XmRImmediate, (XtPointer)DtUNSPECIFIED},
    {DtNchangeFieldLabel, DtCChangeFieldLabel, XmRXmString, sizeof(XmString),
     XtOffset(DtEditorWidget, editor.searchStuff.changeFieldLabel),
     XmRImmediate, (XtPointer)DtUNSPECIFIED},
    {DtNcolumns, DtCColumns, XmRShort, sizeof(short),
     XtOffset(DtEditorWidget, editor.editStuff.columns), XmRImmediate,
     (XtPointer)DtUNSPECIFIED},
    {DtNcurrentLineLabel, DtCCurrentLineLabel, XmRXmString, sizeof(XmString),
     XtOffset(DtEditorWidget, editor.statusStuff.currentLineLabel),
     XmRImmediate, (XtPointer)DtUNSPECIFIED},
    {DtNcursorPosition, DtCCursorPosition, XmRTextPosition,
     sizeof(XmTextPosition),
     XtOffset(DtEditorWidget, editor.editStuff.cursorPos), XmRImmediate,
     (XtPointer)DtUNSPECIFIED},
    {DtNcursorPositionVisible, DtCCursorPositionVisible, XmRBoolean,
     sizeof(Boolean),
     XtOffset(DtEditorWidget, editor.editStuff.cursorPosVisible), XmRImmediate,
     (XtPointer)True},
    ...
    {DtNeditable, DtCEditable, XmRBoolean, sizeof(Boolean),
     XtOffset(DtEditorWidget, editor.editStuff.editable), XmRImmediate,
     (XtPointer)True},
    {DtNfindButtonLabel, DtCFindButtonLabel, XmRXmString, sizeof(XmString),
     XtOffset(DtEditorWidget, editor.searchStuff.findButtonLabel), XmRImmediate,
     (XtPointer)DtUNSPECIFIED},
    {DtNfindChangeDialogTitle, DtCFindChangeDialogTitle, XmRXmString,
     sizeof(XmString),
     XtOffset(DtEditorWidget, editor.searchStuff.fndChngTitle), XmRString,
     (XtPointer)NULL},
    {DtNfindFieldLabel, DtCFindFieldLabel, XmRXmString, sizeof(XmString),
     XtOffset(DtEditorWidget, editor.searchStuff.findFieldLabel), XmRImmediate,
     (XtPointer)DtUNSPECIFIED},
    {DtNformatAllButtonLabel, DtCFormatAllButtonLabel, XmRXmString,
     sizeof(XmString),
     XtOffset(DtEditorWidget, editor.formatStuff.formatAllButtonLabel),
     XmRImmediate, (XtPointer)DtUNSPECIFIED},
    {DtNformatParagraphButtonLabel, DtCFormatParagraphButtonLabel, XmRXmString,
     sizeof(XmString),
     XtOffset(DtEditorWidget, editor.formatStuff.formatParaButtonLabel),
     XmRImmediate, (XtPointer)DtUNSPECIFIED},
    {DtNformatSettingsDialogTitle, DtCFormatSettingsDialogTitle, XmRXmString,
     sizeof(XmString),
     XtOffset(DtEditorWidget, editor.formatStuff.formatDialogTitle), XmRString,
     (XtPointer)NULL},
    {DtNinformationDialogTitle, DtCInformationDialogTitle, XmRXmString,
     sizeof(XmString),
     XtOffset(DtEditorWidget, editor.warningStuff.infoDialogTitle), XmRString,
     (XtPointer)NULL},
    {DtNinsertLabel, DtCInsertLabel, XmRXmString, sizeof(XmString),
     XtOffset(DtEditorWidget, editor.statusStuff.ins), XmRImmediate,
     (XtPointer)DtUNSPECIFIED},
    {DtNjustifyToggleLabel, DtCJustifyToggleLabel, XmRXmString,
     sizeof(XmString),
     XtOffset(DtEditorWidget, editor.formatStuff.justifyToggleLabel),
     XmRImmediate, (XtPointer)DtUNSPECIFIED},
    {DtNlabelFontList, DtCFontList, XmRFontList, sizeof(XmFontList),
     ...
     XmRFontList, (XtPointer)NULL},
    {DtNleftAlignToggleLabel, DtCLeftAlignToggleLabel, XmRXmString,
     sizeof(XmString),
     XtOffset(DtEditorWidget, editor.formatStuff.leftAlignToggleLabel),
     XmRImmediate, (XtPointer)DtUNSPECIFIED},
    {DtNleftMarginFieldLabel, DtCLeftMarginFieldLabel, XmRXmString,
     sizeof(XmString),
     XtOffset(DtEditorWidget, editor.formatStuff.leftMarginFieldLabel),
     XmRImmediate, (XtPointer)DtUNSPECIFIED},
    {DtNmaxLength, DtCMaxLength, XmRInt, sizeof(int),
     XtOffset(DtEditorWidget, editor.editStuff.maxLength), XmRImmediate,
     (XtPointer)DtUNSPECIFIED},
    {DtNmisspelledListLabel, DtCMisspelledListLabel, XmRXmString,
     sizeof(XmString),
     XtOffset(DtEditorWidget, editor.searchStuff.misspelledListLabel),
     XmRImmediate, (XtPointer)DtUNSPECIFIED},
    {DtNoverstrike, DtCOverstrike, XmRBoolean, sizeof(Boolean),
     XtOffset(DtEditorWidget, editor.editStuff.overstrikeMode), XmRImmediate,
     (XtPointer)False},
    {DtNoverstrikeLabel, DtCOverstrikeLabel, XmRXmString, sizeof(XmString),
     XtOffset(DtEditorWidget, editor.statusStuff.ovr), XmRImmediate,
     (XtPointer)DtUNSPECIFIED},
    {DtNrightAlignToggleLabel, DtCRightAlignToggleLabel, XmRXmString,
     sizeof(XmString),
     XtOffset(DtEditorWidget, editor.formatStuff.rightAlignToggleLabel),
     XmRImmediate, (XtPointer)DtUNSPECIFIED},
    {DtNrightMarginFieldLabel, DtCRightMarginFieldLabel, XmRXmString,
     sizeof(XmString),
     XtOffset(DtEditorWidget, editor.formatStuff.rightMarginFieldLabel),
     XmRImmediate, (XtPointer)DtUNSPECIFIED},
    {DtNrows, DtCRows, XmRShort, sizeof(short),
     XtOffset(DtEditorWidget, editor.editStuff.rows), XmRImmediate,
     (XtPointer)DtUNSPECIFIED},
    {DtNscrollHorizontal, DtCScroll, XmRBoolean, sizeof(Boolean),
     XtOffset(DtEditorWidget, editor.editStuff.scrollHorizontal), XmRImmediate,
     (XtPointer)True},
    {DtNscrollLeftSide, DtCScrollSide, XmRBoolean, sizeof(Boolean),
     XtOffset(DtEditorWidget, editor.editStuff.scrollLeft), XmRImmediate,
     (XtPointer)DtUNSPECIFIED},
    {DtNscrollTopSide, DtCScrollSide, XmRBoolean, sizeof(Boolean),
     XtOffset(DtEditorWidget, editor.editStuff.scrollTop), XmRImmediate,
     (XtPointer)DtUNSPECIFIED},
    {DtNscrollVertical, DtCScroll, XmRBoolean, sizeof(Boolean),
     XtOffset(DtEditorWidget, editor.editStuff.scrollVertical), XmRImmediate,
     (XtPointer)True},
    {DtNshowStatusLine, DtCShowStatusLine, XmRBoolean, sizeof(Boolean),
     XtOffset(DtEditorWidget, editor.statusStuff.showStatusLine), XmRImmediate,
     (XtPointer)False},
    {DtNspellDialogTitle, DtCSpellDialogTitle, XmRXmString, sizeof(XmString),
     XtOffset(DtEditorWidget, editor.searchStuff.spellTitle), XmRString,
     (XtPointer)NULL},
    {DtNspellFilter, DtCSpellFilter, XmRString, sizeof(XmRString),
     XtOffset(DtEditorWidget, editor.searchStuff.spellFilter), XmRString,
     "spell"},
    {DtNtextBackground, DtCBackground, XmRPixel, sizeof(Pixel),
     XtOffset(DtEditorWidget, editor.editStuff.background), XmRImmediate,
     (XtPointer)DtUNSPECIFIED},
    {DtNtextDeselectCallback, DtCCallback, XtRCallback, sizeof(XtCallbackList),
     XtOffset(DtEditorWidget, editor.textDeselect), XtRCallback,
     (XtPointer)NULL},
    {DtNtextForeground, DtCForeground, XmRPixel, sizeof(Pixel),
     XtOffset(DtEditorWidget, editor.editStuff.foreground), XmRImmediate,
     (XtPointer)DtUNSPECIFIED},
    {DtNtextFontList, DtCFontList, XmRFontList, sizeof(XmFontList),
     ...
     XmRFontList, (XtPointer)NULL},
    {DtNtextSelectCallback, DtCCallback, XtRCallback, sizeof(XtCallbackList),
     XtOffset(DtEditorWidget, editor.textSelect), XtRCallback, (XtPointer)NULL},
    {DtNtextTranslations, DtCTranslations, XmRTranslationTable,
     sizeof(XtTranslations),
     XtOffsetOf(struct _XmBulletinBoardRec, bulletin_board.text_translations),
     XmRImmediate, (XtPointer)NULL},
    {DtNtopCharacter, DtCTopCharacter, XmRTextPosition, sizeof(XmTextPosition),
     XtOffset(DtEditorWidget, editor.editStuff.topCharacter), XmRImmediate,
     (XtPointer)DtUNSPECIFIED},
    {DtNtotalLineCountLabel, DtCTotalLineCountLabel, XmRXmString,
     sizeof(XmString),
     XtOffset(DtEditorWidget, editor.statusStuff.totalLineLabel), XmRImmediate,
     (XtPointer)DtUNSPECIFIED},
    {DtNwordWrap, DtCWordWrap, XmRBoolean, sizeof(Boolean),
     XtOffset(DtEditorWidget, editor.editStuff.wordWrap), XmRImmediate,
     (XtPointer)False},
};
...
externaldef(dteditorclassrec) DtEditorClassRec dtEditorClassRec = {
    /*	Core Part
     */
    {
...
*/
static void Initialize(Widget rw, Widget nw, ArgList arg_list,
                       Cardinal *num_args) {

  DtEditorWidget request = (DtEditorWidget)rw, new = (DtEditorWidget)nw;
...
static void ValidateResources(DtEditorWidget new, DtEditorWidget request) {
  ...
  if (M_status_insertLabel(request) != (XmString)DtUNSPECIFIED)
    M_status_insertLabel(new) = XmStringCopy(M_status_insertLabel(request));
  else
...
static Widget CreateText(DtEditorWidget parent) {
  ...
  ac++;
  XtSetArg(al[ac], XmNpendingDelete, True);
  ac++;
  ...
  XtSetArg(al[ac], XmNblinkRate, M_blinkRate(parent));
  ac++;

  if (M_columns(parent) != DtUNSPECIFIED) {
    XtSetArg(al[ac], XmNcolumns, M_columns(parent));
    ac++;
    M_columns(parent) = (short)DtUNSPECIFIED;
  }

  if (M_cursorPos(parent) != DtUNSPECIFIED) {
    XtSetArg(al[ac], XmNcursorPosition, M_cursorPos(parent));
    ac++;
  ...
  XtSetArg(al[ac], XmNeditable, M_editable(parent));
  ac++;

  if (E_textFontList(parent) != (XmFontList)NULL) {
    XtSetArg(al[ac], XmNfontList, E_textFontList(parent));
    ac++;
  }

  if (M_maxLength(parent) != DtUNSPECIFIED) {
    XtSetArg(al[ac], XmNmaxLength, M_maxLength(parent));
    ac++;
    M_maxLength(parent) = (int)DtUNSPECIFIED;
  }

  if (M_rows(parent) != DtUNSPECIFIED) {
    XtSetArg(al[ac], XmNrows, M_rows(parent));
    ac++;
    M_rows(parent) = (short)DtUNSPECIFIED;
  }

  XtSetArg(al[ac], XmNscrollHorizontal, M_scrollHorizontal(parent));
  ac++;

  if (M_scrollLeftSide(parent) != (Boolean)DtUNSPECIFIED) {
    XtSetArg(al[ac], XmNscrollLeftSide, M_scrollLeftSide(parent));
    ac++;
    M_scrollLeftSide(parent) = (Boolean)DtUNSPECIFIED;
  }

  if (M_scrollTopSide(parent) != (Boolean)DtUNSPECIFIED) {
    XtSetArg(al[ac], XmNscrollTopSide, M_scrollTopSide(parent));
    ac++;
    M_scrollTopSide(parent) = (Boolean)DtUNSPECIFIED;
  }

  XtSetArg(al[ac], XmNscrollVertical, M_scrollVertical(parent));
  ac++;

  if (M_topCharacter(parent) != DtUNSPECIFIED) {
    XtSetArg(al[ac], XmNtopCharacter, M_topCharacter(parent));
    ac++;
    M_topCharacter(parent) = (XmTextPosition)DtUNSPECIFIED;
  }

  XtSetArg(al[ac], XmNwordWrap, M_wordWrap(parent));
  ac++;
  ...
  if (M_textBackground(parent) != DtUNSPECIFIED) {
    XtSetArg(al[ac], XmNbackground, M_textBackground(parent));
    ac++;
    M_textBackground(parent) = (Pixel)DtUNSPECIFIED;
  }

  if (M_textForeground(parent) != DtUNSPECIFIED) {
    XtSetArg(al[ac], XmNforeground, M_textForeground(parent));
    ac++;
  ...
  XtOverrideTranslations(text, XtParseTranslationTable(EditorTranslationTable));
  ...
  XtAddCallback(text, XmNmodifyVerifyCallback,
                (XtCallbackProc)_DtEditorModifyVerifyCB, (XtPointer)parent);
  ...
  if (((XmTextWidget)(text))->text.source->SetSelection !=
    ...
    M_setSelection(parent) = ((XmTextWidget)(text))->text.source->SetSelection;
    ((XmTextWidget)(text))->text.source->SetSelection = Editor_SetSelectionProc;
  }
...
static Boolean SetValues(Widget cw, Widget rw, Widget nw) {
  ...
  Boolean resetSpellTitle = False, resetFormatTitle = False,
          resetInfoTitle = False, newButtonFontList = False,
          newLabelFontList = False, newTextFontList = False,
  ...
  if (XmStringCompare(E_dialogTitle(request), E_dialogTitle(current)) ==
      False) {
  ...
  if (XmStringCompare(M_fndChngTitle(request), M_fndChngTitle(current)) ==
      False) {
  ...
  if (XmStringCompare(E_infoDialogTitle(request), E_infoDialogTitle(current)) ==
      False) {
  ...
  if (M_status_statusArea(current) != (Widget)NULL) {
    ...
    if (newTextFontList == True) {
      XtSetArg(al[ac], XmNfontList, E_textFontList(request));
      ac++;
    }

    if (M_textBackground(request) != DtUNSPECIFIED) {
      XtSetArg(al[ac], XmNbackground, M_textBackground(request));
      ac++;
    }

    if (M_textForeground(request) != DtUNSPECIFIED) {
      XtSetArg(al[ac], XmNforeground, M_textForeground(request));
      ac++;
    }
  ...
  if (M_gen_warning(current) != (Widget)NULL) {
    ...
    if (newButtonFontList == True) {
      ...
      XtSetValues(
          XmMessageBoxGetChild(M_gen_warning(current), XmDIALOG_OK_BUTTON), al,
          1);
    }
  ...
  if (M_blinkRate(request) != M_blinkRate(current)) {
    XtSetArg(al[ac], XmNblinkRate, M_blinkRate(request));
    ac++;
  }

  if (M_columns(request) != DtUNSPECIFIED) {
    XtSetArg(al[ac], XmNcolumns, M_columns(request));
    ac++;
  ...
  if (M_editable(request) != M_editable(current)) {
    XtSetArg(al[ac], XmNeditable, M_editable(request));
    ac++;
  ...
  if (M_maxLength(request) != DtUNSPECIFIED) {
    XtSetArg(al[ac], XmNmaxLength, M_maxLength(request));
    ac++;
    M_maxLength(new) = (int)DtUNSPECIFIED;
  }

  if (M_rows(request) != DtUNSPECIFIED) {
    XtSetArg(al[ac], XmNrows, M_rows(request));
    ac++;
  ...
  if (M_wordWrap(request) != M_wordWrap(current)) {
    XtSetArg(al[ac], XmNwordWrap, M_wordWrap(request));
    ac++;
    NeedToFixWordWrap =
        M_scrollHorizontal(current); /*XXX Word Wrap workaround*/
  }
...
static void BackwardChar(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "backward-character", event, params,
                   *num_params);
}
...
static void BackwardPara(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "backward-paragraph", event, params,
                   *num_params);
}
...
static void BackwardWord(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "backward-word", event, params, *num_params);
}
...
static void BeginningOfFile(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "beginning-of-file", event, params,
                   *num_params);
}
...
static void BeginningOfLine(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "beginning-of-line", event, params,
                   *num_params);
}
...
static void ClearSelection(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "clear-selection", event, params,
                   *num_params);
...
static void CopyClipboard(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "copy-clipboard", event, params,
                   *num_params);
}
...
static void CutClipboard(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "cut-clipboard", event, params, *num_params);
}
...
static void DeleteNextChar(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "delete-next-character", event, params,
                   *num_params);
}
...
static void DeleteNextWord(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "delete-next-word", event, params,
                   *num_params);
}
...
static void DeletePrevChar(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "delete-previous-character", event, params,
                   *num_params);
}
...
static void DeletePrevWord(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "delete-previous-word", event, params,
                   *num_params);
}
...
static void DeleteToEOL(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "delete-to-end-of-line", event, params,
                   *num_params);
}
...
static void DeleteToSOL(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "delete-to-start-of-line", event, params,
                   *num_params);
}
...
static void DeselectAll(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "deselect-all", event, params, *num_params);
}
...
static void EndOfFile(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "end-of-file", event, params, *num_params);
}
...
static void EndOfLine(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "end-of-line", event, params, *num_params);
}
...
static void ForwardChar(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "forward-character", event, params,
                   *num_params);
}
...
static void ForwardPara(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "forward-paragraph", event, params,
                   *num_params);
}
...
static void ForwardWord(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "forward-word", event, params, *num_params);
}
...
static void GoToLine(Widget w, XEvent *event, char **params,
  ...
  if (M_status_statusArea(editor) != (Widget)NULL &&
    ...
    XtCallActionProc((Widget)M_status_lineText(editor), "select-all", event,
                     (String *)NULL, 0);
  }
...
static void InsertString(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "insert-string", event, params, *num_params);
}
...
static void KeySelect(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "key-select", event, params, *num_params);
}
...
static void NewlineAndBackup(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "newline-and-backup", event, params,
                   *num_params);
}
...
static void NewlineAndIndent(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "newline-and-indent", event, params,
                   *num_params);
}
...
static void NextPage(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "next-page", event, params, *num_params);
}
...
static void PageLeft(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "page-left", event, params, *num_params);
}
...
static void PageRight(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "page-right", event, params, *num_params);
}
...
static void PasteClipboard(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "paste-clipboard", event, params,
                   *num_params);
}
...
static void PreviousPage(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "previous-page", event, params, *num_params);
}
...
static void ProcessCancel(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "process-cancel", event, params,
                   *num_params);
}
...
static void ProcessDown(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "process-down", event, params, *num_params);
}
...
static void ProcessShiftDown(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "process-shift-down", event, params,
                   *num_params);
}
...
static void ProcessShiftUp(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "process-shift-up", event, params,
                   *num_params);
}
...
static void ProcessUp(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "process-up", event, params, *num_params);
}
 ...
 ************************************************************************/
/* ARGSUSED */
static unsigned int GetModeSwitchModifier(Display *dpy) {
 ...
 ************************************************************************/
/* ARGSUSED */
static void QuoteNextChar(Widget widget, XEvent *event, char **params,
                          Cardinal *num_params) {
  DtEditorWidget editor = (DtEditorWidget)widget;
...
static void SelectAll(Widget w, XEvent *event, char **params,
  ...
  XtCallActionProc(M_text(editor), "select-all", event, params, *num_params);
}
...
static void Editor_SetSelectionProc(XmTextSource source, XmTextPosition left,
   ...
   * Sanity check
   */
  if (!XtIsRealized((Widget)data->widgets[0]) || data->numwidgets <= 0)
    return;
...
static void AnimateCallback(Widget w, XtPointer client_data,
                            XtPointer call_data) {
  int numItems, ii;
...
/* ARGSUSED */
static void TransferCallback(Widget w, XtPointer client_data,
                             XtPointer call_data) {
  int numItems, ii;
  DtEditorErrorCode error;
  ...
  case DtDND_FILENAME_TRANSFER: {
    ...
    for (ii = 0; ii < numItems; ii++) {
      error = _DtEditorValidateFileAccess(
          transferInfo->dropData->data.files[ii], READ_ACCESS);
...
static void RegisterDropZone(DtEditorWidget w) {
   ...
   */
  ac = 0;
  XtSetArg(al[ac], DtNdropAnimateCallback, animateCB);
  ac++;

  DtDndDropRegister(M_text(w), DtDND_FILENAME_TRANSFER | DtDND_BUFFER_TRANSFER,
...
static void SetInfoDialogTitle(DtEditorWidget editor) {
  ...
  if (M_gen_warning(editor) != (Widget)NULL) {
    ...
    if (E_dialogTitle(editor) != (XmString)NULL) {
       ...
       */
      titleStr =
          XmStringConcat(E_dialogTitle(editor), E_infoDialogTitle(editor));
...
void _DtEditorWarning(DtEditorWidget editor, char *mess,
  ...
  if (M_gen_warning(editor) == (Widget)NULL) {
    ...
    if (E_dialogTitle(editor) != (XmString)NULL) {
      ...
      XtSetArg(al[ac], XmNdialogTitle, titleStr);
      ac++;

    } else {
      XtSetArg(al[ac], XmNdialogTitle, E_infoDialogTitle(editor));
      ac++;
    }

    okStr = XmStringCreateLocalized((char *)_DtOkString);
    XtSetArg(al[ac], XmNokLabelString, okStr);
    ac++;
    M_gen_warning(editor) =
        (Widget)XmCreateMessageDialog(M_topLevelShell(editor), "Warn", al, ac);
    ...
    XtSetValues(XmMessageBoxGetChild(M_gen_warning(editor), XmDIALOG_OK_BUTTON),
                al, 1);

    XtSetArg(al[0], XmNfontList, E_labelFontList(editor));
    XtSetValues(
        XmMessageBoxGetChild(M_gen_warning(editor), XmDIALOG_MESSAGE_LABEL), al,
        1);

    /* Unmanage unneeded children. */
    XtUnmanageChild(
        XmMessageBoxGetChild(M_gen_warning(editor), XmDIALOG_CANCEL_BUTTON));
    XtUnmanageChild(
        XmMessageBoxGetChild(M_gen_warning(editor), XmDIALOG_HELP_BUTTON));

    XtRealizeWidget(M_gen_warning(editor));
    ac = 0;
    XtSetArg(al[ac], XmNmwmInputMode, MWM_INPUT_PRIMARY_APPLICATION_MODAL);
    ac++;
  ...
  ac = 0;
  XtSetArg(al[ac], XmNdialogType, dialogType);
  ac++;
  XtSetArg(al[ac], XmNmessageString, tmpStr);
  ac++;
...
/* ARGSUSED */
static void PositionActivateCB(Widget w, caddr_t client_data,
                               caddr_t call_data) {
  DtEditorWidget editor = (DtEditorWidget)client_data;
 ...
 */
void _DtEditorUpdateLineDisplay(DtEditorWidget editor, int currentLine,
                                Boolean forceUpdate) {
...
static void UpdateOverstrikeIndicator(DtEditorWidget widget,
  ...
  if (M_status_showStatusLine(ew) == True &&
    ...
    if (overstrikeOn == True) {
      XtSetArg(al[ac], XmNlabelString, M_status_overstrikeLabel(ew));
      ac++;
    } else {
      XtSetArg(al[ac], XmNlabelString, M_status_insertLabel(ew));
      ac++;
    }
...
int _DtEditorGetLineIndex(XmTextWidget tw, XmTextPosition pos) {
 ...
 */
static void SetCursorPosStatus(Widget w, caddr_t client_data,
                               caddr_t call_data) {
  DtEditorWidget editor = (DtEditorWidget)client_data;
  XmTextWidget tw = (XmTextWidget)w;
...
static void SetStatusLine(DtEditorWidget ew, Boolean statusLineOn) {
  ...
  if (statusLineOn == True) {
    ...
    currentLine =
        _DtEditorGetLineIndex((XmTextWidget)M_text(ew), cursorPos) + 1;
    ...
    ac++;
    XtSetArg(al[ac], XmNbottomWidget, M_status_statusArea(ew));
    ac++;
...
static Widget CreateStatusLine(DtEditorWidget parent) {
  ...
  XtSetArg(al[ac], XmNrightAttachment, XmATTACH_FORM);
  ac++;
  XtSetArg(al[ac], XmNverticalSpacing, 3);
  ac++;
  XtSetArg(al[ac], XmNhorizontalSpacing, 3);
  ac++;
  container = (Widget)XmCreateForm((Widget)parent, "statusLine", al, ac);
  ...
  XtSetArg(al[ac], XmNlabelString, tmpStr);
  ac++;
  XtSetArg(al[ac], XmNfontList, E_labelFontList(parent));
  ac++;
  M_status_lineLabel(parent) =
      (Widget)XmCreateLabelGadget(container, "lineLabel", al, ac);
  ...
  ac++;
  XtSetArg(al[ac], XmNleftWidget, M_status_lineLabel(parent));
  ac++;
  M_status_lineText(parent) = XmCreateTextField(container, "lineText", al, ac);
  ...
  XtSetArg(al[ac], XmNleftAttachment, XmATTACH_WIDGET);
  ac++;
  XtSetArg(al[ac], XmNleftWidget, M_status_lineText(parent));
  ac++;
  M_status_totalLabel(parent) =
      (Widget)XmCreateLabelGadget(container, "totalLabel", al, ac);
  ...
  XtSetArg(al[ac], XmNleftAttachment, XmATTACH_WIDGET);
  ac++;
  XtSetArg(al[ac], XmNleftWidget, M_status_totalLabel(parent));
  ac++;
  M_status_totalText(parent) =
      (Widget)XmCreateLabelGadget(container, "totalText", al, ac);
  ...
  */
  XtSetArg(al[ac], XmNmarginLeft, 0);
  ac++;
  XtSetArg(al[ac], XmNmarginRight, 0);
  ac++;
  XtSetArg(al[ac], XmNmarginWidth, 0);
  ac++;
  XtSetArg(al[ac], XmNrightOffset, 3);
  ac++;
  XtSetArg(al[ac], XmNfontList, E_labelFontList(parent));
  ac++;
  XtSetArg(al[ac], XmNbottomAttachment, XmATTACH_FORM);
   ...
   */
  ac = 0;
  XtSetArg(al[ac], XmNbackground, parent->core.background_pixel);
  ac++;
  XtSetArg(al[ac], XmNforeground, foreground);
  ac++;
  XtSetArg(al[ac], XmNfontList, E_textFontList(parent));
  ...
  XtSetArg(al[ac], XmNleftAttachment, XmATTACH_WIDGET);
  ac++;
  XtSetArg(al[ac], XmNleftWidget, M_status_totalText(parent));
  ac++;
  XtSetArg(al[ac], XmNleftOffset, 17);
  ac++;
  XtSetArg(al[ac], XmNrightAttachment, XmATTACH_WIDGET);
  ac++;
  XtSetArg(al[ac], XmNrightWidget, M_status_overstrikeWidget(parent));
  ac++;
...
static void CallHelpCallback(DtEditorWidget editor, int reason) {
  ...
  XtCallCallbackList((Widget)editor, M_HelpCB(editor), (XtPointer)&help_cb);
...
/* ARGSUSED */
static void HelpStatusLineCB(Widget w, caddr_t client_data, caddr_t call_data) {
...
static void HelpStatusMessageCB(Widget w, caddr_t client_data,
                                caddr_t call_data) {
  CallHelpCallback((DtEditorWidget)client_data, DtEDITOR_HELP_STATUS_MESSAGE);
}
...
/* ARGSUSED */
static void HelpFormatDialogCB(Widget w, caddr_t client_data,
                               caddr_t call_data) {
  CallHelpCallback((DtEditorWidget)client_data, DtEDITOR_HELP_FORMAT_DIALOG);
}

/* ARGSUSED */
static void HelpFormatRightMarginCB(Widget w, caddr_t client_data,
                                    caddr_t call_data) {
  CallHelpCallback((DtEditorWidget)client_data,
...
/* ARGSUSED */
static void HelpFormatLeftMarginCB(Widget w, caddr_t client_data,
                                   caddr_t call_data) {
  CallHelpCallback((DtEditorWidget)client_data,
...
/* ARGSUSED */
static void HelpFormatJustifyButtonsCB(Widget w, caddr_t client_data,
                                       caddr_t call_data) {
  CallHelpCallback((DtEditorWidget)client_data, DtEDITOR_HELP_FORMAT_ALIGNMENT);
}
...
/* ARGSUSED */
void _DtEditorHelpSearchCB(Widget w, caddr_t client_data, caddr_t call_data) {
  DtEditorWidget editor = (DtEditorWidget)client_data;

  switch (M_search_dialogMode(editor)) {
  case SPELL:
    CallHelpCallback((DtEditorWidget)client_data, DtEDITOR_HELP_SPELL_DIALOG);
    break;
  case REPLACE:
  default:
    CallHelpCallback((DtEditorWidget)client_data, DtEDITOR_HELP_CHANGE_DIALOG);
    break;
  }
} /* _DtEditorHelpSearchCB */

/* ARGSUSED */
void _DtEditorHelpSearchFindCB(Widget w, caddr_t client_data,
                               caddr_t call_data) {
  CallHelpCallback((DtEditorWidget)client_data, DtEDITOR_HELP_CHANGE_FIND);
}
/* ARGSUSED */
void _DtEditorHelpSearchChangeCB(Widget w, caddr_t client_data,
                                 caddr_t call_data) {
  DtEditorWidget editor = (DtEditorWidget)client_data;

  switch (M_search_dialogMode(editor)) {
  case SPELL:
    CallHelpCallback((DtEditorWidget)client_data, DtEDITOR_HELP_SPELL_CHANGE);
    break;
  case REPLACE:
  default:
    CallHelpCallback((DtEditorWidget)client_data, DtEDITOR_HELP_CHANGE_CHANGE);
    break;
  }
} /* _DtEditorHelpSearchChangeCB */

/* ARGSUSED */
void _DtEditorHelpSearchSpellCB(Widget w, caddr_t client_data,
                                caddr_t call_data) {
  CallHelpCallback((DtEditorWidget)client_data,
...
#define WORDNEXT(d, at)                                                        \
  {                                                                            \
    if (++at == d->wordlimit)                                                  \
      at = d->wordbase;                                                        \
  } /* statement */
#define WORDPREV(d, at)                                                        \
  (((at == d->wordbase) ? d->wordlimit : at) - 1) /* function  */
...
static void Center(FormatData *data, wint_t *in_line, wint_t *inlinelim);
 ...
 */
static int sun_wcwidth(const wchar_t wc) {
  int status;
...
static Boolean lineBlank(char *pLine, int lineLen) {
  int byteNum, charNum;
  wchar_t wc;
...
static char *findNonBlank(char *pLine, int lineLen) {
  int byteNum, charNum;
  wchar_t wc;
  size_t mbCurMax = MB_CUR_MAX;
...
static int countBlanks(char *pLine, int lineLen) {
 ...
 */
static void fixLeftMarginAndNewlines(DtEditorWidget editor, FILE *fp,
                                     int leftMargin, int rightMargin,
                                     int startPos, int endPos) {
  Widget widget = M_text(editor);
  XmTextLineTable lineTable;
  int i;
  int lineIndex, lineLen, nextLen, lineIndent, lastIndex, lineByteLen,
      total_lines;
  ...
  for (; lineIndex < lastIndex; lineIndex++) {
    ...
    lineLen =
        lineTable[lineIndex + 1].start_pos - lineTable[lineIndex].start_pos;
    ...
    if (lineBlank(pLine, lineLen)) {
       ...
       */
      fwrite(pLine, sizeof(char), _DtEditorGetPointer(pLine, lineLen) - pLine,
             fp);
      newPara = True;
      XtFree(pLine);
      continue;
    ...
    if (newPara == True) {
      ...
      if ((total_lines - lineIndex) > 2)
        ...
        nextLen =
            XmTextGetLastPosition(widget) - lineTable[lineIndex + 1].start_pos;
      pNext = _XmStringSourceGetString(
          (XmTextWidget)M_text(editor), lineTable[lineIndex + 1].start_pos,
      ...
      fwrite(pFirstNonBlank, sizeof(char),
             lineByteLen - (pFirstNonBlank - pLine), fp);
    ...
    for (i = lineIndent; i-- > 0;)
      fwrite(" ", sizeof(char), 1, fp); /* that's a _space_ */
    pFirstNonBlank = findNonBlank(pLine, lineLen);
    fwrite(pFirstNonBlank, sizeof(char), lineByteLen - (pFirstNonBlank - pLine),
           fp);
    XtFree(pLine);
  }
  ...
  if ((total_lines - lineIndex) == 1) {
    ...
    if ((total_lines - lineIndex) > 2)
      ...
      lineLen = XmTextGetLastPosition(widget) - lineTable[lineIndex].start_pos;

    if (lineLen > 0) {
      for (i = lineIndent; i-- > 0;)
        fwrite(" ", sizeof(char), 1, fp); /* that's a _space_ */

      pLine = _XmStringSourceGetString(
          (XmTextWidget)M_text(editor), lineTable[lineIndex].start_pos,
...
static int DoLine(FormatData *data, FILE *filep) /* open file to read	*/
{
  ...
  if (data->pAdj->cflag)
    Center(data, in_line, incplim);
  else
    Fill(data, in_line, incplim);
                   ...
                   wint_t *inlinelim) /* end of line + 1	*/
{
  ...
  for (incp = in_line; (incp < inlinelim) && (outcp < outlinelim); incp++) {
    ...
    if (iswspace(ch)) {
      needsp =
          ((ch != L'\t') && (iswblank(ch)))
              ? 1
              : data->tabsize - ((indent + outcp - outline) % data->tabsize);
   ...
   */
    ...
    /* 2 */ PrintIndent(data,
                        data->centermiddle - ((textwidth + extwidth + 1) / 2));
    {
      int i;
...
static void Fill(FormatData *data,
                 wint_t *in_line,   /* start of input line	*/
                 wint_t *inlinelim) /* end of line + 1	*/
{
  ...
  for (incp = in_line; incp < inlinelim; incp++) {
    ...
    if (iswspace(ch)) {
      ...
      data->incolumn +=
          ((ch != L'\t') && (iswblank(ch)))
              ? 1
              : data->tabsize - ((data->incolumn - 1) % data->tabsize);
    }
  ...
  } else                            /* have text on line */
  {
    if (inword) /* line ends in word */
      FillWord(data);
    if (data->pendchars > data->fillmargin) { /* time to dump line	*/
...
static void Dump(FormatData *data, int endpara) /* end of paragraph? */
{
...
static void PrintIndent(FormatData *data, int indent) /* leading indentation */
{
...
static void PrintTag(FormatData *data, WORD *wordpast) /* past last to print */
{
  WORD *wordat = data->wordfirst; /* local value	  */
...
static void PrintWords(FormatData *data,
...
static void Justify(FormatData *data, int blanks, /* blanks to insert   */
                    WORD *wordpast)               /* past last to print */
{
...
static int CompareWords(const void *p1, const void *p2) {
  ...
  if (blanks1 == blanks2) /* commonest case */
  {
    ...
    if (score1 > score2)
      return (-1); /* word1 has priority */
    else if (score1 < score2)
      return (1);
    else
      return (0);
  } else if (blanks1 < blanks2)
    return (-1); /* word1 has priority */
  else
    return (1);
...
static void postEkinBekinProc(FormatData *data, int *poutchars,
                              WORD *wordpast) {
  WORD *curword;
...
static prnword(pword) WORD *pword;
{
  int i = 0;
...
static DtEditorErrorCode DoAdjust(DtEditorWidget editor, int leftMargin,
   ...
   */
  if (leftMargin >= 0 && rightMargin > 0 && rightMargin < 1025 &&
    ...
    */
    ...
    if ((adjRec.infp = fopen(tempName1, "w")) != (FILE *)NULL) {
      ...
      if ((adjRec.outfp = fopen(tempName2, "w")) != (FILE *)NULL) {
        ...
        fixLeftMarginAndNewlines(editor, adjRec.infp, leftMargin, rightMargin,
                                 (int)start, (int)end);
...
/* ARGSUSED */
static void AdjustCloseCB(Widget w, caddr_t client_data, caddr_t call_data) {
  DtEditorWidget editor = (DtEditorWidget)client_data;
  XtUnmanageChild(M_format_dialog(editor));
}

/* ARGSUSED */
static int ComputeRightMargin(DtEditorWidget editor) {
  Dimension text_width, highlight_thickness, shadow_thickness, margin_width;
  int rightMargin;
  Arg al[5]; /* arg list */
  int ac;    /* arg count */

  ac = 0;
  XtSetArg(al[ac], XmNwidth, &text_width);
  ac++;
  XtSetArg(al[ac], XmNhighlightThickness, &highlight_thickness);
  ac++;
  XtSetArg(al[ac], XmNshadowThickness, &shadow_thickness);
  ac++;
  XtSetArg(al[ac], XmNmarginWidth, &margin_width);
  ac++;
  XtGetValues(M_text(editor), al, ac);

  if (M_fontWidth(editor) != 0)
    rightMargin =
        ((int)text_width - (2 * ((int)highlight_thickness +
...
/* ARGSUSED */
static void UpdateAdjust(Widget widget, XtPointer *client_data,
...
static void SetFormatDialogTitle(DtEditorWidget editor) {
  ...
  if (M_format_dialog(editor) != (Widget)NULL) {
    ...
    if (E_dialogTitle(editor) != (XmString)NULL) {
       ...
       */
      titleStr =
          XmStringConcat(E_dialogTitle(editor), E_format_dialogTitle(editor));
...
static void CreateFormatDialog(DtEditorWidget editor) {
   ...
   */
  ac = 0;
  XtSetArg(al[ac], XmNforeground, &textForeground);
  ac++;
  XtSetArg(al[ac], XmNbackground, &textBackground);
  ac++;
  XtGetValues(M_text(editor), al, ac);
  ...
  if (E_dialogTitle(editor) != (XmString)NULL) {
    ...
    tempString =
        XmStringConcat(E_dialogTitle(editor), E_format_dialogTitle(editor));
    XtSetArg(al[ac], XmNdialogTitle, tempString);
    ac++;

  } else {
    XtSetArg(al[ac], XmNdialogTitle, E_format_dialogTitle(editor));
    ac++;
  }

  XtSetArg(al[ac], XmNautoUnmanage, False);
  ac++;
  XtSetArg(al[ac], XmNmarginWidth, 5);
  ac++;
  XtSetArg(al[ac], XmNmarginHeight, 5);
  ac++;
  XtSetArg(al[ac], XmNshadowThickness, 1);
  ac++;
  XtSetArg(al[ac], XmNshadowType, XmSHADOW_OUT);
  ac++;
  XtSetArg(al[ac], XmNnavigationType, XmTAB_GROUP);
  ac++;
  M_format_dialog(editor) =
      XmCreateFormDialog(M_topLevelShell(editor), "ad_dial", al, ac);
  ...
  XtSetArg(al[ac], XmNlabelString, tempString);
  ac++;
  XtSetArg(al[ac], XmNleftAttachment, XmATTACH_POSITION);
  ac++;
  XtSetArg(al[ac], XmNleftPosition, 2);
  ac++;
  XtSetArg(al[ac], XmNtopAttachment, XmATTACH_FORM);
  ac++;
  XtSetArg(al[ac], XmNtopOffset, 10);
  ac++;
  XtSetArg(al[ac], XmNfontList, E_labelFontList(editor));
  ac++;
  ...
  XtSetArg(al[ac], XmNleftAttachment, XmATTACH_WIDGET);
  ac++;
  XtSetArg(al[ac], XmNleftWidget, M_format_leftLabel(editor));
  ac++;
  XtSetArg(al[ac], XmNleftOffset, 3);
  ac++;
  XtSetArg(al[ac], XmNrightAttachment, XmATTACH_POSITION);
  ac++;
  XtSetArg(al[ac], XmNrightPosition, 45);
  ac++;
  XtSetArg(al[ac], XmNtopAttachment, XmATTACH_FORM);
  ac++;
  ...
  ac++;
  XtSetArg(al[ac], XmNcolumns, 3);
  ac++;
  XtSetArg(al[ac], XmNfontList, E_textFontList(editor));
  ac++;
  M_format_leftMarginField(editor) =
      (Widget)XmCreateTextField(M_format_dialog(editor), "left_text", al, ac);
  ...
  XtSetArg(al[ac], XmNleftAttachment, XmATTACH_POSITION);
  ac++;
  XtSetArg(al[ac], XmNleftPosition, 55);
  ac++;
  XtSetArg(al[ac], XmNtopAttachment, XmATTACH_FORM);
  ac++;
  XtSetArg(al[ac], XmNtopOffset, 10);
  ...
  XtAddCallback(M_format_rightLabel(editor), XmNhelpCallback,
                (XtCallbackProc)HelpFormatRightMarginCB, (XtPointer)editor);
  ac = 0;
  XtSetArg(al[ac], XmNbackground, textBackground);
  ac++;
  XtSetArg(al[ac], XmNforeground, textForeground);
  ...
  XtSetArg(al[ac], XmNrightAttachment, XmATTACH_POSITION);
  ac++;
  XtSetArg(al[ac], XmNrightPosition, 98);
  ac++;
  XtSetArg(al[ac], XmNleftAttachment, XmATTACH_WIDGET);
  ac++;
  XtSetArg(al[ac], XmNleftWidget, M_format_rightLabel(editor));
  ac++;
  XtSetArg(al[ac], XmNleftOffset, 3);
  ac++;
  XtSetArg(al[ac], XmNtopAttachment, XmATTACH_FORM);
  ...
  XtSetArg(al[ac], XmNfontList, E_textFontList(editor));
  ac++;
  M_format_rightMarginField(editor) =
      (Widget)XmCreateTextField(M_format_dialog(editor), "right_text", al, ac);
  ...
  ac++;
  XtSetArg(al[ac], XmNtopWidget, M_format_leftMarginField(editor));
  ac++;
  XtSetArg(al[ac], XmNtopOffset, 5);
  ac++;
  XtSetArg(al[ac], XmNrightAttachment, XmATTACH_FORM);
  ...
  XtSetArg(al[ac], XmNtraversalOn, True);
  ac++;
  M_format_radioBox(editor) =
      (Widget)XmCreateRadioBox(M_format_dialog(editor), "radioBox", al, ac);
  XtAddCallback(M_format_radioBox(editor), XmNhelpCallback,
                (XtCallbackProc)HelpFormatJustifyButtonsCB, (XtPointer)editor);
  ...
  XtSetArg(al[ac], XmNlabelString, tempString);
  ac++;
  XtSetArg(al[ac], XmNfontList, E_buttonFontList(editor));
  ac++;
  ...
  XtSetArg(al[ac], XmNtopAttachment, XmATTACH_WIDGET);
  ac++;
  XtSetArg(al[ac], XmNtopWidget, M_format_radioBox(editor));
  ac++;
  XtSetArg(al[ac], XmNtopOffset, 15);
  ac++;
  ...
  XtSetArg(al[ac], XmNrightAttachment, XmATTACH_POSITION);
  ac++;
  XtSetArg(al[ac], XmNrightPosition, 25);
  ac++;
  XtSetArg(al[ac], XmNtopAttachment, XmATTACH_WIDGET);
  ac++;
  XtSetArg(al[ac], XmNtopWidget, M_format_separator(editor));
  ac++;
  XtSetArg(al[ac], XmNtopOffset, 5);
  ac++;
  XtSetArg(al[ac], XmNbottomAttachment, XmATTACH_FORM);
  ...
  ac++;
  XtSetArg(al[ac], XmNmarginWidth, 4);
  ac++;
  XtSetArg(al[ac], XmNmarginHeight, 4);
  ac++;
  XtSetArg(al[ac], XmNfontList, E_buttonFontList(editor));
  ac++;
  M_format_paragraph(editor) =
      (Widget)XmCreatePushButtonGadget(M_format_dialog(editor), "para", al, ac);
  ...
  XtSetArg(al[ac], XmNleftAttachment, XmATTACH_POSITION);
  ac++;
  XtSetArg(al[ac], XmNleftPosition, 27);
  ac++;
  XtSetArg(al[ac], XmNrightAttachment, XmATTACH_POSITION);
  ac++;
  ...
  ac++;
  M_format_all(editor) =
      (Widget)XmCreatePushButtonGadget(M_format_dialog(editor), "all", al, ac);
  ...
  XtSetArg(al[ac], XmNleftAttachment, XmATTACH_POSITION);
  ac++;
  XtSetArg(al[ac], XmNleftPosition, 51);
  ac++;
  XtSetArg(al[ac], XmNrightAttachment, XmATTACH_POSITION);
  ac++;
  XtSetArg(al[ac], XmNrightPosition, 73);
  ac++;
  XtSetArg(al[ac], XmNtopAttachment, XmATTACH_WIDGET);
  ac++;
  XtSetArg(al[ac], XmNtopWidget, M_format_separator(editor));
  ...
  XtSetArg(al[ac], XmNleftAttachment, XmATTACH_POSITION);
  ac++;
  XtSetArg(al[ac], XmNleftPosition, 75);
  ac++;
  XtSetArg(al[ac], XmNrightAttachment, XmATTACH_POSITION);
  ac++;
  XtSetArg(al[ac], XmNrightPosition, 98);
  ...
  XtSetArg(al[ac], XmNfontList, E_buttonFontList(editor));
  ac++;
  M_format_help(editor) =
      (Widget)XmCreatePushButtonGadget(M_format_dialog(editor), "help", al, ac);
...
static void GetAdjustSettings(DtEditorWidget editor,
                              DtEditorFormatSettings *formatSettings) {
  ...
  if (M_format_dialog(editor) != (Widget)NULL) {
     ...
     */
    num =
        (char *)XmTextFieldGetString((Widget)M_format_rightMarginField(editor));
    formatSettings->rightMargin = atoi(num);
    XtFree(num);
    num =
        (char *)XmTextFieldGetString((Widget)M_format_leftMarginField(editor));
...
Widget DtCreateEditor(Widget parent, char *name, ArgList arglist,
                      Cardinal argcount) {
...
DtEditorErrorCode DtEditorFormat(Widget widget,
  ...
  case DtEDITOR_FORMAT_ALL: {
    error = DoAdjust(editor, leftMargin, rightMargin, alignment, 0,
                     XmTextGetLastPosition(M_text(editor)));
    break;
  }
  ...
  case DtEDITOR_FORMAT_PARAGRAPH: {
     ...
     * paragraph
     */
    error = DoAdjust(editor, leftMargin, rightMargin, alignment, start, end);
    break;
  }
...
/* ARGSUSED */
void DtEditorGoToLine(Widget widget, int lineNumber) {
  DtEditorWidget editor = (DtEditorWidget)widget;
  XmTextWidget tw;
 ...
 *
 */
void DtEditorGetSizeHints(Widget widget, XSizeHints *pHints) /* Return */
{
  Arg al[10]; /* arg list */
  int ac;     /* arg count */
  Dimension FormWidth, FormHeight, Twidth, Theight, statusHeight,
      highlightThickness, shadowThickness, marginWidth, marginHeight,
   ...
   */
  ac = 0;
  XtSetArg(al[ac], XmNwidth, &Twidth);
  ac++;
  XtSetArg(al[ac], XmNheight, &Theight);
  ac++;
  XtSetArg(al[ac], XmNhighlightThickness, &highlightThickness);
  ac++;
  XtSetArg(al[ac], XmNshadowThickness, &shadowThickness);
  ac++;
  XtSetArg(al[ac], XmNmarginWidth, &marginWidth);
  ac++;
  XtSetArg(al[ac], XmNmarginHeight, &marginHeight);
  ac++;
  XtGetValues(M_text(editor), al, ac);
  ...
  textRegionWidth =
      (int)Twidth -
      (2 * ((int)highlightThickness + (int)shadowThickness + (int)marginWidth));
  textRegionHeight =
      (int)Theight - (2 * ((int)highlightThickness + (int)shadowThickness +
                           (int)marginHeight));
  ...
  pHints->min_height = pHints->base_width + pHints->height_inc + statusHeight;
