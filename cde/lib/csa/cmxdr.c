...
bool_t xdr_cms_name(XDR *xdrs, cms_name *objp) {
...
bool_t xdr_cms_access_entry(XDR *xdrs, cms_access_entry *objp) {
...
bool_t xdr_cms_key(XDR *xdrs, cms_key *objp) {
...
bool_t xdr_CSA_date_time_entry(XDR *xdrs, CSA_date_time_entry *objp) {
  if (!xdr_string(xdrs, &objp->date_time, ~0))
    return (FALSE);
  if (!xdr_pointer(xdrs, (char **)&objp->next, sizeof(CSA_date_time_entry),
...
bool_t xdr_cms_attribute_value(XDR *xdrs, cms_attribute_value *objp) {
  ...
  case CSA_VALUE_ACCESS_LIST:
    if (!xdr_pointer(xdrs, (char **)&objp->item.access_list_value,
                     sizeof(cms_access_entry), (xdrproc_t)xdr_cms_access_entry))
      return (FALSE);
    break;
  case CSA_VALUE_DATE_TIME_LIST:
    if (!xdr_pointer(xdrs, (char **)&objp->item.date_time_list_value,
                     sizeof(CSA_date_time_entry),
                     (xdrproc_t)xdr_CSA_date_time_entry))
      return (FALSE);
    break;
  case CSA_VALUE_REMINDER:
    if (!xdr_pointer(xdrs, (char **)&objp->item.reminder_value,
...
bool_t xdr_cms_attr_name(XDR *xdrs, cms_attr_name *objp) {
...
bool_t xdr_cms_attribute(XDR *xdrs, cms_attribute *objp) {
  if (!xdr_cms_attr_name(xdrs, &objp->name))
    return (FALSE);
  if (!xdr_pointer(xdrs, (char **)&objp->value, sizeof(CSA_attribute_value),
                   (xdrproc_t)xdr_cms_attribute_value))
    return (FALSE);
  return (TRUE);
}
...
bool_t xdr_cms_entry(XDR *xdrs, cms_entry *objp) {
  if (!xdr_cms_key(xdrs, &objp->key))
    return (FALSE);
  if (!xdr_array(xdrs, (char **)&objp->attrs, (u_int *)&objp->num_attrs, ~0,
                 sizeof(cms_attribute), (xdrproc_t)xdr_cms_attribute))
    return (FALSE);
...
bool_t
xdr_cms_enumerate_calendar_attr_res(XDR *xdrs,
                                    cms_enumerate_calendar_attr_res *objp) {
  if (!xdr_u_long(xdrs, &objp->stat))
    return (FALSE);
  if (!xdr_array(xdrs, (char **)&objp->names, (u_int *)&objp->num_names, ~0,
                 sizeof(cms_attr_name), (xdrproc_t)xdr_cms_attr_name))
    return (FALSE);
  return (TRUE);
}
...
bool_t xdr_cms_list_calendars_res(XDR *xdrs, cms_list_calendars_res *objp) {
  if (!xdr_u_long(xdrs, &objp->stat))
    return (FALSE);
  if (!xdr_array(xdrs, (char **)&objp->names, (u_int *)&objp->num_names, ~0,
                 sizeof(cms_name), (xdrproc_t)xdr_cms_name))
    return (FALSE);
  return (TRUE);
}
...
bool_t xdr_cms_open_args(XDR *xdrs, cms_open_args *objp) {
...
bool_t xdr_cms_open_res(XDR *xdrs, cms_open_res *objp) {
  if (!xdr_u_long(xdrs, &objp->stat))
    return (FALSE);
  ...
  if (!xdr_u_int(xdrs, &objp->user_access))
    return (FALSE);
  if (!xdr_array(xdrs, (char **)&objp->attrs, &objp->num_attrs, ~0,
                 sizeof(cms_attribute), (xdrproc_t)xdr_cms_attribute))
    return (FALSE);
  return (TRUE);
}
...
bool_t xdr_cms_create_args(XDR *xdrs, cms_create_args *objp) {
  if (!xdr_string(xdrs, &objp->cal, ~0))
    return (FALSE);
...
bool_t xdr_cms_remove_args(XDR *xdrs, cms_remove_args *objp) {
  if (!xdr_string(xdrs, &objp->cal, ~0))
    return (FALSE);
  if (!xdr_int(xdrs, &objp->pid))
    return (FALSE);
...
bool_t xdr_cms_register_args(XDR *xdrs, cms_register_args *objp) {
  if (!xdr_string(xdrs, &objp->cal, ~0))
    return (FALSE);
...
bool_t xdr_cms_get_cal_attr_res(XDR *xdrs, cms_get_cal_attr_res *objp) {
  if (!xdr_u_long(xdrs, &objp->stat))
    return (FALSE);
  if (!xdr_array(xdrs, (char **)&objp->attrs, (u_int *)&objp->num_attrs, ~0,
                 sizeof(cms_attribute), (xdrproc_t)xdr_cms_attribute))
...
bool_t xdr_cms_get_cal_attr_args(XDR *xdrs, cms_get_cal_attr_args *objp) {
  if (!xdr_string(xdrs, &objp->cal, ~0))
    return (FALSE);
  if (!xdr_array(xdrs, (char **)&objp->names, (u_int *)&objp->num_names, ~0,
                 sizeof(cms_attr_name), (xdrproc_t)xdr_cms_attr_name))
...
bool_t xdr_cms_set_cal_attr_args(XDR *xdrs, cms_set_cal_attr_args *objp) {
  if (!xdr_string(xdrs, &objp->cal, ~0))
    return (FALSE);
  if (!xdr_int(xdrs, &objp->pid))
    return (FALSE);
...
bool_t xdr_cms_archive_res(XDR *xdrs, cms_archive_res *objp) {
  if (!xdr_u_long(xdrs, &objp->stat))
    return (FALSE);
...
bool_t xdr_cms_archive_args(XDR *xdrs, cms_archive_args *objp) {
  if (!xdr_string(xdrs, &objp->cal, ~0))
    return (FALSE);
  ...
  if (!xdr_array(xdrs, (char **)&objp->attrs, (u_int *)&objp->num_attrs, ~0,
                 sizeof(cms_attribute), (xdrproc_t)xdr_cms_attribute))
    return (FALSE);
  if (!xdr_array(xdrs, (char **)&objp->ops, (u_int *)&objp->num_attrs, ~0,
                 sizeof(CSA_enum), (xdrproc_t)xdr_long))
    return (FALSE);
  return (TRUE);
}
...
bool_t xdr_cms_restore_args(XDR *xdrs, cms_restore_args *objp) {
  if (!xdr_string(xdrs, &objp->cal, ~0))
    return (FALSE);
  if (!xdr_string(xdrs, &objp->data, ~0))
    return (FALSE);
...
bool_t xdr_cms_reminder_ref(XDR *xdrs, cms_reminder_ref *objp) {
...
bool_t xdr_cms_reminder_res(XDR *xdrs, cms_reminder_res *objp) {
  if (!xdr_u_long(xdrs, &objp->stat))
    return (FALSE);
...
bool_t xdr_cms_reminder_args(XDR *xdrs, cms_reminder_args *objp) {
  if (!xdr_string(xdrs, &objp->cal, ~0))
    return (FALSE);
...
bool_t xdr_cms_entries_res(XDR *xdrs, cms_entries_res *objp) {
  if (!xdr_u_long(xdrs, &objp->stat))
    return (FALSE);
...
bool_t xdr_cms_lookup_entries_args(XDR *xdrs, cms_lookup_entries_args *objp) {
  if (!xdr_string(xdrs, &objp->cal, ~0))
    return (FALSE);
  if (!xdr_string(xdrs, &objp->char_set, ~0))
    return (FALSE);
...
bool_t xdr_cms_enumerate_args(XDR *xdrs, cms_enumerate_args *objp) {
  if (!xdr_string(xdrs, &objp->cal, ~0))
    return (FALSE);
  if (!xdr_long(xdrs, &objp->id))
    return (FALSE);
...
bool_t xdr_cms_get_entry_attr_res_item(XDR *xdrs,
...
bool_t xdr_cms_get_entry_attr_res(XDR *xdrs, cms_get_entry_attr_res *objp) {
  if (!xdr_u_long(xdrs, &objp->stat))
    return (FALSE);
...
bool_t xdr_cms_get_entry_attr_args(XDR *xdrs, cms_get_entry_attr_args *objp) {
  if (!xdr_string(xdrs, &objp->cal, ~0))
    return (FALSE);
  if (!xdr_array(xdrs, (char **)&objp->keys, (u_int *)&objp->num_keys, ~0,
                 sizeof(cms_key), (xdrproc_t)xdr_cms_key))
    return (FALSE);
  if (!xdr_array(xdrs, (char **)&objp->names, (u_int *)&objp->num_names, ~0,
                 sizeof(cms_attr_name), (xdrproc_t)xdr_cms_attr_name))
    return (FALSE);
...
bool_t xdr_cms_entry_res(XDR *xdrs, cms_entry_res *objp) {
  if (!xdr_u_long(xdrs, &objp->stat))
    return (FALSE);
...
bool_t xdr_cms_insert_args(XDR *xdrs, cms_insert_args *objp) {
  if (!xdr_string(xdrs, &objp->cal, ~0))
    return (FALSE);
  if (!xdr_int(xdrs, &objp->pid))
    return (FALSE);
...
bool_t xdr_cms_update_args(XDR *xdrs, cms_update_args *objp) {
  if (!xdr_string(xdrs, &objp->cal, ~0))
    return (FALSE);
  if (!xdr_int(xdrs, &objp->pid))
    return (FALSE);
...
bool_t xdr_cms_delete_args(XDR *xdrs, cms_delete_args *objp) {
  if (!xdr_string(xdrs, &objp->cal, ~0))
    return (FALSE);
  if (!xdr_int(xdrs, &objp->pid))
    return (FALSE);
