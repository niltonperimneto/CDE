...
_DtCmAttrInfo _CSA_cal_attr_info[] = {
    ...
    {CSA_CAL_ATTR_CALENDAR_NAME_I, CSA_VALUE_STRING, 1, _DtCm_old_attr_unknown,
     B_TRUE, B_TRUE},
    {CSA_CAL_ATTR_CALENDAR_OWNER_I, CSA_VALUE_CALENDAR_USER, 1,
     _DtCm_old_attr_unknown, B_TRUE, B_TRUE},
    {CSA_CAL_ATTR_CALENDAR_SIZE_I, CSA_VALUE_UINT32, 4, _DtCm_old_attr_unknown,
     B_TRUE, B_TRUE},
    {CSA_CAL_ATTR_CHARACTER_SET_I, CSA_VALUE_STRING, 4, _DtCm_old_attr_unknown,
     B_TRUE, B_TRUE},
    {CSA_CAL_ATTR_COUNTRY_I, CSA_VALUE_STRING, 0, _DtCm_old_attr_unknown,
     B_FALSE, B_FALSE},
    {CSA_CAL_ATTR_DATE_CREATED_I, CSA_VALUE_DATE_TIME, 4,
     _DtCm_old_attr_unknown, B_TRUE, B_TRUE},
    {CSA_CAL_ATTR_LANGUAGE_I, CSA_VALUE_STRING, 0, _DtCm_old_attr_unknown,
     B_FALSE, B_FALSE},
    {CSA_CAL_ATTR_NUMBER_ENTRIES_I, CSA_VALUE_UINT32, 1, _DtCm_old_attr_unknown,
     B_TRUE, B_TRUE},
    {CSA_CAL_ATTR_PRODUCT_IDENTIFIER_I, CSA_VALUE_STRING, 1,
     _DtCm_old_attr_unknown, B_TRUE, B_TRUE},
    {CSA_CAL_ATTR_TIME_ZONE_I, CSA_VALUE_STRING, 4, _DtCm_old_attr_unknown,
     B_TRUE, B_TRUE},
    {CSA_CAL_ATTR_VERSION_I, CSA_VALUE_STRING, 1, _DtCm_old_attr_unknown,
     B_TRUE, B_TRUE},
...
_DtCmAttrInfo _CSA_entry_attr_info[] = {
    /* first element is not used */
    {0, -1, 0, _DtCm_old_attr_unknown, B_TRUE, B_TRUE},
    {CSA_ENTRY_ATTR_ATTENDEE_LIST_I, CSA_VALUE_ATTENDEE_LIST, 0,
     _DtCm_old_attr_unknown, B_FALSE, B_FALSE},
    {CSA_ENTRY_ATTR_AUDIO_REMINDER_I, CSA_VALUE_REMINDER, 1,
     _DtCm_old_attr_beep_reminder, B_FALSE, B_FALSE},
    {CSA_ENTRY_ATTR_CLASSIFICATION_I, CSA_VALUE_UINT32, 2,
     _DtCm_old_attr_privacy, B_FALSE, B_FALSE},
    {CSA_ENTRY_ATTR_DATE_COMPLETED_I, CSA_VALUE_DATE_TIME, 4,
     _DtCm_old_attr_unknown, B_FALSE, B_FALSE},
    {CSA_ENTRY_ATTR_DATE_CREATED_I, CSA_VALUE_DATE_TIME, 4,
     _DtCm_old_attr_unknown, B_TRUE, B_TRUE},
    {CSA_ENTRY_ATTR_DESCRIPTION_I, CSA_VALUE_STRING, 4, _DtCm_old_attr_unknown,
     B_FALSE, B_FALSE},
    {CSA_ENTRY_ATTR_DUE_DATE_I, CSA_VALUE_DATE_TIME, 4, _DtCm_old_attr_unknown,
     B_FALSE, B_FALSE},
    {CSA_ENTRY_ATTR_END_DATE_I, CSA_VALUE_DATE_TIME, 1, _DtCm_old_attr_duration,
     B_FALSE, B_FALSE},
    {CSA_ENTRY_ATTR_EXCEPTION_DATES_I, CSA_VALUE_DATE_TIME_LIST, 4,
     _DtCm_old_attr_unknown, B_FALSE, B_FALSE},
    {CSA_ENTRY_ATTR_EXCEPTION_RULE_I, CSA_VALUE_STRING, 0,
     _DtCm_old_attr_unknown, B_FALSE, B_FALSE},
    {CSA_ENTRY_ATTR_FLASHING_REMINDER_I, CSA_VALUE_REMINDER, 1,
     _DtCm_old_attr_flash_reminder, B_FALSE, B_FALSE},
    {CSA_ENTRY_ATTR_LAST_UPDATE_I, CSA_VALUE_DATE_TIME, 4,
     _DtCm_old_attr_unknown, B_TRUE, B_TRUE},
    {CSA_ENTRY_ATTR_MAIL_REMINDER_I, CSA_VALUE_REMINDER, 1,
     _DtCm_old_attr_mail_reminder, B_FALSE, B_FALSE},
    {CSA_ENTRY_ATTR_NUMBER_RECURRENCES_I, CSA_VALUE_UINT32, 4,
     _DtCm_old_attr_unknown, B_TRUE, B_TRUE},
    {CSA_ENTRY_ATTR_ORGANIZER_I, CSA_VALUE_CALENDAR_USER, 1,
     _DtCm_old_attr_author, B_TRUE, B_TRUE},
    {CSA_ENTRY_ATTR_POPUP_REMINDER_I, CSA_VALUE_REMINDER, 1,
     _DtCm_old_attr_popup_reminder, B_FALSE, B_FALSE},
    {CSA_ENTRY_ATTR_PRIORITY_I, CSA_VALUE_UINT32, 4, _DtCm_old_attr_unknown,
     B_FALSE, B_FALSE},
    {CSA_ENTRY_ATTR_RECURRENCE_RULE_I, CSA_VALUE_STRING, 4,
     _DtCm_old_attr_unknown, B_FALSE, B_FALSE},
    {CSA_ENTRY_ATTR_RECURRING_DATES_I, CSA_VALUE_DATE_TIME_LIST, 0,
     _DtCm_old_attr_unknown, B_FALSE, B_FALSE},
    {CSA_ENTRY_ATTR_REFERENCE_IDENTIFIER_I, CSA_VALUE_OPAQUE_DATA, 1,
     _DtCm_old_attr_id, B_TRUE, B_TRUE},
    {CSA_ENTRY_ATTR_SEQUENCE_NUMBER_I, CSA_VALUE_UINT32, 0,
     _DtCm_old_attr_unknown, B_TRUE, B_TRUE},
    {CSA_ENTRY_ATTR_SPONSOR_I, CSA_VALUE_CALENDAR_USER, 4,
     _DtCm_old_attr_unknown, B_FALSE, B_FALSE},
    {CSA_ENTRY_ATTR_START_DATE_I, CSA_VALUE_DATE_TIME, 1, _DtCm_old_attr_time,
     B_FALSE, B_FALSE},
    {CSA_ENTRY_ATTR_STATUS_I, CSA_VALUE_UINT32, 2, _DtCm_old_attr_status,
     B_FALSE, B_FALSE},
    {CSA_ENTRY_ATTR_SUBTYPE_I, CSA_VALUE_STRING, 1, _DtCm_old_attr_type2,
     B_FALSE, B_FALSE},
    {CSA_ENTRY_ATTR_SUMMARY_I, CSA_VALUE_STRING, 1, _DtCm_old_attr_what,
     B_FALSE, B_FALSE},
    {CSA_ENTRY_ATTR_TIME_TRANSPARENCY_I, CSA_VALUE_SINT32, 4,
     _DtCm_old_attr_unknown, B_FALSE, B_FALSE},
    {CSA_ENTRY_ATTR_TYPE_I, CSA_VALUE_UINT32, 1, _DtCm_old_attr_type, B_FALSE,
     B_FALSE},
    {CSA_X_DT_ENTRY_ATTR_SHOWTIME_I, CSA_VALUE_SINT32, 2,
     _DtCm_old_attr_showtime, B_FALSE, B_FALSE},
    {CSA_X_DT_ENTRY_ATTR_REPEAT_TYPE_I, CSA_VALUE_SINT32, 1,
     _DtCm_old_attr_repeat_type, B_FALSE, B_TRUE},
    {CSA_X_DT_ENTRY_ATTR_REPEAT_TIMES_I, CSA_VALUE_UINT32, 1,
     _DtCm_old_attr_repeat_times, B_FALSE, B_TRUE},
    {CSA_X_DT_ENTRY_ATTR_REPEAT_INTERVAL_I, CSA_VALUE_UINT32, 3,
     _DtCm_old_attr_repeat_nth_interval, B_FALSE, B_TRUE},
    {CSA_X_DT_ENTRY_ATTR_REPEAT_OCCURRENCE_NUM_I, CSA_VALUE_SINT32, 3,
     _DtCm_old_attr_repeat_nth_weeknum, B_FALSE, B_TRUE},
    {CSA_X_DT_ENTRY_ATTR_SEQUENCE_END_DATE_I, CSA_VALUE_DATE_TIME, 3,
     _DtCm_old_attr_end_date, B_FALSE, B_TRUE},
    {CSA_X_DT_ENTRY_ATTR_ENTRY_DELIMITER_I, CSA_VALUE_STRING, -1,
     _DtCm_old_attr_unknown, B_TRUE, B_TRUE}};
...
check_predefined_attrs(int fversion, uint num_attrs, cms_attribute *attrs,
                       boolean_t checkreadonly, _DtCmNameTable *tbl,
                       uint num_defined, _DtCmAttrInfo *our_attrs);
...
static CSA_return_code hash_entry_attrs(uint num_attrs, CSA_attribute *csaattrs,
                                        cms_attribute *cmsattrs, uint *hnum,
                                        cms_attribute **hattrs, uint *num);

static CSA_return_code hash_cal_attrs(uint num_attrs, CSA_attribute *csaattrs,
                                      cms_attribute *cmsattrs, uint *hnum,
                                      cms_attribute **hattrs, uint *num);

static CSA_return_code _DtCm_check_hashed_entry_attributes(int fvers,
                                                           uint num_attrs,
                                                           cms_attribute *attrs,
                                                           CSA_flags utype);

static CSA_return_code _DtCm_check_hashed_cal_attributes(
    int fvers, uint num_attrs, cms_attribute *attrs, char *owner, char *cname,
    boolean_t checkreadonly, boolean_t firsttime, boolean_t csatype);
...
_DtCm_check_cal_csa_attributes(int fvers, uint num_attrs, CSA_attribute *attrs,
                               char *cname, boolean_t checkreadonly,
                               boolean_t firsttime, boolean_t checkattrnum) {
  ...
  stat = _DtCm_check_hashed_cal_attributes(fvers, hnum, hattrs, NULL, cname,
                                           checkreadonly, firsttime, B_TRUE);
...
extern CSA_return_code _DtCm_check_cal_cms_attributes(
    int fvers, uint num_attrs, cms_attribute *attrs, char *owner, char *cname,
    boolean_t checkreadonly, boolean_t firsttime, boolean_t checkattrnum) {
  CSA_return_code stat;
  uint hnum;
  cms_attribute *hattrs;
  uint realnum;
  ...
  stat = _DtCm_check_hashed_cal_attributes(fvers, hnum, hattrs, owner, cname,
                                           checkreadonly, firsttime, B_FALSE);
...
extern CSA_return_code _DtCm_check_entry_attributes(int fvers, uint num_attrs,
                                                    CSA_attribute *attrs,
                                                    CSA_flags utype,
...
extern CSA_return_code
_DtCm_check_entry_cms_attributes(int fvers, uint num_attrs,
                                 cms_attribute *attrs, CSA_flags utype,
                                 boolean_t checkattrnum) {
  CSA_return_code stat;
  uint hnum;
  cms_attribute *hattrs;
 ...
 */
extern CSA_return_code _DtCm_copy_cms_attributes(uint srcsize,
  ...
  *dstattrs = NULL;
  ...
  for (i = 1, j = 1; i <= srcsize; i++) {
    if (srcattrs[i].name.name != NULL) {
      if ((stat = _DtCm_copy_cms_attribute(&attrs[j], &srcattrs[i], B_TRUE)) !=
          CSA_SUCCESS)
        break;
      else
        j++;
 ...
 */
extern void _DtCm_free_cms_attributes(uint size, cms_attribute *attrs) {
  int i;
 ...
 * array itself.
 */
extern void _DtCm_free_attributes(uint size, CSA_attribute *attrs) {
  int i;
 ...
 * note: element 0 is not used
 */
extern void _DtCm_free_cms_attribute_values(uint size, cms_attribute *attrs) {
  int i;
 ...
 */
extern void _DtCm_free_attribute_values(uint size, CSA_attribute *attrs) {
  int i;
...
extern int _DtCm_old_reminder_name_to_index(char *oldname) {
  char *name;
...
extern CSA_return_code _DtCm_get_old_attr_by_name(char *name,
  ...
  if (index > 0 && index <= _DtCM_DEFINED_ENTRY_ATTR_SIZE) {
    ...
    if (_CSA_entry_attr_info[index].oldattr != _DtCm_old_attr_unknown) {
...
extern CSA_return_code _DtCm_copy_cms_attr_val(cms_attribute_value *from,
  ...
  if (from == NULL)
    ...
    if ((val = (cms_attribute_value *)calloc(1, sizeof(cms_attribute_value))) ==
        NULL)
      return (CSA_E_INSUFFICIENT_MEMORY);
    ...
    case CSA_VALUE_CALENDAR_USER:
      if (from->item.string_value)
        val->item.string_value = strdup(from->item.string_value);
      else
    ...
    case CSA_VALUE_REMINDER:
      if (from->item.reminder_value == NULL)
        ...
        stat = _DtCm_copy_reminder(from->item.reminder_value,
    ...
    case CSA_VALUE_ACCESS_LIST:
      if (from->item.access_list_value &&
          (val->item.access_list_value = _DtCm_copy_cms_access_list(
    ...
    case CSA_VALUE_DATE_TIME_LIST:
      if (from->item.date_time_list_value &&
          (val->item.date_time_list_value = _DtCm_copy_date_time_list(
    ...
    case CSA_VALUE_OPAQUE_DATA:
      if (from->item.opaque_data_value) {
        stat = _DtCm_copy_opaque_data(from->item.opaque_data_value,
...
extern CSA_return_code _DtCm_cms2csa_attrval(cms_attribute_value *from,
  ...
  if (from == NULL)
    ...
    if ((val = (CSA_attribute_value *)calloc(1, sizeof(CSA_attribute_value))) ==
        NULL)
      return (CSA_E_INSUFFICIENT_MEMORY);
    ...
    case CSA_VALUE_CALENDAR_USER:
      if (from->item.calendar_user_value == NULL)
        ...
        stat = convert_cms_user_to_csa_user(from->item.calendar_user_value,
                                            &val->item.calendar_user_value);
      break;
    case CSA_VALUE_ACCESS_LIST:
      stat = _DtCm_cms2csa_access_list(from->item.access_list_value,
...
extern CSA_return_code _DtCm_set_uint32_attrval(uint numval,
...
extern CSA_return_code _DtCm_set_sint32_attrval(int numval,
                                                cms_attribute_value **attrval) {
  cms_attribute_value *val;
...
extern CSA_return_code _DtCm_set_string_attrval(char *strval,
  ...
  if (type != CSA_VALUE_STRING && type != CSA_VALUE_DATE_TIME &&
      type != CSA_VALUE_DATE_TIME_RANGE && type != CSA_VALUE_TIME_DURATION &&
      type != CSA_VALUE_CALENDAR_USER)
    return (CSA_E_INVALID_PARAMETER);
...
extern CSA_return_code
_DtCm_set_reminder_attrval(CSA_reminder *remval,
                           cms_attribute_value **attrval) {
  cms_attribute_value *val;
  CSA_return_code stat;
...
extern CSA_return_code
_DtCm_set_csa_access_attrval(cms_access_entry *aval,
  ...
  if (aval == NULL) {
    ...
    stat = _DtCm_cms2csa_access_list(aval, &val->item.access_list_value);
  }
...
extern CSA_return_code _DtCm_set_opaque_attrval(CSA_opaque_data *data,
                                                cms_attribute_value **attrval) {
  CSA_return_code stat;
  cms_attribute_value *val;
...
extern CSA_return_code
_DtCm_set_csa_string_attrval(char *strval, CSA_attribute_value **attrval,
                             CSA_enum type) {
  CSA_attribute_value *val;
...
extern cms_access_entry *_DtCm_copy_cms_access_list(cms_access_entry *alist) {
  ...
  prev = head = NULL;
  while (alist != NULL) {
    if ((l = (cms_access_entry *)calloc(1, sizeof(cms_access_entry))) == NULL) {
      cleanup = B_TRUE;
      break;
    }
...
extern CSA_return_code _DtCm_cms2csa_access_list(cms_access_entry *cmslist,
  ...
  head = prev = NULL;
  while (cmslist != NULL) {
    if ((to = (CSA_access_rights *)calloc(1, sizeof(CSA_access_rights))) ==
        NULL) {
      stat = CSA_E_INSUFFICIENT_MEMORY;
      break;
    }

    if ((to->user = (CSA_calendar_user *)calloc(
             1, sizeof(CSA_calendar_user))) == NULL) {
      free(to);
      stat = CSA_E_INSUFFICIENT_MEMORY;
      break;
    }
...
extern CSA_return_code _DtCm_csa2cms_access_list(CSA_access_rights *csalist,
  ...
  head = prev = NULL;
  while (csalist != NULL) {
    if ((to = (cms_access_entry *)calloc(1, sizeof(cms_access_entry))) ==
        NULL) {
      stat = CSA_E_INSUFFICIENT_MEMORY;
      break;
    }
    ...
    if (csalist->user->user_name) {
      if ((to->user = strdup(csalist->user->user_name)) == NULL) {
        stat = CSA_E_INSUFFICIENT_MEMORY;
        free(to);
        break;
      }
...
extern CSA_date_time_list _DtCm_copy_date_time_list(CSA_date_time_list dlist) {
  ...
  prev = head = NULL;
  while (dlist != NULL) {
    if ((l = (CSA_date_time_entry *)calloc(1, sizeof(CSA_date_time_entry))) ==
        NULL) {
      cleanup = B_TRUE;
      break;
    }
...
extern CSA_return_code _DtCm_copy_reminder(CSA_reminder *from,
  ...
  if (from->reminder_data.size > 0) {
    ...
    if ((newval->reminder_data.data = malloc(newval->reminder_data.size)) ==
        NULL) {
      _DtCm_free_reminder(newval);
      return (CSA_E_INSUFFICIENT_MEMORY);
    }
...
extern CSA_return_code _DtCm_copy_opaque_data(CSA_opaque_data *from,
  ...
  if ((val = (CSA_opaque_data *)calloc(1, sizeof(CSA_opaque_data))) == NULL) {
    return (CSA_E_INSUFFICIENT_MEMORY);
  }
 ...
 */
static CSA_return_code
check_predefined_attrs(int fver, uint num_attrs, cms_attribute *attrs,
                       boolean_t checkreadonly, _DtCmNameTable *tbl,
                       uint num_defined, _DtCmAttrInfo *our_attrs) {
  int i, index, cl;
  CSA_reminder *rptr;
  ...
  for (i = 0; i < num_attrs; i++) {
    ...
    if (tbl == NULL)
      ...
      index = _DtCm_get_index_from_table(tbl, attrs[i].name.name);
    ...
    if (index > 0 && index <= num_defined) {
      ...
      if (checkreadonly && ((fver < _DtCM_FIRST_EXTENSIBLE_DATA_VERSION &&
      ...
      /* check data type */
      if (attrs[i].value && attrs[i].value->type != our_attrs[index].type)
        return (CSA_E_INVALID_ATTRIBUTE_VALUE);

      if (index == CSA_ENTRY_ATTR_CLASSIFICATION_I) {
        cl = attrs[i].value->item.uint32_value;
        if (cl < CSA_CLASS_PUBLIC || cl > CSA_CLASS_CONFIDENTIAL)
          return (CSA_E_INVALID_ATTRIBUTE_VALUE);
      }

      if (index == CSA_ENTRY_ATTR_TYPE_I) {
        cl = attrs[i].value->item.uint32_value;
        if (cl < CSA_TYPE_EVENT || cl > CSA_X_DT_TYPE_OTHER)
          return (CSA_E_INVALID_ATTRIBUTE_VALUE);
      }
    ...
    if (attrs[i].value) {
      ...
      case CSA_VALUE_DATE_TIME:
        if (attrs[i].value->item.sint32_value == 0 ||
            _csa_iso8601_to_tick((char *)attrs[i].value->item.sint32_value,
                                 &tick))
          return (CSA_E_INVALID_DATE_TIME);
        break;
      case CSA_VALUE_REMINDER:
        rptr = (CSA_reminder *)attrs[i].value->item.sint32_value;
        if (rptr == NULL || rptr->lead_time == NULL ||
            _csa_iso8601_to_duration(rptr->lead_time, &tick))
          return (CSA_E_INVALID_ATTRIBUTE_VALUE);
        break;
      case CSA_VALUE_ATTENDEE_LIST:
        return (CSA_E_INVALID_ATTRIBUTE_VALUE);
...
static CSA_return_code convert_cms_user_to_csa_user(char *from,
  ...
  if ((newval = (CSA_calendar_user *)calloc(1, sizeof(CSA_calendar_user))) ==
      NULL)
    return (CSA_E_INSUFFICIENT_MEMORY);
...
static CSA_return_code hash_entry_attrs(uint num_attrs, CSA_attribute *csaattrs,
  ...
  if ((nattrs = (cms_attribute *)calloc(
           1, sizeof(cms_attribute) *
                  (num_attrs + _DtCM_DEFINED_ENTRY_ATTR_SIZE + 1))) == NULL)
    return (CSA_E_INSUFFICIENT_MEMORY);
...
static CSA_return_code hash_cal_attrs(uint num_attrs, CSA_attribute *csaattrs,
  ...
  if ((nattrs = (cms_attribute *)calloc(
           1, sizeof(cms_attribute) *
                  (num_attrs + _DtCM_DEFINED_CAL_ATTR_SIZE + 1))) == NULL)
    return (CSA_E_INSUFFICIENT_MEMORY);
...
static CSA_return_code _DtCm_check_hashed_cal_attributes(
  ...
  if (firsttime) {
    if (attrs[CSA_CAL_ATTR_CALENDAR_OWNER_I].name.name) {
      ...
      if (csatype) {
        csaval =
            (CSA_attribute_value *)attrs[CSA_CAL_ATTR_CALENDAR_OWNER_I].value;
        stat = _CheckCalendarOwner(
            owner, csaval->type,
            (csaval && csaval->item.calendar_user_value
                 ? csaval->item.calendar_user_value->user_name
                 : NULL));
      } else {
        cmsval = attrs[CSA_CAL_ATTR_CALENDAR_OWNER_I].value;
        stat = _CheckCalendarOwner(owner, cmsval->type,
                                   cmsval ? cmsval->item.calendar_user_value
                                          : NULL);
      }
    ...
    if (attrs[CSA_CAL_ATTR_CALENDAR_NAME_I].name.name) {
      if (attrs[CSA_CAL_ATTR_CALENDAR_NAME_I].value == NULL ||
          attrs[CSA_CAL_ATTR_CALENDAR_NAME_I].value->item.string_value ==
              NULL) {
        if (oattr)
      ...
      if ((stat = _CheckCalendarName(
               owner, cname, attrs[CSA_CAL_ATTR_CALENDAR_NAME_I].value)) !=
          CSA_SUCCESS) {
        if (oattr)
          attrs[CSA_CAL_ATTR_CALENDAR_OWNER_I].name.name = oattr;
        return (stat);
  ...
  stat =
      check_predefined_attrs(fvers, num_attrs + 1, attrs, checkreadonly, NULL,
                             _DtCM_DEFINED_CAL_ATTR_SIZE, _CSA_cal_attr_info);
...
static CSA_return_code _DtCm_check_hashed_entry_attributes(int fvers,
  ...
  if ((stat = check_predefined_attrs(fvers, num_attrs + 1, attrs,
                                     ...
                                     _CSA_entry_attr_info)) != CSA_SUCCESS) {
 ...
 */
static CSA_return_code _CheckCalendarOwner(char *owner, int type, char *user) {
...
static CSA_return_code _CheckCalendarName(char *owner, char *cname,
   ...
   * calendar name
   */
  if ((stat = _CheckNameAtHost(cname, val->item.string_value)) != CSA_SUCCESS)
    return (stat);

  /* now make sure if cal name is a user name, it's
   * the same as that of the calling user
   */
  if (ptr = strchr(val->item.string_value, '@'))
    *ptr = '\0';
  ...
  if (isuser == B_TRUE) {
    snprintf(user, BUFSIZ, "%s%s", val->item.string_value, (ptr ? ptr : ""));
    return (_CheckNameAtHost(owner, user));
  }
