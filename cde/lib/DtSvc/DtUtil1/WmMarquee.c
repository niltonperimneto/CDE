...
static Tt_callback_action _WsSelectionCB(Tt_message m, Tt_pattern p) {
 ...
 *
 *************************************<->***********************************/
DtWsmCBContext _DtWsmAddMarqueeSelectionCallback(Widget widget,
                                                 DtWsmMarqueeSelectionProc marquee_selection,
                                                 XtPointer client_data) {
  struct _DtWsmCBContext* pCbCtx;
  int screen;
  ...
  snprintf(sNum, sizeof(sNum), "%d", screen);
   ...
   */
  pCbCtx = (struct _DtWsmCBContext*)XtMalloc(sizeof(struct _DtWsmCBContext));
