...
public:
   ...
   oid_t  locator_id(void);
   const char*  short_title(void);
   const char*  long_title(void);
   short_list_handler* tab_list(void);
   int seq_num(void);  // seq number for Fulcrum.
   const char*  license_terms(void);
   unsigned int license_terms_size(void);
};
