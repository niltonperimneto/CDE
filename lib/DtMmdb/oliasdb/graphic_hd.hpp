...
public:
   ...
   const char* locator(void);
   const char* file_name(void);
   const char* version(void);

   int type() const;
   unsigned short coding(void);
   unsigned short width(void);
   unsigned short height(void);
   int data_size(void);
   const char* data(void);
   const char* title(void);

   unsigned int llx(void) ;
   unsigned int lly(void) ;
   unsigned int urx(void) ;
   unsigned int ury(void) ;
