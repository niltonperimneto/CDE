...
#include "dstr/dlist.hpp"
#include "dstr/dlist_void_ptr_cell.hpp"
#include "object/oid.hpp"
#include "object/composite.hpp"
#include "storage/page_storage.hpp"
#include "storage/chunks_index.hpp"
...
// handle both the memory and disk list.
   ...
   void build_internal_index(void); // set up an index on the list
   void reqest_build_internal_index(void); 
