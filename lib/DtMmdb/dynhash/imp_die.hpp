...
#include "dstr/index_agent.hpp"
#include "dynhash/imp_bucket.hpp"
...
protected:
   ...
   void init_table(void);           // init hash table and bucket array
   void collect_all_keys(void);     // collect all keys into bcuket_list_head
   Boolean rehash(void);            // rehash all keys 
...
public:
   ...
   void clean(void) ; // remove all keys 
