...
typedef enum {
  _TT_TRACE_VERSION_VAL = 1, // Don't want a "false" value
  _TT_TRACE_FOLLOW_ENUM,
  _TT_TRACE_WRITEFILE_ENUM,
  _TT_TRACE_APPENDFILE_ENUM,
  _TT_TRACE_FUNCTIONS_ENUM,
  _TT_TRACE_ATTRIBUTES_ENUM,
  _TT_TRACE_STATES_ENUM,
  _TT_TRACE_OPS_ENUM,
  _TT_TRACE_SENDER_PTYPES_ENUM,
  _TT_TRACE_HANDLER_PTYPES_ENUM,
#ifdef _OPT_TIMERS_SUNOS
  _TT_TRACE_TIMERS_ENUM,
#endif
  ...
  _TT_TRACE_OFF_ENUM,
  _TT_TRACE_ON_ENUM,
  _TT_TRACE_FILENAME_ENUM,
  _TT_TRACE_FUNC_VAL,
  _TT_TRACE_ALL_ENUM,
  _TT_TRACE_NONE_ENUM,
  _TT_TRACE_EDGE_ENUM,
  _TT_TRACE_DELIVER_ENUM,
  _TT_TRACE_DISPATCH_ENUM,
  _TT_TRACE_STRING,
