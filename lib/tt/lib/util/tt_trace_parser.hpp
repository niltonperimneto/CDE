...
typedef enum { None, Edge, Dispatch, Deliver } _Tt_dispatch_stage;
...
public:
  ...
  _Tt_string_list_ptr sfunction_val(void);
  ...
  _Tt_int_rec_list_ptr states_val(void);
  _Tt_string_list_ptr ops_val(void);
  _Tt_string_list_ptr sender_ptypes_val(void);
  _Tt_string_list_ptr handler_ptypes_val(void);
  ...
  // sender_ptypes
  void clear_sender_ptypes(void);
  void add_sender_ptype(const _Tt_string &sp);

  // handler_ptypes
  void clear_handler_ptypes(void);
  ...
  int is_traced(const _Tt_message &msg, _Tt_dispatch_stage stage) const;
...
typedef _Tt_trace_parser *_Tt_trace_parser_ptr;
