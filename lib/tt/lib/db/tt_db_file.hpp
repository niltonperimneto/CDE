...
public:
  ...
  _Tt_string_list_ptr getObjects (void);
  ...
  _Tt_string_list_ptr getSessions (void);  
...
private:
  ...
  _Tt_db_results createDBFile (void);
  bool_t         isFileInDatabase (void);
