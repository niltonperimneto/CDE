...
#include "db/tt_client_isam_key_descriptor_utils.hpp"
...
public:
  ...
  _Tt_client_isam_record_ptr getEmptyRecord (void);
  ...
  _Tt_string readMagicString (void);
