...
#include <util/tt_host.hpp>
#include <util/tt_threadspecific.hpp>
#include <mp/mp_c_file.hpp>
#include <mp/mp_c_message.hpp>
#include <mp/mp_c_mp.hpp>
#include <mp/mp_c_global.hpp>
#include <mp/mp_pattern.hpp>
#include <mp/mp_c_procid.hpp>
#include <mp/mp_rpc_interface.h>
#include <mp/mp_c_session.hpp>
#include <mp/mp_stream_socket.hpp>
...
// 
// Used by the client library to a new pattern. The real work is
