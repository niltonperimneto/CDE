...
#include "mp/mp_session_utils.hpp"
#include "mp_s_session_utils.hpp"
#include "mp/mp_file_utils.hpp"
#include "mp/mp_procid.hpp"
#include "mp/mp_procid_utils.hpp"
#include "mp_s_procid.hpp"
#include "mp_s_procid_utils.h"
#include "mp/mp_pattern_utils.hpp"
#include "mp_typedb_utils.hpp"
#include "mp_ptype_utils.hpp"
#include "mp_otype_utils.hpp"
#include "mp_rpc_implement.h"
#include "mp_signature_utils.hpp"
...
class _Tt_s_mp : public _Tt_mp {
	...
	Tt_status			init(void);
	void				main_loop(void);
	_Tt_string			alloc_procid_key(void);
	...
	Tt_status			s_init(void);
	Tt_status			init_self(void);
	_Tt_typedb_ptr			tdb;

	pid_t				garbage_collector_pid;

      private:
	Tt_status			_handle_Session_Trace(void);
	Tt_status			_observe_Saved(void);
