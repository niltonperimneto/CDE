...
class _Tt_types_table : public _Tt_object {
	...
	_Tt_parse_status	check_cycle(_Tt_otype_ptr otype, _Tt_otype **path,
					    int top);
	_Tt_parse_status	check_otypes(void);
	_Tt_parse_status	check_ptypes(void);
