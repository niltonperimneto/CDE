...
static void jis_to_sjis(Uchar *, Uchar *);
static void sjis_to_jis(Uchar *, Uchar *);
...
static int sjis_mbstowcs(XlcConv conv, XPointer *from, int *from_left,
...
static int sjis_wcstombs(XlcConv conv, XPointer *from, int *from_left,
                         XPointer *to, int *to_left, XPointer *args,
                         int num_args) {
...
static int sjis_mbtocs(XlcConv conv, XPointer *from, int *from_left,
                       XPointer *to, int *to_left, XPointer *args,
                       int num_args) {
  XLCd lcd = (XLCd)conv->state;
...
static int sjis_mbstocs(XlcConv conv, XPointer *from, int *from_left,
                        XPointer *to, int *to_left, XPointer *args,
                        int num_args) {
  XLCd lcd = (XLCd)conv->state;
  ...
  while ((ret = sjis_mbtocs(conv, from, from_left, to, to_left, tmp_args, 1)) >
         0)
    unconv_num += ret;
  if (ret < 0)
    return ret;
...
static int sjis_wcstocs(XlcConv conv, XPointer *from, int *from_left,
                        XPointer *to, int *to_left, XPointer *args,
                        int num_args) {
  XLCd lcd = (XLCd)conv->state;
...
static int sjis_cstombs(XlcConv conv, char **from, int *from_left, char **to,
...
static int sjis_cstowcs(XlcConv conv, XPointer *from, int *from_left,
                        XPointer *to, int *to_left, XPointer *args,
                        int num_args) {
  XLCd lcd = (XLCd)conv->state;
...
static int sjis_mbstocts(XlcConv conv, XPointer *from, int *from_left,
                         XPointer *to, int *to_left, XPointer *args,
                         int num_args) {
  int ct_len = *to_left;
  int cs_num;
...
static int sjis_wcstocts(XlcConv conv, XPointer *from, int *from_left,
                         XPointer *to, int *to_left, XPointer *args,
                         int num_args) {
  int ct_len = *to_left;
  wchar_t *inbufptr = (wchar_t *)*from;
...
static int sjis_ctstombs(XlcConv conv, XPointer *from, int *from_left,
                         XPointer *to, int *to_left, XPointer *args,
                         int num_args) {
  XPointer inbufptr = *from;
  XPointer outbufptr = *to;
...
static int sjis_ctstowcs(XlcConv conv, XPointer *from, int *from_left,
                         XPointer *to, int *to_left, XPointer *args,
                         int num_args) {
  XLCd lcd = (XLCd)conv->state;
  ...
  for (length = ctdata[Ascii].length; *from_left > 0; (*from_left) -= length) {
    ...
    /* The following block of code insures that non-standard encodings,
     * direction, extension, and version strings are ignored; subject to change
     * in future.
     */
    switch (ct_type) {
    case CT_STD:
...
XLCd _fallcSjisLoader(char *name) {
  XLCd lcd;
