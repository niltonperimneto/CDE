...
typedef struct pcf_inf PcfFontInf;
 ...
 */
extern FalFontID
FalOpenSysFont(FalFontData * /* open_font_data */, int /* font_data_mask */,
               FalFontDataList ** /* missing_font_list_return */
);

extern int FalGetFontList(FalFontData * /* key_data */, int /* mask */,
                          FalFontDataList ** /* list_ret */
);

extern int FalFreeFontList(FalFontDataList * /* list */
);

extern char *FalReadFont(FalFontID /* fid */, int /* code */, int /* width */,
                         int /* height */
);

extern int FalQueryFont(FalFontID /* fid */, FalFontinfo * /* fontinfo */
);

extern int FalFontOfFontID(FalFontID /* fid */, FalFontData * /* fontdata */
);

extern int FalCloseFont(FalFontID /* fid */
);

extern int FalFontIDToFileName(FalFontID /* fid */, char ** /* file_name */
);

extern int FalFree(void * /* list */
);

extern int FalGetUDCCPArea(char * /* locale */, int /* code_set */,
                           char * /* charset_str */, FalCodeRegion ** /* cr */,
                           int * /* num_cr */
);

extern int FalGetUDCGIArea(char * /* locale */, int /* codeset */,
                           char * /* charset_str */, FalGlyphRegion ** /* gr */,
                           int * /* num_gr */
);

extern FalFontID FalOpenFont(char *, int, int);

/*
 * Code set
 */
#define FALGETFALCODESET(cd_set)                                               \
  (((cd_set) == -1) ? FAL_FONT_GLYPH_INDEX : (cd_set) + 1)

#define FALCODESETTONUM(cd_set)                                                \
  (((cd_set) == FAL_FONT_GLYPH_INDEX) ? -1 : (cd_set) - 1)
