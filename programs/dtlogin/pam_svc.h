...
extern int _DtAccounting(char *, char *, char[], char *, char *, pid_t, int,
                         int);
extern int _DtSetCred(char *, char *, uid_t, gid_t);
extern int _DtSetDevPerm(char *, uid_t, gid_t);
extern int _DtResetDevPerm(char *);

extern int PamInit(char *, char *, char *, char *);
extern int PamAuthenticate(char *, char *, char *, char *, char *);
extern int PamAccounting(char *, char *, char *, char *, char *, pid_t, int,
                         int);
extern int PamSetCred(char *, char *, uid_t, gid_t);
