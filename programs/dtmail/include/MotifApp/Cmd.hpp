...
class Cmd {
  ...
  private:
    ...
    void            revert(void);   // Reverts object to previous state
  ...
  public:
    ...
    void    activate(void);   // Activate this object
    void    deactivate(void); // Deactivate this object
    char    *getLabel() { return _label; }  
    
#ifdef DEAD_WOOD
    // Functions to dependent commands
