 ...
 */
/*
 * $XConsortium: WXmToggleButtonGadget.h /main/3 1996/06/11 17:03:00 cde-hal $
 *
...
#ifndef WXmToggleButtonGadget_h
#define WXmToggleButtonGadget_h

#include "WXmLabelGadget.hpp"
#include <Xm/ToggleBG.h>

class WXmToggleButtonGadget : public WXmLabelGadget {
public :
  DEFINE_INIT (WXmToggleButtonGadget, WXmLabelGadget, xmToggleButtonGadgetClass)
inline	void	State (int set, int notify = FALSE) const { XmToggleButtonGadgetSetState (widget, set, notify); }
inline	int	State () const	{ return XmToggleButtonGadgetGetState (widget); }
...
#define	NULLWXmToggleButtonGadget		WXmToggleButtonGadget((Widget)0)
