 ...
 */
/*
 * $XConsortium: WXmPrimitive.h /main/3 1996/06/11 17:01:28 cde-hal $
 *
...
#ifndef WXmPrimitive_h
#define WXmPrimitive_h
...
class WXmPrimitive : public WCore {
public :
   DEFINE_INIT (WXmPrimitive, WCore, xmPrimitiveWidgetClass)
   ...
   DEFINE_GETTER_SETTER (NavigationType,XmNavigationType,"navigationType")
...
// For some reason a warning is generated if the line
//	 a.value = (XtArgVal)poffset;  _Set(a);
// is not duplicated in the if and else clauses
...
#define	NULLWXmPrimitive		WXmPrimitive((Widget)0)
