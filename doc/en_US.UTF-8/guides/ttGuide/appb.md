...
# The broadcast Demonstration Program
broadcast demo programexample program

This appendix contains the source code for the ToolTalk demo
program,broadcast. The source code can also
be found in the file/usr/dt/examples/tt/broadcast.c.
The purpose of the demo program is to show the use of some ToolTalk
APIs. In particular, this program:Creates and registers a patternCreates a notification message and sends it (to itself)Receives a messagebroadcast.c Program Listing/*
