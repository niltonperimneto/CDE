...
is an example of a typical algorithm of aTtdt_contract_cbTtdt_contract_cbcallback for an application that handles its own
Pause/Resume/Quit requests but allows the toolkit to handle the X11-related
requests.

This example callback deals with the case when thecontractparameter
has a value other than zero and can, therefore, also be used as theTtdt_contract_cbcallback passed tottdt_message_accept.
# Typical Algorithm of Ttdt_contract_cb
Tt_message
myContractCB(
        Tt_message      msg,
        void           *clientdata,
...
# ExampleTtdt_file_cbTtdt_file_cb


is an example of a typical algorithm of this callback.
# Typical Algorithm of Ttdt_file_cb
Tt_message
myFileCB(
        Tt_message      msg,
        Tttk_op         op,
...
# ExampleTtmedia_load_msg_cbTtmedia_load_msg_cb


is an example of a typical algorithm of this callback.
# Typical Algorithm of Ttmedia_load_msg_cb
Tt_message
myLoadMsgCB(
        Tt_message      msg,
        void           *clientData,
...
# ExampleTtmedia_load_pat_cbTtmedia_load_pat_cb


is an example of a typical algorithm of this callback.
# Typical Algorithm of Ttmedia_load_pat_cb
Tt_message
myAcmeSheetLoadCB(
        Tt_message      msg,
        void           *client_data,
...
# Example Ptype Signature forTtmedia_ptype_declareTtmedia_ptype_declare Function


is an example of the signature layout of a media ptype.
# Example of Media Ptype Signature Layout
ptype Acme_Calc {
...
is an example for the Xt input handler function.
# Xt Input Handler Function Example
int myTtFd;
char *myProcID;
