# dtfile_config
special filedtfile_configCDE File Manager configuration file`# Comment
aix:3     = native
hpux:0    = native
sunos:ufs = native
end
...
/local/bin/modExtAttr:native: buttonLabel = Modify extended attributes ...
        warning     = Warning:\nExtended attributes may limit your access
        fsDialog    = /local/bin/modExtAttr
        dismiss     = yes
## SEE
